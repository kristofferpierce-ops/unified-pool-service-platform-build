...
$PhaseNumber = 36
$StepNumber = 97
$StepTitle = "Phase 36 Step 97 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Approval Readiness Packet"
$ExpectedBranch = "phase36-step97-controlled-live-write-expansion-final-release-hold-approval-readiness"
$PriorCompletedStep = "Phase 36 Step 96 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Approval Boundary Packet"
...
$StepFiles = @(
    "scripts/phase36_step97_controlled_live_write_expansion_final_release_hold_approval_readiness_packet.ps1",
    "ui/pages/1793_Phase36_Step97_Live_Write_Expansion_Final_Release_Hold_Approval_Readiness.py",
    "docs/PHASE36_STEP97_CONTROLLED_LIVE_WRITE_EXPANSION_FINAL_RELEASE_HOLD_APPROVAL_READINESS_PACKET.md",
    "tests/test_phase36_step97_controlled_live_write_expansion_final_release_hold_approval_readiness_packet.py"
)
