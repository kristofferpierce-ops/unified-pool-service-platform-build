...
$PhaseNumber = 36
$StepNumber = 95
$StepTitle = "Phase 36 Step 95 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Safety Disposition Review Packet"
$ExpectedBranch = "phase36-step95-controlled-live-write-expansion-final-release-hold-safety-review"
$PriorCompletedStep = "Phase 36 Step 94 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Safety Disposition Planning Packet"
...
$StepFiles = @(
    "scripts/phase36_step95_controlled_live_write_expansion_final_release_hold_safety_review_packet.ps1",
    "ui/pages/1791_Phase36_Step95_Live_Write_Expansion_Final_Release_Hold_Safety_Review.py",
    "docs/PHASE36_STEP95_CONTROLLED_LIVE_WRITE_EXPANSION_FINAL_RELEASE_HOLD_SAFETY_REVIEW_PACKET.md",
    "tests/test_phase36_step95_controlled_live_write_expansion_final_release_hold_safety_review_packet.py"
)
