...
$StepNumber = 6
$StepTitle = "Phase 30 Step 6 - Phase 20 Network Transport Implementation Active Live Program Development Readiness Approval Boundary Packet"
$ShortTitle = "Phase 20 Network Transport Implementation Active Live Program Development Readiness Approval Boundary Packet"
$ExpectedBranch = "phase30-step6-active-live-program-development-readiness-approval-boundary"
$PriorStep = "Phase 30 Step 5 - Phase 20 Network Transport Implementation Active Live Program Development Readiness Safety Disposition Review Packet"
$Slug = "implementation_active_live_program_development_readiness_approval_boundary"
...
$StepFiles = @(
    "scripts/phase30_step6_active_live_program_development_readiness_approval_boundary_packet.ps1",
    "ui/pages/982_Phase30_Step6_Implementation_Active_Live_Program_Development_Readiness_Approval_Boundary_Packet.py",
    "docs/PHASE30_STEP6_ACTIVE_LIVE_PROGRAM_DEVELOPMENT_READINESS_APPROVAL_BOUNDARY_PACKET.md",
    "tests/test_phase30_step6_active_live_program_development_readiness_approval_boundary_packet.py"
)
...
$SafetyPosture = [ordered]@{
    ...
    phase30_boundary = "implementation_active_live_program_development_readiness_approval_boundary_opened_by_packet"
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 30 Step 6 files copied or already present."
}
...
function Test-Smoke {
    ...
    Write-Host "SMOKE TEST PASS: Phase 30 Step 6 Phase 20 Network Transport Implementation Active Live Program Development Readiness Approval Boundary Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $PacketDir = Join-Path $BackupRoot ("phase30_step6_{0}_packet_{1}" -f $Slug, $Timestamp)
    New-Item -ItemType Directory -Path $PacketDir -Force | Out-Null
    $PacketJson = Join-Path $PacketDir ("phase30_step6_{0}_packet.json" -f $Slug)
