...
$PhaseNumber = 37
$StepNumber = 69
$StepTitle = "Phase 37 Step 69 - Phase 20 Network Transport Implementation Trusted Production Monitored Live Write Operations No-Write Dry Run Result Disposition Planning Closeout Index Packet"
$PriorCompletedStep = "Phase 37 Step 68 packet"
