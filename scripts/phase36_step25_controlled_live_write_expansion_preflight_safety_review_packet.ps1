...
$PhaseNumber = 36
$StepNumber = 25
$StepTitle = "Phase 36 Step 25 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Safety Disposition Review Packet"
$ExpectedBranch = "phase36-step25-controlled-live-write-expansion-preflight-safety-review"
$PriorCompletedStep = "Phase 36 Step 24 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Safety Disposition Planning Packet"
...
$StepFiles = @(
    "scripts/phase36_step25_controlled_live_write_expansion_preflight_safety_review_packet.ps1",
    "ui/pages/1721_Phase36_Step25_Live_Write_Expansion_Preflight_Safety_Review.py",
    "docs/PHASE36_STEP25_CONTROLLED_LIVE_WRITE_EXPANSION_PREFLIGHT_SAFETY_REVIEW_PACKET.md",
    "tests/test_phase36_step25_controlled_live_write_expansion_preflight_safety_review_packet.py"
)
