...
$PhaseNumber = 36
$StepNumber = 99
$StepTitle = "Phase 36 Step 99 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Closeout Index Packet"
$ExpectedBranch = "phase36-step99-controlled-live-write-expansion-final-release-hold-closeout-index"
$PriorCompletedStep = "Phase 36 Step 98 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Operator Hold Point Packet"
...
$StepFiles = @(
    "scripts/phase36_step99_controlled_live_write_expansion_final_release_hold_closeout_index_packet.ps1",
    "ui/pages/1795_Phase36_Step99_Live_Write_Expansion_Final_Release_Hold_Closeout_Index.py",
    "docs/PHASE36_STEP99_CONTROLLED_LIVE_WRITE_EXPANSION_FINAL_RELEASE_HOLD_CLOSEOUT_INDEX_PACKET.md",
    "tests/test_phase36_step99_controlled_live_write_expansion_final_release_hold_closeout_index_packet.py"
)
