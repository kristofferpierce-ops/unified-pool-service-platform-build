...
$PhaseNumber = 36
$StepNumber = 85
$StepTitle = "Phase 36 Step 85 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Safety Disposition Review Packet"
$ExpectedBranch = "phase36-step85-controlled-live-write-expansion-release-gate-verification-planning-safety-review"
$PriorCompletedStep = "Phase 36 Step 84 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Safety Disposition Planning Packet"
...
$StepFiles = @(
    "scripts/phase36_step85_controlled_live_write_expansion_release_gate_verification_planning_safety_review_packet.ps1",
    "ui/pages/1781_Phase36_Step85_Live_Write_Expansion_Release_Gate_Verification_Safety_Review.py",
    "docs/PHASE36_STEP85_CONTROLLED_LIVE_WRITE_EXPANSION_RELEASE_GATE_VERIFICATION_PLANNING_SAFETY_REVIEW_PACKET.md",
    "tests/test_phase36_step85_controlled_live_write_expansion_release_gate_verification_planning_safety_review_packet.py"
)
