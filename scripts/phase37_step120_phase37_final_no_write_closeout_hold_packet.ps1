...
$PacketTitle = "Phase 37 Step 120 - Phase 20 Network Transport Implementation Phase 37 Final No-Write Closeout Hold Packet"
...
function Assert-SafetyMarkers {
    ...
    foreach ($Marker in $Forbidden) {
        if ($Compact.Contains($Marker)) {
            throw ("Forbidden unsafe marker detected in Phase 37 Step 120 packet.")
        }
    }
}
