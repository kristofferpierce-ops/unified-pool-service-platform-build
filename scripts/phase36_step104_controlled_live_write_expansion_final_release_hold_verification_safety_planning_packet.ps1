...
$PhaseNumber = 36
$StepNumber = 104
$StepTitle = "Phase 36 Step 104 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Verification Planning Safety Disposition Planning Packet"
$ExpectedBranch = "phase36-step104-controlled-live-write-expansion-final-release-hold-verification-safety-planning"
$PriorCompletedStep = "Phase 36 Step 103 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Verification Planning Evidence Gap Review Packet"
...
$StepFiles = @(
    "scripts/phase36_step104_controlled_live_write_expansion_final_release_hold_verification_safety_planning_packet.ps1",
    "ui/pages/1800_Phase36_Step104_Live_Write_Expansion_Final_Release_Hold_Verification_Safety_Planning.py",
    "docs/PHASE36_STEP104_CONTROLLED_LIVE_WRITE_EXPANSION_FINAL_RELEASE_HOLD_VERIFICATION_SAFETY_PLANNING_PACKET.md",
    "tests/test_phase36_step104_controlled_live_write_expansion_final_release_hold_verification_safety_planning_packet.py"
)
