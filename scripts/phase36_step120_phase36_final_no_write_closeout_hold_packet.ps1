...
$PhaseNumber = 36
$StepNumber = 120
$StepTitle = "Phase 36 Step 120 - Phase 20 Network Transport Implementation Phase 36 Final No-Write Closeout Hold Packet"
$ExpectedBranch = "phase36-step120-phase36-final-no-write-closeout-hold"
$PriorCompletedStep = "Phase 36 Step 119 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Result Review Planning Closeout Index Packet"
...
$StepFiles = @(
    "scripts/phase36_step120_phase36_final_no_write_closeout_hold_packet.ps1",
    "ui/pages/1816_Phase36_Step120_Phase36_Final_No_Write_Closeout_Hold.py",
    "docs/PHASE36_STEP120_PHASE36_FINAL_NO_WRITE_CLOSEOUT_HOLD_PACKET.md",
    "tests/test_phase36_step120_phase36_final_no_write_closeout_hold_packet.py"
)
