...
$StepNumber = 99
$StepTitle = "Phase 25 Step 99 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Closeout Index Packet"
$ExpectedBranch = "phase25-step99-post-closeout-final-release-hold-planning-closeout-index"
$PriorStep = "Phase 25 Step 98 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Final Boundary Confirmation Packet"
if ($StepNumber -gt 91) {
    $PriorStep = "Phase 25 Step 98 - previous Phase 25 post-closeout final release hold planning packet"
}

$StepFiles = @(
    "scripts/phase25_step99_post_closeout_final_release_hold_planning_closeout_index_packet.ps1",
    "ui/pages/475_Phase25_Step99_Implementation_PostCloseout_Final_Release_Hold_Planning_Closeout_Index_Packet.py",
    "docs/PHASE25_STEP99_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_CLOSEOUT_INDEX_PACKET.md",
    "tests/test_phase25_step99_post_closeout_final_release_hold_planning_closeout_index_packet.py"
)
...
$Safety = [ordered]@{
    ...
    phase25_boundary = "implementation_post_closeout_final_release_hold_planning_closeout_index_opened_by_packet"
    ...
    implementation_post_closeout_final_release_hold_planning_closeout_index_mode = "reference_only"
    implementation_post_closeout_final_release_hold_planning_closeout_index_write = $false
    implementation_post_closeout_final_release_hold_planning_closeout_index_record_creation = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 25 Step 99 files copied or already present."
}
...
function Invoke-SmokeTest {
    ...
    Write-Host "SMOKE TEST PASS: Phase 25 Step 99 Implementation Post-Closeout Final Release Hold Planning Closeout Index Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $BackupDir = Join-Path $RepoRoot "backups\phase25_step99_post_closeout_final_release_hold_planning_closeout_index_packet_$Stamp"
    New-Item -ItemType Directory -Path $BackupDir -Force | Out-Null
    $PacketPath = Join-Path $BackupDir "phase25_step99_post_closeout_final_release_hold_planning_closeout_index_packet.json"
    ...
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_closeout_index_mode" $Safety.implementation_post_closeout_final_release_hold_planning_closeout_index_mode
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_closeout_index_write" $Safety.implementation_post_closeout_final_release_hold_planning_closeout_index_write
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_closeout_index_record_creation" $Safety.implementation_post_closeout_final_release_hold_planning_closeout_index_record_creation
    ...
    Write-Host "CHECK: phase25_context=post_closeout_final_release_hold_planning_closeout_index_planning_only"
