...
$PhaseNumber = 36
$StepNumber = 96
$StepTitle = "Phase 36 Step 96 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Approval Boundary Packet"
$ExpectedBranch = "phase36-step96-controlled-live-write-expansion-final-release-hold-approval-boundary"
$PriorCompletedStep = "Phase 36 Step 95 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Safety Disposition Review Packet"
...
$StepFiles = @(
    "scripts/phase36_step96_controlled_live_write_expansion_final_release_hold_approval_boundary_packet.ps1",
    "ui/pages/1792_Phase36_Step96_Live_Write_Expansion_Final_Release_Hold_Approval_Boundary.py",
    "docs/PHASE36_STEP96_CONTROLLED_LIVE_WRITE_EXPANSION_FINAL_RELEASE_HOLD_APPROVAL_BOUNDARY_PACKET.md",
    "tests/test_phase36_step96_controlled_live_write_expansion_final_release_hold_approval_boundary_packet.py"
)
