...
$PhaseNumber = 24
$StepNumber = 96
$StepName = "Phase 24 Step 96 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Approval Boundary Packet"
$PriorStepName = "Phase 24 Step 95 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Safety Disposition Review Packet"
$ExpectedBranch = "phase24-step96-final-release-hold-approval-boundary"
$ModeKey = "implementation_controlled_activation_final_release_hold_planning_approval_boundary_mode"
$WriteKey = "implementation_controlled_activation_final_release_hold_planning_approval_boundary_write"
$RecordKey = "implementation_controlled_activation_final_release_hold_planning_approval_boundary_record_creation"
$PhaseContext = "implementation_controlled_activation_final_release_hold_planning_approval_boundary_planning_only"
$PacketSlug = "phase24_step96_controlled_activation_final_release_hold_planning_approval_boundary_packet"

$StepFiles = @(
    "scripts/phase24_step96_controlled_activation_final_release_hold_planning_approval_boundary_packet.ps1",
    "ui/pages/352_Phase24_Step96_Implementation_Controlled_Activation_Final_Release_Hold_Planning_Approval_Boundary_Packet.py",
    "docs/PHASE24_STEP96_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_PLANNING_APPROVAL_BOUNDARY_PACKET.md",
    "tests/test_phase24_step96_controlled_activation_final_release_hold_planning_approval_boundary_packet.py"
)
...
$SafetyPosture = [ordered]@{
    ...
    phase24_boundary = "implementation_controlled_activation_final_release_hold_planning_approval_boundary_opened_by_packet"
    ...
    implementation_controlled_activation_final_release_hold_planning_approval_boundary_mode = "reference_only"
    implementation_controlled_activation_final_release_hold_planning_approval_boundary_write = $false
    implementation_controlled_activation_final_release_hold_planning_approval_boundary_record_creation = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 24 Step 96 files copied or already present."
}
...
function Invoke-SmokeTest {
    ...
    $scriptText = Get-Content -LiteralPath (Join-SafePath -Root $Repo -RelativePath "scripts/phase24_step96_controlled_activation_final_release_hold_planning_approval_boundary_packet.ps1") -Raw -Encoding UTF8
    ...
    Write-Host "SMOKE TEST PASS: Phase 24 Step 96 Implementation Controlled Activation Final Release Hold Planning Approval Boundary Packet is present and planning-only."
}
...
function Write-Packet {
    ...
    Write-Host "PASS: phase24_boundary=implementation_controlled_activation_final_release_hold_planning_approval_boundary_opened_by_packet"
    ...
    Write-Host "PASS: implementation_controlled_activation_final_release_hold_planning_approval_boundary_mode=reference_only"
    Write-Host "PASS: implementation_controlled_activation_final_release_hold_planning_approval_boundary_write=false"
    Write-Host "PASS: implementation_controlled_activation_final_release_hold_planning_approval_boundary_record_creation=false"
...
while ($true) {
    Write-Host ""
    Write-Host "Phase 24 Step 96 menu"
    Write-Host "1. Show status / verify paths"
    Write-Host "2. Apply Phase 24 Step 96 Implementation Controlled Activation Final Release Hold Planning Approval Boundary Packet files"
    Write-Host "3. Smoke test Phase 24 Step 96"
    Write-Host "4. Show server start placeholder only"
    Write-Host "5. Generate Phase 24 Step 96 Implementation Controlled Activation Final Release Hold Planning Approval Boundary Packet"
    Write-Host "6. Exit"
