...
$PhaseNumber = 36
$StepNumber = 102
$StepTitle = "Phase 36 Step 102 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Verification Planning Evidence Index Packet"
$ExpectedBranch = "phase36-step102-controlled-live-write-expansion-final-release-hold-verification-evidence-index"
$PriorCompletedStep = "Phase 36 Step 101 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Verification Planning Boundary Packet"
...
$StepFiles = @(
    "scripts/phase36_step102_controlled_live_write_expansion_final_release_hold_verification_evidence_index_packet.ps1",
    "ui/pages/1798_Phase36_Step102_Live_Write_Expansion_Final_Release_Hold_Verification_Evidence_Index.py",
    "docs/PHASE36_STEP102_CONTROLLED_LIVE_WRITE_EXPANSION_FINAL_RELEASE_HOLD_VERIFICATION_EVIDENCE_INDEX_PACKET.md",
    "tests/test_phase36_step102_controlled_live_write_expansion_final_release_hold_verification_evidence_index_packet.py"
)
