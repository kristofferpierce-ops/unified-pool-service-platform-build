...
$PhaseNumber = 37
$StepNumber = 101
$StepTitle = "Phase 37 Step 101 - Phase 20 Network Transport Implementation Trusted Production Monitored Live Write Operations Final Release Hold Verification Planning Boundary Packet"
$PriorCompletedStep = "Phase 37 Step 100 - Phase 20 Network Transport Implementation Trusted Production Monitored Live Write Operations Final Release Hold Planning Final Boundary Confirmation Packet"
