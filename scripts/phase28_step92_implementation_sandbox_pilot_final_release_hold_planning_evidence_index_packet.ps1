...
$StepNumber = 92
$StepName = "Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Evidence Index Packet"
$StepTitle = "Phase 28 Step 92 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Evidence Index Packet"
$ExpectedBranch = "phase28-step92-implementation-sandbox-pilot-final-release-hold-planning-evidence-index"
$PriorStep = "Phase 28 Step 91 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Boundary Packet"
$StepKey = "implementation_sandbox_pilot_final_release_hold_planning_evidence_index"
$BoundaryMarker = "implementation_sandbox_pilot_final_release_hold_planning_evidence_index_opened_by_packet"
$PhaseContext = "implementation_sandbox_pilot_final_release_hold_planning_only"
$ScriptRel = "scripts/phase28_step92_implementation_sandbox_pilot_final_release_hold_planning_evidence_index_packet.ps1"
$UiRel = "ui/pages/828_Phase28_Step92_Implementation_Sandbox_Pilot_Final_Release_Hold_Planning_Evidence_Index_Packet.py"
$DocRel = "docs/PHASE28_STEP92_IMPLEMENTATION_SANDBOX_PILOT_FINAL_RELEASE_HOLD_PLANNING_EVIDENCE_INDEX_PACKET.md"
$TestRel = "tests/test_phase28_step92_implementation_sandbox_pilot_final_release_hold_planning_evidence_index_packet.py"
$PacketSlug = "phase28_step92_implementation_sandbox_pilot_final_release_hold_planning_evidence_index_packet"
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 28 Step 92 files copied or already present."
}
...
function Test-Smoke {
    ...
    if ($Missing.Count -gt 0) {
        throw ("Missing Phase 28 Step 92 files: {0}" -f ($Missing -join ", "))
    }
    Write-Host "SMOKE TEST PASS: Phase 28 Step 92 Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Evidence Index Packet is present and planning-only."
}
