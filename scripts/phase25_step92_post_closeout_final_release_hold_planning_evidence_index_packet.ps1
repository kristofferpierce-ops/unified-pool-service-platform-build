...
$StepNumber = 92
$StepTitle = "Phase 25 Step 92 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Evidence Index Packet"
$ExpectedBranch = "phase25-step92-post-closeout-final-release-hold-planning-evidence-index"
$PriorStep = "Phase 25 Step 91 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Final Boundary Confirmation Packet"
if ($StepNumber -gt 91) {
    $PriorStep = "Phase 25 Step 91 - previous Phase 25 post-closeout final release hold planning packet"
}

$StepFiles = @(
    "scripts/phase25_step92_post_closeout_final_release_hold_planning_evidence_index_packet.ps1",
    "ui/pages/468_Phase25_Step92_Implementation_PostCloseout_Final_Release_Hold_Planning_Evidence_Index_Packet.py",
    "docs/PHASE25_STEP92_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_EVIDENCE_INDEX_PACKET.md",
    "tests/test_phase25_step92_post_closeout_final_release_hold_planning_evidence_index_packet.py"
)
...
$Safety = [ordered]@{
    ...
    phase25_boundary = "implementation_post_closeout_final_release_hold_planning_evidence_index_opened_by_packet"
    ...
    implementation_post_closeout_final_release_hold_planning_evidence_index_mode = "reference_only"
    implementation_post_closeout_final_release_hold_planning_evidence_index_write = $false
    implementation_post_closeout_final_release_hold_planning_evidence_index_record_creation = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 25 Step 92 files copied or already present."
}
...
function Invoke-SmokeTest {
    ...
    Write-Host "SMOKE TEST PASS: Phase 25 Step 92 Implementation Post-Closeout Final Release Hold Planning Evidence Index Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $BackupDir = Join-Path $RepoRoot "backups\phase25_step92_post_closeout_final_release_hold_planning_evidence_index_packet_$Stamp"
    New-Item -ItemType Directory -Path $BackupDir -Force | Out-Null
    $PacketPath = Join-Path $BackupDir "phase25_step92_post_closeout_final_release_hold_planning_evidence_index_packet.json"
    ...
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_evidence_index_mode" $Safety.implementation_post_closeout_final_release_hold_planning_evidence_index_mode
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_evidence_index_write" $Safety.implementation_post_closeout_final_release_hold_planning_evidence_index_write
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_evidence_index_record_creation" $Safety.implementation_post_closeout_final_release_hold_planning_evidence_index_record_creation
    ...
    Write-Host "CHECK: phase25_context=post_closeout_final_release_hold_planning_evidence_index_planning_only"
