...
$StepNumber = 120
$StepTitle = "Phase 25 Step 120 - Phase 20 Network Transport Implementation Phase 25 Final No-Write Closeout Hold Packet"
$ExpectedBranch = "phase25-step120-final-no-write-closeout-hold"
$PriorStep = "Phase 25 Step 119 - previous Phase 25 post-closeout packet"
$ModeKey = "phase25_final_no_write_closeout_hold_mode"
$WriteKey = "phase25_final_no_write_closeout_hold_write"
$RecordKey = "phase25_final_no_write_closeout_hold_record_creation"

$ExpectedRelativeFiles = @(
    "scripts/phase25_step120_final_no_write_closeout_hold_packet.ps1",
    "ui/pages/496_Phase25_Step120_Final_No_Write_Closeout_Hold_Packet.py",
    "docs/PHASE25_STEP120_FINAL_NO_WRITE_CLOSEOUT_HOLD_PACKET.md",
    "tests/test_phase25_step120_final_no_write_closeout_hold_packet.py"
)
...
$Safety = [ordered]@{
    ...
    phase25_boundary = "phase25_final_no_write_closeout_hold_opened_by_packet"
    ...
    "phase25_final_no_write_closeout_hold_mode" = "reference_only"
    "phase25_final_no_write_closeout_hold_write" = $false
    "phase25_final_no_write_closeout_hold_record_creation" = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 25 Step 120 files copied or already present."
}
...
function Test-Smoke {
    ...
    Write-Host "SMOKE TEST PASS: Phase 25 Step 120 Phase 25 Final No-Write Closeout Hold Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $BackupDir = Join-Path $RepoRoot "backups\phase25_step120_phase25_final_no_write_closeout_hold_packet_$Stamp"
    New-Item -ItemType Directory -Path $BackupDir -Force | Out-Null
    $PacketPath = Join-Path $BackupDir "phase25_step120_phase25_final_no_write_closeout_hold_packet.json"
    ...
    Write-LowercaseBoolLine "phase25_final_no_write_closeout_hold_mode" $Safety["phase25_final_no_write_closeout_hold_mode"]
    Write-LowercaseBoolLine "phase25_final_no_write_closeout_hold_write" $Safety["phase25_final_no_write_closeout_hold_write"]
    Write-LowercaseBoolLine "phase25_final_no_write_closeout_hold_record_creation" $Safety["phase25_final_no_write_closeout_hold_record_creation"]
    ...
    Write-Host "CHECK: phase25_context=phase25_final_no_write_closeout_hold_planning_only"
