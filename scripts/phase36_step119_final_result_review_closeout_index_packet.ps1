...
$PhaseNumber = 36
$StepNumber = 119
$StepTitle = "Phase 36 Step 119 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Result Review Planning Closeout Index Packet"
$ExpectedBranch = "phase36-step119-final-result-review-closeout-index"
$PriorCompletedStep = "Phase 36 Step 118 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Result Review Planning Operator Hold Point Packet"
...
$StepFiles = @(
    "scripts/phase36_step119_final_result_review_closeout_index_packet.ps1",
    "ui/pages/1815_Phase36_Step119_Live_Write_Expansion_Final_Result_Review_Closeout_Index.py",
    "docs/PHASE36_STEP119_CONTROLLED_LIVE_WRITE_EXPANSION_FINAL_RESULT_REVIEW_CLOSEOUT_INDEX_PACKET.md",
    "tests/test_phase36_step119_final_result_review_closeout_index_packet.py"
)
