...
$StepNumber = 97
$StepTitle = "Phase 25 Step 97 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Approval Readiness Packet"
$ExpectedBranch = "phase25-step97-post-closeout-final-release-hold-planning-approval-readiness"
$PriorStep = "Phase 25 Step 96 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Final Boundary Confirmation Packet"
if ($StepNumber -gt 91) {
    $PriorStep = "Phase 25 Step 96 - previous Phase 25 post-closeout final release hold planning packet"
}

$StepFiles = @(
    "scripts/phase25_step97_post_closeout_final_release_hold_planning_approval_readiness_packet.ps1",
    "ui/pages/473_Phase25_Step97_Implementation_PostCloseout_Final_Release_Hold_Planning_Approval_Readiness_Packet.py",
    "docs/PHASE25_STEP97_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_APPROVAL_READINESS_PACKET.md",
    "tests/test_phase25_step97_post_closeout_final_release_hold_planning_approval_readiness_packet.py"
)
...
$Safety = [ordered]@{
    ...
    phase25_boundary = "implementation_post_closeout_final_release_hold_planning_approval_readiness_opened_by_packet"
    ...
    implementation_post_closeout_final_release_hold_planning_approval_readiness_mode = "reference_only"
    implementation_post_closeout_final_release_hold_planning_approval_readiness_write = $false
    implementation_post_closeout_final_release_hold_planning_approval_readiness_record_creation = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 25 Step 97 files copied or already present."
}
...
function Invoke-SmokeTest {
    ...
    Write-Host "SMOKE TEST PASS: Phase 25 Step 97 Implementation Post-Closeout Final Release Hold Planning Approval Readiness Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $BackupDir = Join-Path $RepoRoot "backups\phase25_step97_post_closeout_final_release_hold_planning_approval_readiness_packet_$Stamp"
    New-Item -ItemType Directory -Path $BackupDir -Force | Out-Null
    $PacketPath = Join-Path $BackupDir "phase25_step97_post_closeout_final_release_hold_planning_approval_readiness_packet.json"
    ...
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_approval_readiness_mode" $Safety.implementation_post_closeout_final_release_hold_planning_approval_readiness_mode
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_approval_readiness_write" $Safety.implementation_post_closeout_final_release_hold_planning_approval_readiness_write
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_approval_readiness_record_creation" $Safety.implementation_post_closeout_final_release_hold_planning_approval_readiness_record_creation
    ...
    Write-Host "CHECK: phase25_context=post_closeout_final_release_hold_planning_approval_readiness_planning_only"
