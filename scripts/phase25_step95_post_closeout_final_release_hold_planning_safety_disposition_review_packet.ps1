...
$StepNumber = 95
$StepTitle = "Phase 25 Step 95 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Safety Disposition Review Packet"
$ExpectedBranch = "phase25-step95-post-closeout-final-release-hold-planning-safety-disposition-review"
$PriorStep = "Phase 25 Step 94 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Final Boundary Confirmation Packet"
if ($StepNumber -gt 91) {
    $PriorStep = "Phase 25 Step 94 - previous Phase 25 post-closeout final release hold planning packet"
}

$StepFiles = @(
    "scripts/phase25_step95_post_closeout_final_release_hold_planning_safety_disposition_review_packet.ps1",
    "ui/pages/471_Phase25_Step95_Implementation_PostCloseout_Final_Release_Hold_Planning_Safety_Disposition_Review_Packet.py",
    "docs/PHASE25_STEP95_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_SAFETY_DISPOSITION_REVIEW_PACKET.md",
    "tests/test_phase25_step95_post_closeout_final_release_hold_planning_safety_disposition_review_packet.py"
)
...
$Safety = [ordered]@{
    ...
    phase25_boundary = "implementation_post_closeout_final_release_hold_planning_safety_disposition_review_opened_by_packet"
    ...
    implementation_post_closeout_final_release_hold_planning_safety_disposition_review_mode = "reference_only"
    implementation_post_closeout_final_release_hold_planning_safety_disposition_review_write = $false
    implementation_post_closeout_final_release_hold_planning_safety_disposition_review_record_creation = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 25 Step 95 files copied or already present."
}
...
function Invoke-SmokeTest {
    ...
    Write-Host "SMOKE TEST PASS: Phase 25 Step 95 Implementation Post-Closeout Final Release Hold Planning Safety Disposition Review Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $BackupDir = Join-Path $RepoRoot "backups\phase25_step95_post_closeout_final_release_hold_planning_safety_disposition_review_packet_$Stamp"
    New-Item -ItemType Directory -Path $BackupDir -Force | Out-Null
    $PacketPath = Join-Path $BackupDir "phase25_step95_post_closeout_final_release_hold_planning_safety_disposition_review_packet.json"
    ...
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_safety_disposition_review_mode" $Safety.implementation_post_closeout_final_release_hold_planning_safety_disposition_review_mode
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_safety_disposition_review_write" $Safety.implementation_post_closeout_final_release_hold_planning_safety_disposition_review_write
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_safety_disposition_review_record_creation" $Safety.implementation_post_closeout_final_release_hold_planning_safety_disposition_review_record_creation
    ...
    Write-Host "CHECK: phase25_context=post_closeout_final_release_hold_planning_safety_disposition_review_planning_only"
