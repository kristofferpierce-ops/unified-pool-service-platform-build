...
$PhaseNumber = 37
$StepNumber = 64
$StepTitle = "Phase 37 Step 64 - Phase 20 Network Transport Implementation Trusted Production Monitored Live Write Operations No-Write Dry Run Result Disposition Planning Safety Disposition Planning Packet"
$PriorCompletedStep = "Phase 37 Step 63 packet"
