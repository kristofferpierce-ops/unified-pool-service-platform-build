...
$StepNumber = 93
$StepName = "Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Evidence Gap Review Packet"
$StepTitle = "Phase 28 Step 93 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Evidence Gap Review Packet"
$ExpectedBranch = "phase28-step93-implementation-sandbox-pilot-final-release-hold-planning-evidence-gap-review"
$PriorStep = "Phase 28 Step 92 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Evidence Index Packet"
$StepKey = "implementation_sandbox_pilot_final_release_hold_planning_evidence_gap_review"
$BoundaryMarker = "implementation_sandbox_pilot_final_release_hold_planning_evidence_gap_review_opened_by_packet"
$PhaseContext = "implementation_sandbox_pilot_final_release_hold_planning_only"
$ScriptRel = "scripts/phase28_step93_implementation_sandbox_pilot_final_release_hold_planning_evidence_gap_review_packet.ps1"
$UiRel = "ui/pages/829_Phase28_Step93_Implementation_Sandbox_Pilot_Final_Release_Hold_Planning_Evidence_Gap_Review_Packet.py"
$DocRel = "docs/PHASE28_STEP93_IMPLEMENTATION_SANDBOX_PILOT_FINAL_RELEASE_HOLD_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
$TestRel = "tests/test_phase28_step93_implementation_sandbox_pilot_final_release_hold_planning_evidence_gap_review_packet.py"
$PacketSlug = "phase28_step93_implementation_sandbox_pilot_final_release_hold_planning_evidence_gap_review_packet"
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 28 Step 93 files copied or already present."
}
...
function Test-Smoke {
    ...
    if ($Missing.Count -gt 0) {
        throw ("Missing Phase 28 Step 93 files: {0}" -f ($Missing -join ", "))
    }
    Write-Host "SMOKE TEST PASS: Phase 28 Step 93 Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Evidence Gap Review Packet is present and planning-only."
}
