...
$PhaseNumber = 37
$StepNumber = 83
$StepTitle = "Phase 37 Step 83 - Phase 20 Network Transport Implementation Trusted Production Monitored Live Write Operations Release Gate Verification Planning Evidence Gap Review Packet"
$PriorCompletedStep = "Phase 37 Step 82 packet"
...
$StepFiles = @(
    "scripts/phase37_step83_monitored_live_write_ops_release_gate_verification_planning_evidence_gap_review_packet.ps1",
    "ui/pages/1899_Phase37_Step83_Monitored_Live_Write_Ops_Release_Gate_Verification_Evidence_Gap_Review.py",
    "docs/PHASE37_STEP83_MONITORED_LIVE_WRITE_OPS_RELEASE_GATE_VERIFICATION_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md",
    "tests/test_phase37_step83_monitored_live_write_ops_release_gate_verification_planning_evidence_gap_review_packet.py"
)
