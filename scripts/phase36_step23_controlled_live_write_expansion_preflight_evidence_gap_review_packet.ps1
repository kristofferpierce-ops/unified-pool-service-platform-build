...
$PhaseNumber = 36
$StepNumber = 23
$StepTitle = "Phase 36 Step 23 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Evidence Gap Review Packet"
$ExpectedBranch = "phase36-step23-controlled-live-write-expansion-preflight-evidence-gap-review"
$PriorCompletedStep = "Phase 36 Step 22 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Evidence Index Packet"
...
$StepFiles = @(
    "scripts/phase36_step23_controlled_live_write_expansion_preflight_evidence_gap_review_packet.ps1",
    "ui/pages/1719_Phase36_Step23_Live_Write_Expansion_Preflight_Evidence_Gap_Review.py",
    "docs/PHASE36_STEP23_CONTROLLED_LIVE_WRITE_EXPANSION_PREFLIGHT_EVIDENCE_GAP_REVIEW_PACKET.md",
    "tests/test_phase36_step23_controlled_live_write_expansion_preflight_evidence_gap_review_packet.py"
)
...
$SafetyPosture = [ordered]@{
    ...
    phase36_boundary = "trusted_production_controlled_live_write_expansion_preflight_planning_packet"
