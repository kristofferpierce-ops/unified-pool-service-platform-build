...
$StepNumber = 98
$StepTitle = "Phase 25 Step 98 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Operator Hold Point Packet"
$ExpectedBranch = "phase25-step98-post-closeout-final-release-hold-planning-operator-hold-point"
$PriorStep = "Phase 25 Step 97 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Final Boundary Confirmation Packet"
if ($StepNumber -gt 91) {
    $PriorStep = "Phase 25 Step 97 - previous Phase 25 post-closeout final release hold planning packet"
}

$StepFiles = @(
    "scripts/phase25_step98_post_closeout_final_release_hold_planning_operator_hold_point_packet.ps1",
    "ui/pages/474_Phase25_Step98_Implementation_PostCloseout_Final_Release_Hold_Planning_Operator_Hold_Point_Packet.py",
    "docs/PHASE25_STEP98_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_OPERATOR_HOLD_POINT_PACKET.md",
    "tests/test_phase25_step98_post_closeout_final_release_hold_planning_operator_hold_point_packet.py"
)
...
$Safety = [ordered]@{
    ...
    phase25_boundary = "implementation_post_closeout_final_release_hold_planning_operator_hold_point_opened_by_packet"
    ...
    implementation_post_closeout_final_release_hold_planning_operator_hold_point_mode = "reference_only"
    implementation_post_closeout_final_release_hold_planning_operator_hold_point_write = $false
    implementation_post_closeout_final_release_hold_planning_operator_hold_point_record_creation = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 25 Step 98 files copied or already present."
}
...
function Invoke-SmokeTest {
    ...
    Write-Host "SMOKE TEST PASS: Phase 25 Step 98 Implementation Post-Closeout Final Release Hold Planning Operator Hold Point Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $BackupDir = Join-Path $RepoRoot "backups\phase25_step98_post_closeout_final_release_hold_planning_operator_hold_point_packet_$Stamp"
    New-Item -ItemType Directory -Path $BackupDir -Force | Out-Null
    $PacketPath = Join-Path $BackupDir "phase25_step98_post_closeout_final_release_hold_planning_operator_hold_point_packet.json"
    ...
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_operator_hold_point_mode" $Safety.implementation_post_closeout_final_release_hold_planning_operator_hold_point_mode
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_operator_hold_point_write" $Safety.implementation_post_closeout_final_release_hold_planning_operator_hold_point_write
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_operator_hold_point_record_creation" $Safety.implementation_post_closeout_final_release_hold_planning_operator_hold_point_record_creation
    ...
    Write-Host "CHECK: phase25_context=post_closeout_final_release_hold_planning_operator_hold_point_planning_only"
