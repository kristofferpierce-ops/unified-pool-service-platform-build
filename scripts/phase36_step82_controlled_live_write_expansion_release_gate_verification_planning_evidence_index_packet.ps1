...
$PhaseNumber = 36
$StepNumber = 82
$StepTitle = "Phase 36 Step 82 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Evidence Index Packet"
$ExpectedBranch = "phase36-step82-controlled-live-write-expansion-release-gate-verification-planning-evidence-index"
$PriorCompletedStep = "Phase 36 Step 81 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Boundary Packet"
...
$StepFiles = @(
    "scripts/phase36_step82_controlled_live_write_expansion_release_gate_verification_planning_evidence_index_packet.ps1",
    "ui/pages/1778_Phase36_Step82_Live_Write_Expansion_Release_Gate_Verification_Evidence_Index.py",
    "docs/PHASE36_STEP82_CONTROLLED_LIVE_WRITE_EXPANSION_RELEASE_GATE_VERIFICATION_PLANNING_EVIDENCE_INDEX_PACKET.md",
    "tests/test_phase36_step82_controlled_live_write_expansion_release_gate_verification_planning_evidence_index_packet.py"
)
