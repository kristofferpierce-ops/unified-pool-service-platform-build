...
$PhaseNumber = 36
$StepNumber = 24
$StepTitle = "Phase 36 Step 24 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Safety Disposition Planning Packet"
$ExpectedBranch = "phase36-step24-controlled-live-write-expansion-preflight-safety-planning"
$PriorCompletedStep = "Phase 36 Step 23 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Evidence Gap Review Packet"
...
$StepFiles = @(
    "scripts/phase36_step24_controlled_live_write_expansion_preflight_safety_planning_packet.ps1",
    "ui/pages/1720_Phase36_Step24_Live_Write_Expansion_Preflight_Safety_Planning.py",
    "docs/PHASE36_STEP24_CONTROLLED_LIVE_WRITE_EXPANSION_PREFLIGHT_SAFETY_PLANNING_PACKET.md",
    "tests/test_phase36_step24_controlled_live_write_expansion_preflight_safety_planning_packet.py"
)
