...
$PhaseNumber = 25
$StepNumber = 86
$StepName = "Phase 25 Step 86 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Approval Boundary Packet"
$PriorStepName = "Phase 25 Step 85 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Safety Disposition Review Packet"
$ExpectedBranch = "phase25-step86-post-closeout-release-gate-verification-planning-approval-boundary"
$ModeKey = "implementation_post_closeout_release_gate_verification_planning_approval_boundary_mode"
$WriteKey = "implementation_post_closeout_release_gate_verification_planning_approval_boundary_write"
$RecordKey = "implementation_post_closeout_release_gate_verification_planning_approval_boundary_record_creation"
$PhaseContext = "implementation_post_closeout_release_gate_verification_planning_approval_boundary_planning_only"
$PacketSlug = "phase25_step86_post_closeout_release_gate_verification_planning_approval_boundary_packet"

$StepFiles = @(
    "scripts/phase25_step86_post_closeout_release_gate_verification_planning_approval_boundary_packet.ps1",
    "ui/pages/462_Phase25_Step86_Implementation_PostCloseout_Release_Gate_Verification_Planning_Approval_Boundary_Packet.py",
    "docs/PHASE25_STEP86_POST_CLOSEOUT_RELEASE_GATE_VERIFICATION_PLANNING_APPROVAL_BOUNDARY_PACKET.md",
    "tests/test_phase25_step86_post_closeout_release_gate_verification_planning_approval_boundary_packet.py"
)
...
$SafetyPosture = [ordered]@{
    ...
    phase25_boundary = "implementation_post_closeout_release_gate_verification_planning_approval_boundary_opened_by_packet"
    ...
    implementation_post_closeout_release_gate_verification_planning_approval_boundary_mode = "reference_only"
    implementation_post_closeout_release_gate_verification_planning_approval_boundary_write = $false
    implementation_post_closeout_release_gate_verification_planning_approval_boundary_record_creation = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 25 Step 86 files copied or already present."
}
...
function Invoke-SmokeTest {
    ...
    $scriptText = Get-Content -LiteralPath (Join-SafePath -Root $Repo -RelativePath "scripts/phase25_step86_post_closeout_release_gate_verification_planning_approval_boundary_packet.ps1") -Raw -Encoding UTF8
    ...
    Write-Host "SMOKE TEST PASS: Phase 25 Step 86 Implementation Post-Closeout Release Gate Verification Planning Approval Boundary Packet is present and planning-only."
}
...
function Write-Packet {
    ...
    Write-Host "PASS: phase25_boundary=implementation_post_closeout_release_gate_verification_planning_approval_boundary_opened_by_packet"
    ...
    Write-Host "PASS: implementation_post_closeout_release_gate_verification_planning_approval_boundary_mode=reference_only"
    Write-Host "PASS: implementation_post_closeout_release_gate_verification_planning_approval_boundary_write=false"
    Write-Host "PASS: implementation_post_closeout_release_gate_verification_planning_approval_boundary_record_creation=false"
...
while ($true) {
    Write-Host ""
    Write-Host "Phase 25 Step 86 menu"
    Write-Host "1. Show status / verify paths"
    Write-Host "2. Apply Phase 25 Step 86 Implementation Post-Closeout Release Gate Verification Planning Approval Boundary Packet files"
    Write-Host "3. Smoke test Phase 25 Step 86"
    Write-Host "4. Show server start placeholder only"
    Write-Host "5. Generate Phase 25 Step 86 Implementation Post-Closeout Release Gate Verification Planning Approval Boundary Packet"
    Write-Host "6. Exit"
