...
$PhaseNumber = 36
$StepNumber = 87
$StepTitle = "Phase 36 Step 87 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Approval Readiness Packet"
$ExpectedBranch = "phase36-step87-controlled-live-write-expansion-release-gate-verification-planning-approval-readiness"
$PriorCompletedStep = "Phase 36 Step 86 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Approval Boundary Packet"
...
$StepFiles = @(
    "scripts/phase36_step87_controlled_live_write_expansion_release_gate_verification_planning_approval_readiness_packet.ps1",
    "ui/pages/1783_Phase36_Step87_Live_Write_Expansion_Release_Gate_Verification_Approval_Readiness.py",
    "docs/PHASE36_STEP87_CONTROLLED_LIVE_WRITE_EXPANSION_RELEASE_GATE_VERIFICATION_PLANNING_APPROVAL_READINESS_PACKET.md",
    "tests/test_phase36_step87_controlled_live_write_expansion_release_gate_verification_planning_approval_readiness_packet.py"
)
