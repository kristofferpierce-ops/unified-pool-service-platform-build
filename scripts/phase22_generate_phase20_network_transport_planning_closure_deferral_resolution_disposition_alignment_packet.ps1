...
$PhaseStep = "Phase 22 Step 46"
$PacketName = "Phase 20 Network Transport Planning Closure Deferral Resolution Disposition Alignment Packet"
$ExpectedBranch = "phase22-step46-phase20-network-transport-planning-closure-deferral-resolution-disposition-alignment-packet"
$PriorCompletedStep = "Phase 22 Step 45 - Phase 20 Network Transport Planning Closure Deferral Resolution Review Alignment Packet"
...
$StepFiles = [ordered]@{
    "launcher" = "scripts\phase22_generate_phase20_network_transport_planning_closure_deferral_resolution_disposition_alignment_packet.ps1"
    "ui" = "ui\pages\152_Phase20_Network_Transport_Planning_Closure_Deferral_Resolution_Disposition_Alignment_Packet.py"
    "doc" = "docs\PHASE22_STEP46_PHASE20_NETWORK_TRANSPORT_PLANNING_CLOSURE_DEFERRAL_RESOLUTION_DISPOSITION_ALIGNMENT_PACKET.md"
    "test" = "tests\test_phase22_phase20_network_transport_planning_closure_deferral_resolution_disposition_alignment_packet.py"
}
...
function New-PlanningPacket {
    ...
    $packetDir = Join-Path $ResolvedRepoRoot "backups\phase22_phase20_network_transport_planning_closure_deferral_resolution_disposition_alignment_packet_$timestamp"
    ...
    $packet = [ordered]@{
        ...
        closure_deferral_resolution_disposition_alignment = [ordered]@{
    ...
    $packetPath = Join-Path $packetDir "phase22_phase20_network_transport_planning_closure_deferral_resolution_disposition_alignment_packet.json"
...
function Show-Menu {
    ...
    while ($true) {
        ...
        Write-Host "5. Generate Phase 20 network transport planning closure deferral resolution disposition packet"
        Write-Host "6. Exit"
