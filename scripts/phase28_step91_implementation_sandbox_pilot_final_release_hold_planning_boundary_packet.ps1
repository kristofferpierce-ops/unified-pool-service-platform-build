...
$StepNumber = 91
$StepName = "Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Boundary Packet"
$StepTitle = "Phase 28 Step 91 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Boundary Packet"
$ExpectedBranch = "phase28-step91-implementation-sandbox-pilot-final-release-hold-planning-boundary"
$PriorStep = "Phase 28 Step 90 - Phase 20 Network Transport Implementation Sandbox Pilot Release Gate Verification Planning Final Boundary Confirmation Packet"
$StepKey = "implementation_sandbox_pilot_final_release_hold_planning_boundary"
$BoundaryMarker = "implementation_sandbox_pilot_final_release_hold_planning_boundary_opened_by_packet"
$PhaseContext = "implementation_sandbox_pilot_final_release_hold_planning_only"
$ScriptRel = "scripts/phase28_step91_implementation_sandbox_pilot_final_release_hold_planning_boundary_packet.ps1"
$UiRel = "ui/pages/827_Phase28_Step91_Implementation_Sandbox_Pilot_Final_Release_Hold_Planning_Boundary_Packet.py"
$DocRel = "docs/PHASE28_STEP91_IMPLEMENTATION_SANDBOX_PILOT_FINAL_RELEASE_HOLD_PLANNING_BOUNDARY_PACKET.md"
$TestRel = "tests/test_phase28_step91_implementation_sandbox_pilot_final_release_hold_planning_boundary_packet.py"
$PacketSlug = "phase28_step91_implementation_sandbox_pilot_final_release_hold_planning_boundary_packet"
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 28 Step 91 files copied or already present."
}
...
function Test-Smoke {
    ...
    if ($Missing.Count -gt 0) {
        throw ("Missing Phase 28 Step 91 files: {0}" -f ($Missing -join ", "))
    }
    Write-Host "SMOKE TEST PASS: Phase 28 Step 91 Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Boundary Packet is present and planning-only."
}
