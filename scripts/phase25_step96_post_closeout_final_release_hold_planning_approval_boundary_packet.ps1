...
$StepNumber = 96
$StepTitle = "Phase 25 Step 96 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Approval Boundary Packet"
$ExpectedBranch = "phase25-step96-post-closeout-final-release-hold-planning-approval-boundary"
$PriorStep = "Phase 25 Step 95 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Final Boundary Confirmation Packet"
if ($StepNumber -gt 91) {
    $PriorStep = "Phase 25 Step 95 - previous Phase 25 post-closeout final release hold planning packet"
}

$StepFiles = @(
    "scripts/phase25_step96_post_closeout_final_release_hold_planning_approval_boundary_packet.ps1",
    "ui/pages/472_Phase25_Step96_Implementation_PostCloseout_Final_Release_Hold_Planning_Approval_Boundary_Packet.py",
    "docs/PHASE25_STEP96_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_APPROVAL_BOUNDARY_PACKET.md",
    "tests/test_phase25_step96_post_closeout_final_release_hold_planning_approval_boundary_packet.py"
)
...
$Safety = [ordered]@{
    ...
    phase25_boundary = "implementation_post_closeout_final_release_hold_planning_approval_boundary_opened_by_packet"
    ...
    implementation_post_closeout_final_release_hold_planning_approval_boundary_mode = "reference_only"
    implementation_post_closeout_final_release_hold_planning_approval_boundary_write = $false
    implementation_post_closeout_final_release_hold_planning_approval_boundary_record_creation = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 25 Step 96 files copied or already present."
}
...
function Invoke-SmokeTest {
    ...
    Write-Host "SMOKE TEST PASS: Phase 25 Step 96 Implementation Post-Closeout Final Release Hold Planning Approval Boundary Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $BackupDir = Join-Path $RepoRoot "backups\phase25_step96_post_closeout_final_release_hold_planning_approval_boundary_packet_$Stamp"
    New-Item -ItemType Directory -Path $BackupDir -Force | Out-Null
    $PacketPath = Join-Path $BackupDir "phase25_step96_post_closeout_final_release_hold_planning_approval_boundary_packet.json"
    ...
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_approval_boundary_mode" $Safety.implementation_post_closeout_final_release_hold_planning_approval_boundary_mode
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_approval_boundary_write" $Safety.implementation_post_closeout_final_release_hold_planning_approval_boundary_write
    Write-LowercaseBoolLine "implementation_post_closeout_final_release_hold_planning_approval_boundary_record_creation" $Safety.implementation_post_closeout_final_release_hold_planning_approval_boundary_record_creation
    ...
    Write-Host "CHECK: phase25_context=post_closeout_final_release_hold_planning_approval_boundary_planning_only"
