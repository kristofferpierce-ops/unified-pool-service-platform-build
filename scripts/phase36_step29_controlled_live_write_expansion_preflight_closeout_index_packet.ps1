...
$PhaseNumber = 36
$StepNumber = 29
$StepTitle = "Phase 36 Step 29 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Closeout Index Packet"
$ExpectedBranch = "phase36-step29-controlled-live-write-expansion-preflight-closeout-index"
$PriorCompletedStep = "Phase 36 Step 28 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Operator Hold Point Packet"
...
$StepFiles = @(
    "scripts/phase36_step29_controlled_live_write_expansion_preflight_closeout_index_packet.ps1",
    "ui/pages/1725_Phase36_Step29_Live_Write_Expansion_Preflight_Closeout_Index.py",
    "docs/PHASE36_STEP29_CONTROLLED_LIVE_WRITE_EXPANSION_PREFLIGHT_CLOSEOUT_INDEX_PACKET.md",
    "tests/test_phase36_step29_controlled_live_write_expansion_preflight_closeout_index_packet.py"
)
