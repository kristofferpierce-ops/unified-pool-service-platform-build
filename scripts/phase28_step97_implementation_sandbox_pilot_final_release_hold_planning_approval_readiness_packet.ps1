...
$StepNumber = 97
$StepName = "Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Approval Readiness Packet"
$StepTitle = "Phase 28 Step 97 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Approval Readiness Packet"
$ExpectedBranch = "phase28-step97-implementation-sandbox-pilot-final-release-hold-planning-approval-readiness"
$PriorStep = "Phase 28 Step 96 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Approval Boundary Packet"
$StepKey = "implementation_sandbox_pilot_final_release_hold_planning_approval_readiness"
$BoundaryMarker = "implementation_sandbox_pilot_final_release_hold_planning_approval_readiness_opened_by_packet"
$PhaseContext = "implementation_sandbox_pilot_final_release_hold_planning_only"
$ScriptRel = "scripts/phase28_step97_implementation_sandbox_pilot_final_release_hold_planning_approval_readiness_packet.ps1"
$UiRel = "ui/pages/833_Phase28_Step97_Implementation_Sandbox_Pilot_Final_Release_Hold_Planning_Approval_Readiness_Packet.py"
$DocRel = "docs/PHASE28_STEP97_IMPLEMENTATION_SANDBOX_PILOT_FINAL_RELEASE_HOLD_PLANNING_APPROVAL_READINESS_PACKET.md"
$TestRel = "tests/test_phase28_step97_implementation_sandbox_pilot_final_release_hold_planning_approval_readiness_packet.py"
$PacketSlug = "phase28_step97_implementation_sandbox_pilot_final_release_hold_planning_approval_readiness_packet"
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 28 Step 97 files copied or already present."
}
...
function Test-Smoke {
    ...
    if ($Missing.Count -gt 0) {
        throw ("Missing Phase 28 Step 97 files: {0}" -f ($Missing -join ", "))
    }
    Write-Host "SMOKE TEST PASS: Phase 28 Step 97 Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Approval Readiness Packet is present and planning-only."
}
