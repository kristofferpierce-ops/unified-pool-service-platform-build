...
$PhaseNumber = 37
$StepNumber = 68
$StepTitle = "Phase 37 Step 68 - Phase 20 Network Transport Implementation Trusted Production Monitored Live Write Operations No-Write Dry Run Result Disposition Planning Operator Hold Point Packet"
$PriorCompletedStep = "Phase 37 Step 67 packet"
