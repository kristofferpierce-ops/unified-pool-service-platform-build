...
$PhaseNumber = 36
$StepNumber = 89
$StepTitle = "Phase 36 Step 89 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Closeout Index Packet"
$ExpectedBranch = "phase36-step89-controlled-live-write-expansion-release-gate-verification-planning-closeout-index"
$PriorCompletedStep = "Phase 36 Step 88 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Operator Hold Point Packet"
...
$StepFiles = @(
    "scripts/phase36_step89_controlled_live_write_expansion_release_gate_verification_planning_closeout_index_packet.ps1",
    "ui/pages/1785_Phase36_Step89_Live_Write_Expansion_Release_Gate_Verification_Closeout_Index.py",
    "docs/PHASE36_STEP89_CONTROLLED_LIVE_WRITE_EXPANSION_RELEASE_GATE_VERIFICATION_PLANNING_CLOSEOUT_INDEX_PACKET.md",
    "tests/test_phase36_step89_controlled_live_write_expansion_release_gate_verification_planning_closeout_index_packet.py"
)
