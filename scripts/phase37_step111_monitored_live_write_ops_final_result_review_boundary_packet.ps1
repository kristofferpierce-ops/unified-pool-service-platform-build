...
$PacketTitle = "Phase 37 Step 111 - Phase 20 Network Transport Implementation Trusted Production Monitored Live Write Operations Final Release Result Review Planning Boundary Packet"
...
function Assert-SafetyMarkers {
    ...
    foreach ($Marker in $Forbidden) {
        if ($Compact.Contains($Marker)) {
            throw ("Forbidden unsafe marker detected in Phase 37 Step 111 packet.")
        }
    }
}
