...
$PhaseNumber = 36
$StepNumber = 94
$StepTitle = "Phase 36 Step 94 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Safety Disposition Planning Packet"
$ExpectedBranch = "phase36-step94-controlled-live-write-expansion-final-release-hold-safety-planning"
$PriorCompletedStep = "Phase 36 Step 93 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Hold Planning Evidence Gap Review Packet"
...
$StepFiles = @(
    "scripts/phase36_step94_controlled_live_write_expansion_final_release_hold_safety_planning_packet.ps1",
    "ui/pages/1790_Phase36_Step94_Live_Write_Expansion_Final_Release_Hold_Safety_Planning.py",
    "docs/PHASE36_STEP94_CONTROLLED_LIVE_WRITE_EXPANSION_FINAL_RELEASE_HOLD_SAFETY_PLANNING_PACKET.md",
    "tests/test_phase36_step94_controlled_live_write_expansion_final_release_hold_safety_planning_packet.py"
)
