...
$StepNumber = 17
$StepTitle = "Phase 29 Step 17 - Phase 20 Network Transport Implementation Limited Live Pilot Guardrail Verification Approval Readiness Packet"
$ShortTitle = "Phase 20 Network Transport Implementation Limited Live Pilot Guardrail Verification Approval Readiness Packet"
$ExpectedBranch = "phase29-step17-implementation-limited-live-pilot-guardrail-verification-approval-readiness"
$PriorStep = "Phase 29 Step 16 - Phase 20 Network Transport Implementation Limited Live Pilot Guardrail Verification Approval Boundary Packet"
$Slug = "implementation_limited_live_pilot_guardrail_verification_approval_readiness"
...
$SafetyPosture = [ordered]@{
    ...
    phase29_boundary = "implementation_limited_live_pilot_guardrail_verification_approval_readiness_opened_by_packet"
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 29 Step 17 files copied or already present."
}
...
function Test-Smoke {
    ...
    Write-Host "SMOKE TEST PASS: Phase 29 Step 17 Phase 20 Network Transport Implementation Limited Live Pilot Guardrail Verification Approval Readiness Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $PacketDir = Join-Path $BackupRoot ("phase29_step17_{0}_packet_{1}" -f $Slug, $Timestamp)
    New-Item -ItemType Directory -Path $PacketDir -Force | Out-Null
    $PacketJson = Join-Path $PacketDir ("phase29_step17_{0}_packet.json" -f $Slug)
    ...
    foreach ($Key in @(
        ...
        "cross_repo_mutation",
        "external_repo_push",
        "implementation_limited_live_pilot_guardrail_verification_approval_readiness_mode",
        "implementation_limited_live_pilot_guardrail_verification_approval_readiness_write",
        "implementation_limited_live_pilot_guardrail_verification_approval_readiness_record_creation",
