...
$PhaseNumber = 36
$StepNumber = 84
$StepTitle = "Phase 36 Step 84 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Safety Disposition Planning Packet"
$ExpectedBranch = "phase36-step84-controlled-live-write-expansion-release-gate-verification-planning-safety-planning"
$PriorCompletedStep = "Phase 36 Step 83 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Release Gate Verification Planning Evidence Gap Review Packet"
...
$StepFiles = @(
    "scripts/phase36_step84_controlled_live_write_expansion_release_gate_verification_planning_safety_planning_packet.ps1",
    "ui/pages/1780_Phase36_Step84_Live_Write_Expansion_Release_Gate_Verification_Safety_Planning.py",
    "docs/PHASE36_STEP84_CONTROLLED_LIVE_WRITE_EXPANSION_RELEASE_GATE_VERIFICATION_PLANNING_SAFETY_PLANNING_PACKET.md",
    "tests/test_phase36_step84_controlled_live_write_expansion_release_gate_verification_planning_safety_planning_packet.py"
)
