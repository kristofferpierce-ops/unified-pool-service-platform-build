...
$StepNumber = 9
$StepTitle = "Phase 31 Step 9 - Phase 20 Network Transport Implementation Controlled Active Program Operation Readiness Closeout Index Packet"
$ShortTitle = "Phase 20 Network Transport Implementation Controlled Active Program Operation Readiness Closeout Index Packet"
$ExpectedBranch = "phase31-step9-controlled-active-program-operation-readiness-closeout-index"
$PriorStep = "Phase 31 Step 8 - Phase 20 Network Transport Implementation Controlled Active Program Operation Readiness Operator Hold Point Packet"
$Slug = "implementation_controlled_active_program_operation_readiness_closeout_index"
...
$SafetyPosture = [ordered]@{
    ...
    phase31_boundary = "implementation_controlled_active_program_operation_readiness_closeout_index_opened_by_packet"
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 31 Step 9 files copied or already present."
}
...
function Test-Smoke {
    ...
    Write-Host "SMOKE TEST PASS: Phase 31 Step 9 Phase 20 Network Transport Implementation Controlled Active Program Operation Readiness Closeout Index Packet is present and planning-only."
}
...
function New-Packet {
    ...
    $PacketDir = Join-Path $BackupRoot ("phase31_step9_{0}_packet_{1}" -f $Slug, $Timestamp)
    New-Item -ItemType Directory -Path $PacketDir -Force | Out-Null
    $PacketJson = Join-Path $PacketDir ("phase31_step9_{0}_packet.json" -f $Slug)
