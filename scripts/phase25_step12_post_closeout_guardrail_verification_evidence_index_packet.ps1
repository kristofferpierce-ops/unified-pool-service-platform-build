...
$PhaseNumber = 25
$StepNumber = 12
$StepName = "Phase 25 Step 12 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Evidence Index Packet"
$PriorStepName = "Phase 25 Step 11 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Boundary Packet"
$ExpectedBranch = "phase25-step12-post-closeout-guardrail-verification-evidence-index"
$ModeKey = "implementation_post_closeout_guardrail_verification_evidence_index_mode"
$WriteKey = "implementation_post_closeout_guardrail_verification_evidence_index_write"
$RecordKey = "implementation_post_closeout_guardrail_verification_evidence_index_record_creation"
$PhaseContext = "implementation_post_closeout_guardrail_verification_evidence_index_planning_only"
$PacketSlug = "phase25_step12_post_closeout_guardrail_verification_evidence_index_packet"

$StepFiles = @(
    "scripts/phase25_step12_post_closeout_guardrail_verification_evidence_index_packet.ps1",
    "ui/pages/388_Phase25_Step12_Implementation_PostCloseout_Guardrail_Verification_Evidence_Index_Packet.py",
    "docs/PHASE25_STEP12_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_EVIDENCE_INDEX_PACKET.md",
    "tests/test_phase25_step12_post_closeout_guardrail_verification_evidence_index_packet.py"
)
...
$SafetyPosture = [ordered]@{
    ...
    phase25_boundary = "implementation_post_closeout_guardrail_verification_evidence_index_opened_by_packet"
    ...
    implementation_post_closeout_guardrail_verification_evidence_index_mode = "reference_only"
    implementation_post_closeout_guardrail_verification_evidence_index_write = $false
    implementation_post_closeout_guardrail_verification_evidence_index_record_creation = $false
...
function Apply-StepFiles {
    ...
    Write-Host "APPLY PASS: Phase 25 Step 12 files copied or already present."
}
...
function Invoke-SmokeTest {
    ...
    $scriptText = Get-Content -LiteralPath (Join-SafePath -Root $Repo -RelativePath "scripts/phase25_step12_post_closeout_guardrail_verification_evidence_index_packet.ps1") -Raw -Encoding UTF8
    ...
    Write-Host "SMOKE TEST PASS: Phase 25 Step 12 Implementation Post-Closeout Guardrail Verification Evidence Index Packet is present and planning-only."
}
...
function Write-Packet {
    ...
    Write-Host "PASS: phase25_boundary=implementation_post_closeout_guardrail_verification_evidence_index_opened_by_packet"
    ...
    Write-Host "PASS: implementation_post_closeout_guardrail_verification_evidence_index_mode=reference_only"
    Write-Host "PASS: implementation_post_closeout_guardrail_verification_evidence_index_write=false"
    Write-Host "PASS: implementation_post_closeout_guardrail_verification_evidence_index_record_creation=false"
...
while ($true) {
    Write-Host ""
    Write-Host "Phase 25 Step 12 menu"
    Write-Host "1. Show status / verify paths"
    Write-Host "2. Apply Phase 25 Step 12 Implementation Post-Closeout Guardrail Verification Evidence Index Packet files"
    Write-Host "3. Smoke test Phase 25 Step 12"
    Write-Host "4. Show server start placeholder only"
    Write-Host "5. Generate Phase 25 Step 12 Implementation Post-Closeout Guardrail Verification Evidence Index Packet"
    Write-Host "6. Exit"
