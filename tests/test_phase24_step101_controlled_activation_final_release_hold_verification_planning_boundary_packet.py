...
PHASE = 24
STEP = 101
STEP_TITLE = "Phase 24 Step 101 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Verification Planning Boundary Packet"
PRIOR_STEP = "Phase 24 Step 100 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Final Boundary Confirmation Packet"
BRANCH = "phase24-step101-final-release-hold-verification-boundary"
MODE_KEY = "implementation_controlled_activation_final_release_hold_verification_planning_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_verification_planning_boundary_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_verification_planning_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_verification_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step101_controlled_activation_final_release_hold_verification_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/357_Phase24_Step101_Implementation_Controlled_Activation_Final_Release_Hold_Verification_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP101_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_VERIFICATION_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step101_controlled_activation_final_release_hold_verification_planning_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 101 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 101 files copied or already present." in text
