...
MODE_KEY = "implementation_post_closeout_readiness_closeout_index_mode"
WRITE_KEY = "implementation_post_closeout_readiness_closeout_index_write"
RECORD_KEY = "implementation_post_closeout_readiness_closeout_index_record_creation"
CONTEXT = "implementation_post_closeout_readiness_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step9_post_closeout_readiness_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/385_Phase25_Step9_Implementation_PostCloseout_Readiness_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP9_POST_CLOSEOUT_READINESS_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step9_post_closeout_readiness_closeout_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 9 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 9 files copied or already present." in text
