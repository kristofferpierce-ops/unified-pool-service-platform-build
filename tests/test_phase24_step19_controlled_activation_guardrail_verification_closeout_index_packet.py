...
PHASE = 24
STEP = 19
STEP_TITLE = "Phase 24 Step 19 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Closeout Index Packet"
PRIOR_STEP = "Phase 24 Step 18 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Operator Hold Point Packet"
BRANCH = "phase24-step19-controlled-activation-guardrail-closeout-index"
MODE_KEY = "implementation_controlled_activation_guardrail_verification_closeout_index_mode"
WRITE_KEY = "implementation_controlled_activation_guardrail_verification_closeout_index_write"
RECORD_KEY = "implementation_controlled_activation_guardrail_verification_closeout_index_record_creation"
CONTEXT = "implementation_controlled_activation_guardrail_verification_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step19_controlled_activation_guardrail_verification_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/275_Phase24_Step19_Implementation_Controlled_Activation_Guardrail_Verification_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP19_CONTROLLED_ACTIVATION_GUARDRAIL_VERIFICATION_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step19_controlled_activation_guardrail_verification_closeout_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 19 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 19 files copied or already present." in text
