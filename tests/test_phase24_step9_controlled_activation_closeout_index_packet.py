...
PHASE = 24
STEP = 9
STEP_TITLE = "Phase 24 Step 9 - Phase 20 Network Transport Implementation Controlled Activation Closeout Index Packet"
PRIOR_STEP = "Phase 24 Step 8 - Phase 20 Network Transport Implementation Controlled Activation Operator Hold Point Packet"
BRANCH = "phase24-step9-controlled-activation-closeout-index"
MODE_KEY = "implementation_controlled_activation_closeout_index_mode"
WRITE_KEY = "implementation_controlled_activation_closeout_index_write"
RECORD_KEY = "implementation_controlled_activation_closeout_index_record_creation"
CONTEXT = "implementation_controlled_activation_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step9_controlled_activation_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/265_Phase24_Step9_Implementation_Controlled_Activation_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP9_CONTROLLED_ACTIVATION_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step9_controlled_activation_closeout_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 9 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 9 files copied or already present." in text
