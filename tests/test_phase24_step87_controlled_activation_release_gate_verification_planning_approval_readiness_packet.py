...
MODE_KEY = "implementation_controlled_activation_release_gate_verification_planning_approval_readiness_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_verification_planning_approval_readiness_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_verification_planning_approval_readiness_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_verification_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step87_controlled_activation_release_gate_verification_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/343_Phase24_Step87_Implementation_Controlled_Activation_Release_Gate_Verification_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP87_CONTROLLED_ACTIVATION_RELEASE_GATE_VERIFICATION_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step87_controlled_activation_release_gate_verification_planning_approval_readiness_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 87 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 87 files copied or already present." in text
