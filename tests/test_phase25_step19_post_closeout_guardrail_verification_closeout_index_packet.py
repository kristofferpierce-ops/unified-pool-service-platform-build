...
PHASE = 25
STEP = 19
STEP_TITLE = "Phase 25 Step 19 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Closeout Index Packet"
PRIOR_STEP = "Phase 25 Step 18 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Operator Hold Point Packet"
BRANCH = "phase25-step19-post-closeout-guardrail-verification-closeout-index"
MODE_KEY = "implementation_post_closeout_guardrail_verification_closeout_index_mode"
WRITE_KEY = "implementation_post_closeout_guardrail_verification_closeout_index_write"
RECORD_KEY = "implementation_post_closeout_guardrail_verification_closeout_index_record_creation"
CONTEXT = "implementation_post_closeout_guardrail_verification_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step19_post_closeout_guardrail_verification_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/395_Phase25_Step19_Implementation_PostCloseout_Guardrail_Verification_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP19_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step19_post_closeout_guardrail_verification_closeout_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 19 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 19 files copied or already present." in text
