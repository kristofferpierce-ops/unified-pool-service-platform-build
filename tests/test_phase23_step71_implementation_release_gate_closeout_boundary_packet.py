...
BRANCH = "phase23-step71-implementation-release-gate-closeout-boundary"
MODE_KEY = "implementation_release_gate_closeout_boundary_mode"
WRITE_KEY = "implementation_release_gate_closeout_boundary_write"
RECORD_KEY = "implementation_release_gate_closeout_boundary_record_creation"
CONTEXT = "implementation_release_gate_closeout_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step71_implementation_release_gate_closeout_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/247_Phase23_Step71_Implementation_Release_Gate_Closeout_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP71_IMPLEMENTATION_RELEASE_GATE_CLOSEOUT_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step71_implementation_release_gate_closeout_boundary_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 71 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 71 files copied or already present." in text
