...
PHASE = 25
STEP = 10
STEP_TITLE = "Phase 25 Step 10 - Phase 20 Network Transport Implementation Post-Closeout Readiness Final Boundary Confirmation Packet"
PRIOR_STEP = "Phase 25 Step 9 - Phase 20 Network Transport Implementation Post-Closeout Readiness Closeout Index Packet"
BRANCH = "phase25-step10-post-closeout-readiness-final-boundary-confirmation"
MODE_KEY = "implementation_post_closeout_readiness_final_boundary_confirmation_mode"
WRITE_KEY = "implementation_post_closeout_readiness_final_boundary_confirmation_write"
RECORD_KEY = "implementation_post_closeout_readiness_final_boundary_confirmation_record_creation"
CONTEXT = "implementation_post_closeout_readiness_final_boundary_confirmation_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step10_post_closeout_readiness_final_boundary_confirmation_packet.ps1"
UI_PAGE = ROOT / "ui/pages/386_Phase25_Step10_Implementation_PostCloseout_Readiness_Final_Boundary_Confirmation_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP10_POST_CLOSEOUT_READINESS_FINAL_BOUNDARY_CONFIRMATION_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step10_post_closeout_readiness_final_boundary_confirmation_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 10 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 10 files copied or already present." in text
