...
PHASE = 25
STEP = 28
STEP_TITLE = "Phase 25 Step 28 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Operator Hold Point Packet"
PRIOR_STEP = "Phase 25 Step 27 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Approval Readiness Packet"
BRANCH = "phase25-step28-post-closeout-preflight-planning-operator-hold-point"
MODE_KEY = "implementation_post_closeout_preflight_planning_operator_hold_point_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_operator_hold_point_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_operator_hold_point_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step28_post_closeout_preflight_planning_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/404_Phase25_Step28_Implementation_PostCloseout_Preflight_Planning_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP28_POST_CLOSEOUT_PREFLIGHT_PLANNING_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step28_post_closeout_preflight_planning_operator_hold_point_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 28 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 28 files copied or already present." in text
