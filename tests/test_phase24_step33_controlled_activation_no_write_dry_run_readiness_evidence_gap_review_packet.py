...
PHASE = 24
STEP = 33
STEP_TITLE = "Phase 24 Step 33 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Evidence Gap Review Packet"
PRIOR_STEP = "Phase 24 Step 32 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Evidence Index Packet"
BRANCH = "phase24-step33-ctrl-activation-dry-run-evidence-gap-review"
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_evidence_gap_review_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_evidence_gap_review_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_evidence_gap_review_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_readiness_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step33_controlled_activation_no_write_dry_run_readiness_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/289_Phase24_Step33_Implementation_Controlled_Activation_No_Write_Dry_Run_Readiness_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP33_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_READINESS_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step33_controlled_activation_no_write_dry_run_readiness_evidence_gap_review_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 33 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 33 files copied or already present." in text
