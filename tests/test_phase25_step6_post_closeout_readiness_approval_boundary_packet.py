...
PHASE = 25
STEP = 6
STEP_TITLE = "Phase 25 Step 6 - Phase 20 Network Transport Implementation Post-Closeout Readiness Approval Boundary Packet"
PRIOR_STEP = "Phase 25 Step 5 - Phase 20 Network Transport Implementation Post-Closeout Readiness Safety Disposition Review Packet"
BRANCH = "phase25-step6-post-closeout-readiness-approval-boundary"
MODE_KEY = "implementation_post_closeout_readiness_approval_boundary_mode"
WRITE_KEY = "implementation_post_closeout_readiness_approval_boundary_write"
RECORD_KEY = "implementation_post_closeout_readiness_approval_boundary_record_creation"
CONTEXT = "implementation_post_closeout_readiness_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step6_post_closeout_readiness_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/382_Phase25_Step6_Implementation_PostCloseout_Readiness_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP6_POST_CLOSEOUT_READINESS_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step6_post_closeout_readiness_approval_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 6 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 6 files copied or already present." in text
