...
PHASE = 24
STEP = 20
STEP_TITLE = "Phase 24 Step 20 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Final Boundary Confirmation Packet"
PRIOR_STEP = "Phase 24 Step 19 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Closeout Index Packet"
BRANCH = "phase24-step20-controlled-activation-guardrail-final-boundary"
MODE_KEY = "implementation_controlled_activation_guardrail_verification_final_boundary_confirmation_mode"
WRITE_KEY = "implementation_controlled_activation_guardrail_verification_final_boundary_confirmation_write"
RECORD_KEY = "implementation_controlled_activation_guardrail_verification_final_boundary_confirmation_record_creation"
CONTEXT = "implementation_controlled_activation_guardrail_verification_final_boundary_confirmation_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step20_controlled_activation_guardrail_verification_final_boundary_confirmation_packet.ps1"
UI_PAGE = ROOT / "ui/pages/276_Phase24_Step20_Implementation_Controlled_Activation_Guardrail_Verification_Final_Boundary_Confirmation_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP20_CONTROLLED_ACTIVATION_GUARDRAIL_VERIFICATION_FINAL_BOUNDARY_CONFIRMATION_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step20_controlled_activation_guardrail_verification_final_boundary_confirmation_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 20 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 20 files copied or already present." in text
