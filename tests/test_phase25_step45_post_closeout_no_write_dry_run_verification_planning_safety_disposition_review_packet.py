...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_safety_disposition_review_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_safety_disposition_review_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_safety_disposition_review_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_verification_planning_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step45_post_closeout_no_write_dry_run_verification_planning_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/421_Phase25_Step45_Implementation_PostCloseout_NoWrite_Dry_Run_Verification_Planning_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP45_POST_CLOSEOUT_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step45_post_closeout_no_write_dry_run_verification_planning_safety_disposition_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 45 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 45 files copied or already present." in text
