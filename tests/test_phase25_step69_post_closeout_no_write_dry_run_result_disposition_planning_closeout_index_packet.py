...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_closeout_index_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_closeout_index_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_closeout_index_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step69_post_closeout_no_write_dry_run_result_disposition_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/445_Phase25_Step69_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Disposition_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP69_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_DISPOSITION_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step69_post_closeout_no_write_dry_run_result_disposition_planning_closeout_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 69 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 69 files copied or already present." in text
