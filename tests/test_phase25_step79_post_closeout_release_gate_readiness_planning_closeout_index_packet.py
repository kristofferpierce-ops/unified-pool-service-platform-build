...
PHASE = 25
STEP = 79
STEP_TITLE = "Phase 25 Step 79 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Closeout Index Packet"
PRIOR_STEP = "Phase 25 Step 78 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Operator Hold Point Packet"
BRANCH = "phase25-step79-post-closeout-release-gate-readiness-planning-closeout-index"
MODE_KEY = "implementation_post_closeout_release_gate_readiness_planning_closeout_index_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_readiness_planning_closeout_index_write"
RECORD_KEY = "implementation_post_closeout_release_gate_readiness_planning_closeout_index_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_readiness_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step79_post_closeout_release_gate_readiness_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/455_Phase25_Step79_Implementation_PostCloseout_Release_Gate_Readiness_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP79_POST_CLOSEOUT_RELEASE_GATE_READINESS_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step79_post_closeout_release_gate_readiness_planning_closeout_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 79 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 79 files copied or already present." in text
