...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_approval_readiness_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_approval_readiness_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_approval_readiness_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_review_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step57_post_closeout_no_write_dry_run_result_review_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/433_Phase25_Step57_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Review_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP57_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_REVIEW_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step57_post_closeout_no_write_dry_run_result_review_planning_approval_readiness_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 57 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 57 files copied or already present." in text
