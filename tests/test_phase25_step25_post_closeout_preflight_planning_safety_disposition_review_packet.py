...
PHASE = 25
STEP = 25
STEP_TITLE = "Phase 25 Step 25 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Safety Disposition Review Packet"
PRIOR_STEP = "Phase 25 Step 24 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Safety Disposition Planning Packet"
BRANCH = "phase25-step25-post-closeout-preflight-planning-safety-disposition-review"
MODE_KEY = "implementation_post_closeout_preflight_planning_safety_disposition_review_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_safety_disposition_review_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_safety_disposition_review_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step25_post_closeout_preflight_planning_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/401_Phase25_Step25_Implementation_PostCloseout_Preflight_Planning_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP25_POST_CLOSEOUT_PREFLIGHT_PLANNING_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step25_post_closeout_preflight_planning_safety_disposition_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 25 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 25 files copied or already present." in text
