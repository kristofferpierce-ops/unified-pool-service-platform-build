...
PHASE = 25
STEP = 33
STEP_TITLE = "Phase 25 Step 33 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Evidence Gap Review Packet"
PRIOR_STEP = "Phase 25 Step 32 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Evidence Index Packet"
BRANCH = "phase25-step33-post-closeout-no-write-dry-run-readiness-evidence-gap-review"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_evidence_gap_review_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_evidence_gap_review_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_readiness_evidence_gap_review_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_readiness_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step33_post_closeout_no_write_dry_run_readiness_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/409_Phase25_Step33_Implementation_PostCloseout_NoWrite_Dry_Run_Readiness_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP33_POST_CLOSEOUT_NO_WRITE_DRY_RUN_READINESS_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step33_post_closeout_no_write_dry_run_readiness_evidence_gap_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 33 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 33 files copied or already present." in text
