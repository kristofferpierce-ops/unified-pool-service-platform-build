...
PHASE = 25
STEP = 76
STEP_TITLE = "Phase 25 Step 76 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Approval Boundary Packet"
PRIOR_STEP = "Phase 25 Step 75 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Safety Disposition Review Packet"
BRANCH = "phase25-step76-post-closeout-release-gate-readiness-planning-approval-boundary"
MODE_KEY = "implementation_post_closeout_release_gate_readiness_planning_approval_boundary_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_readiness_planning_approval_boundary_write"
RECORD_KEY = "implementation_post_closeout_release_gate_readiness_planning_approval_boundary_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_readiness_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step76_post_closeout_release_gate_readiness_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/452_Phase25_Step76_Implementation_PostCloseout_Release_Gate_Readiness_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP76_POST_CLOSEOUT_RELEASE_GATE_READINESS_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step76_post_closeout_release_gate_readiness_planning_approval_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 76 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 76 files copied or already present." in text
