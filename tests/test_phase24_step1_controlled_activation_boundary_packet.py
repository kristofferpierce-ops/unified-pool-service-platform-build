...
PHASE = 24
STEP = 1
STEP_TITLE = "Phase 24 Step 1 - Phase 20 Network Transport Implementation Controlled Activation Boundary Packet"
PRIOR_STEP = "Phase 23 Step 80 - Phase 20 Network Transport Implementation Phase 23 Final No-Write Closeout Packet"
BRANCH = "phase24-step1-controlled-activation-boundary"
MODE_KEY = "implementation_controlled_activation_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_boundary_write"
RECORD_KEY = "implementation_controlled_activation_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step1_controlled_activation_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/257_Phase24_Step1_Implementation_Controlled_Activation_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP1_CONTROLLED_ACTIVATION_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step1_controlled_activation_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 1 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 1 files copied or already present." in text
