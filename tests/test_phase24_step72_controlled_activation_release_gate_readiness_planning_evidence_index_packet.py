...
MODE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_evidence_index_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_evidence_index_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_readiness_planning_evidence_index_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_readiness_planning_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step72_controlled_activation_release_gate_readiness_planning_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/328_Phase24_Step72_Implementation_Controlled_Activation_Release_Gate_Readiness_Planning_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP72_CONTROLLED_ACTIVATION_RELEASE_GATE_READINESS_PLANNING_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step72_controlled_activation_release_gate_readiness_planning_evidence_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 72 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 72 files copied or already present." in text
