...
PHASE = 24
STEP = 2
STEP_TITLE = "Phase 24 Step 2 - Phase 20 Network Transport Implementation Controlled Activation Evidence Index Packet"
PRIOR_STEP = "Phase 24 Step 1 - Phase 20 Network Transport Implementation Controlled Activation Boundary Packet"
BRANCH = "phase24-step2-controlled-activation-evidence-index"
MODE_KEY = "implementation_controlled_activation_evidence_index_mode"
WRITE_KEY = "implementation_controlled_activation_evidence_index_write"
RECORD_KEY = "implementation_controlled_activation_evidence_index_record_creation"
CONTEXT = "implementation_controlled_activation_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step2_controlled_activation_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/258_Phase24_Step2_Implementation_Controlled_Activation_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP2_CONTROLLED_ACTIVATION_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step2_controlled_activation_evidence_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 2 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 2 files copied or already present." in text
