...
MODE_KEY = "implementation_post_closeout_release_gate_verification_planning_operator_hold_point_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_verification_planning_operator_hold_point_write"
RECORD_KEY = "implementation_post_closeout_release_gate_verification_planning_operator_hold_point_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_verification_planning_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step88_post_closeout_release_gate_verification_planning_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/464_Phase25_Step88_Implementation_PostCloseout_Release_Gate_Verification_Planning_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP88_POST_CLOSEOUT_RELEASE_GATE_VERIFICATION_PLANNING_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step88_post_closeout_release_gate_verification_planning_operator_hold_point_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 88 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 88 files copied or already present." in text
