...
PHASE = 24
STEP = 82
STEP_TITLE = "Phase 24 Step 82 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Verification Planning Evidence Index Packet"
PRIOR_STEP = "Phase 24 Step 81 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Verification Planning Boundary Packet"
BRANCH = "phase24-step82-release-gate-verification-evidence-index"
MODE_KEY = "implementation_controlled_activation_release_gate_verification_planning_evidence_index_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_verification_planning_evidence_index_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_verification_planning_evidence_index_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_verification_planning_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step82_controlled_activation_release_gate_verification_planning_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/338_Phase24_Step82_Implementation_Controlled_Activation_Release_Gate_Verification_Planning_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP82_CONTROLLED_ACTIVATION_RELEASE_GATE_VERIFICATION_PLANNING_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step82_controlled_activation_release_gate_verification_planning_evidence_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 82 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 82 files copied or already present." in text
