...
PHASE = 24
STEP = 89
STEP_TITLE = "Phase 24 Step 89 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Verification Planning Closeout Index Packet"
PRIOR_STEP = "Phase 24 Step 88 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Verification Planning Operator Hold Point Packet"
BRANCH = "phase24-step89-release-gate-verification-closeout-index"
MODE_KEY = "implementation_controlled_activation_release_gate_verification_planning_closeout_index_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_verification_planning_closeout_index_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_verification_planning_closeout_index_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_verification_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step89_controlled_activation_release_gate_verification_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/345_Phase24_Step89_Implementation_Controlled_Activation_Release_Gate_Verification_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP89_CONTROLLED_ACTIVATION_RELEASE_GATE_VERIFICATION_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step89_controlled_activation_release_gate_verification_planning_closeout_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 89 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 89 files copied or already present." in text
