...
PHASE = 24
STEP = 39
STEP_TITLE = "Phase 24 Step 39 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Closeout Index Packet"
PRIOR_STEP = "Phase 24 Step 38 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Operator Hold Point Packet"
BRANCH = "phase24-step39-ctrl-activation-dry-run-closeout-index"
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_closeout_index_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_closeout_index_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_closeout_index_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_readiness_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step39_controlled_activation_no_write_dry_run_readiness_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/295_Phase24_Step39_Implementation_Controlled_Activation_No_Write_Dry_Run_Readiness_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP39_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_READINESS_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step39_controlled_activation_no_write_dry_run_readiness_closeout_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 39 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 39 files copied or already present." in text
