...
PHASE = 24
STEP = 13
STEP_TITLE = "Phase 24 Step 13 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Evidence Gap Review Packet"
PRIOR_STEP = "Phase 24 Step 12 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Evidence Index Packet"
BRANCH = "phase24-step13-controlled-activation-guardrail-evidence-gap-review"
MODE_KEY = "implementation_controlled_activation_guardrail_verification_evidence_gap_review_mode"
WRITE_KEY = "implementation_controlled_activation_guardrail_verification_evidence_gap_review_write"
RECORD_KEY = "implementation_controlled_activation_guardrail_verification_evidence_gap_review_record_creation"
CONTEXT = "implementation_controlled_activation_guardrail_verification_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step13_controlled_activation_guardrail_verification_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/269_Phase24_Step13_Implementation_Controlled_Activation_Guardrail_Verification_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP13_CONTROLLED_ACTIVATION_GUARDRAIL_VERIFICATION_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step13_controlled_activation_guardrail_verification_evidence_gap_review_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 13 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 13 files copied or already present." in text
