...
PHASE = 24
STEP = 79
STEP_TITLE = "Phase 24 Step 79 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Readiness Planning Closeout Index Packet"
PRIOR_STEP = "Phase 24 Step 78 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Readiness Planning Operator Hold Point Packet"
BRANCH = "phase24-step79-release-gate-readiness-closeout-index"
MODE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_closeout_index_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_closeout_index_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_readiness_planning_closeout_index_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_readiness_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step79_controlled_activation_release_gate_readiness_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/335_Phase24_Step79_Implementation_Controlled_Activation_Release_Gate_Readiness_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP79_CONTROLLED_ACTIVATION_RELEASE_GATE_READINESS_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step79_controlled_activation_release_gate_readiness_planning_closeout_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 79 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 79 files copied or already present." in text
