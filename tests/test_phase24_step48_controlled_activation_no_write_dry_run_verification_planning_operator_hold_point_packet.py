...
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_verification_planning_operator_hold_point_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_verification_planning_operator_hold_point_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_verification_planning_operator_hold_point_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_verification_planning_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step48_controlled_activation_no_write_dry_run_verification_planning_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/304_Phase24_Step48_Implementation_Controlled_Activation_No_Write_Dry_Run_Verification_Planning_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP48_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step48_controlled_activation_no_write_dry_run_verification_planning_operator_hold_point_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 48 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 48 files copied or already present." in text
