...
BRANCH = "phase23-step32-implementation-patch-assembly-planning-approval-readiness"
MODE_KEY = "implementation_patch_assembly_planning_approval_readiness_mode"
WRITE_KEY = "implementation_patch_assembly_planning_approval_readiness_write"
RECORD_KEY = "implementation_patch_assembly_planning_approval_readiness_record_creation"
CONTEXT = "implementation_patch_assembly_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step32_implementation_patch_assembly_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/208_Phase23_Step32_Implementation_Patch_Assembly_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP32_IMPLEMENTATION_PATCH_ASSEMBLY_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step32_implementation_patch_assembly_planning_approval_readiness_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 32 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 32 files copied or already present." in text
