...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_approval_boundary_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_approval_boundary_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_approval_boundary_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step66_post_closeout_no_write_dry_run_result_disposition_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/442_Phase25_Step66_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Disposition_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP66_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_DISPOSITION_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step66_post_closeout_no_write_dry_run_result_disposition_planning_approval_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 66 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 66 files copied or already present." in text
