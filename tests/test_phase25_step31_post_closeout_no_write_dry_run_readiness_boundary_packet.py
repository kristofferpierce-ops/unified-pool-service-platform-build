...
PHASE = 25
STEP = 31
STEP_TITLE = "Phase 25 Step 31 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Boundary Packet"
PRIOR_STEP = "Phase 25 Step 30 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Final Boundary Confirmation Packet"
BRANCH = "phase25-step31-post-closeout-no-write-dry-run-readiness-boundary"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_boundary_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_boundary_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_readiness_boundary_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_readiness_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step31_post_closeout_no_write_dry_run_readiness_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/407_Phase25_Step31_Implementation_PostCloseout_NoWrite_Dry_Run_Readiness_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP31_POST_CLOSEOUT_NO_WRITE_DRY_RUN_READINESS_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step31_post_closeout_no_write_dry_run_readiness_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 31 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 31 files copied or already present." in text
