...
BRANCH = "phase23-step15-implementation-guardrail-evidence-gap-disposition-review"
MODE_KEY = "implementation_guardrail_evidence_gap_disposition_review_mode"
WRITE_KEY = "implementation_guardrail_evidence_gap_disposition_review_write"
RECORD_KEY = "implementation_guardrail_evidence_gap_disposition_review_record_creation"
CONTEXT = "implementation_guardrail_evidence_gap_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step15_implementation_guardrail_evidence_gap_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/191_Phase23_Step15_Implementation_Guardrail_Evidence_Gap_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP15_IMPLEMENTATION_GUARDRAIL_EVIDENCE_GAP_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step15_implementation_guardrail_evidence_gap_disposition_review_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 15 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 15 files copied or already present." in text
