...
PHASE = 25
STEP = 22
STEP_TITLE = "Phase 25 Step 22 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Evidence Index Packet"
PRIOR_STEP = "Phase 25 Step 21 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Boundary Packet"
BRANCH = "phase25-step22-post-closeout-preflight-planning-evidence-index"
MODE_KEY = "implementation_post_closeout_preflight_planning_evidence_index_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_evidence_index_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_evidence_index_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step22_post_closeout_preflight_planning_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/398_Phase25_Step22_Implementation_PostCloseout_Preflight_Planning_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP22_POST_CLOSEOUT_PREFLIGHT_PLANNING_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step22_post_closeout_preflight_planning_evidence_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 22 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 22 files copied or already present." in text
