...
MODE_KEY = "implementation_post_closeout_release_gate_readiness_planning_safety_disposition_planning_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_readiness_planning_safety_disposition_planning_write"
RECORD_KEY = "implementation_post_closeout_release_gate_readiness_planning_safety_disposition_planning_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_readiness_planning_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step74_post_closeout_release_gate_readiness_planning_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/450_Phase25_Step74_Implementation_PostCloseout_Release_Gate_Readiness_Planning_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP74_POST_CLOSEOUT_RELEASE_GATE_READINESS_PLANNING_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step74_post_closeout_release_gate_readiness_planning_safety_disposition_planning_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 74 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 74 files copied or already present." in text
