...
PHASE = 24
STEP = 111
STEP_TITLE = "Phase 24 Step 111 - Phase 20 Network Transport Implementation Controlled Activation Final Release Result Review Planning Boundary Packet"
PRIOR_STEP = "Phase 24 Step 110 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Verification Planning Final Boundary Confirmation Packet"
BRANCH = "phase24-step111-final-release-result-review-boundary"
MODE_KEY = "implementation_controlled_activation_final_release_result_review_planning_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_result_review_planning_boundary_write"
RECORD_KEY = "implementation_controlled_activation_final_release_result_review_planning_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_result_review_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step111_controlled_activation_final_release_result_review_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/367_Phase24_Step111_Implementation_Controlled_Activation_Final_Release_Result_Review_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP111_CONTROLLED_ACTIVATION_FINAL_RELEASE_RESULT_REVIEW_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step111_controlled_activation_final_release_result_review_planning_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 111 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 111 files copied or already present." in text
