...
PHASE = 25
STEP = 13
STEP_TITLE = "Phase 25 Step 13 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Evidence Gap Review Packet"
PRIOR_STEP = "Phase 25 Step 12 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Evidence Index Packet"
BRANCH = "phase25-step13-post-closeout-guardrail-verification-evidence-gap-review"
MODE_KEY = "implementation_post_closeout_guardrail_verification_evidence_gap_review_mode"
WRITE_KEY = "implementation_post_closeout_guardrail_verification_evidence_gap_review_write"
RECORD_KEY = "implementation_post_closeout_guardrail_verification_evidence_gap_review_record_creation"
CONTEXT = "implementation_post_closeout_guardrail_verification_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step13_post_closeout_guardrail_verification_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/389_Phase25_Step13_Implementation_PostCloseout_Guardrail_Verification_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP13_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step13_post_closeout_guardrail_verification_evidence_gap_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 13 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 13 files copied or already present." in text
