...
PHASE = 24
STEP = 6
STEP_TITLE = "Phase 24 Step 6 - Phase 20 Network Transport Implementation Controlled Activation Approval Boundary Packet"
PRIOR_STEP = "Phase 24 Step 5 - Phase 20 Network Transport Implementation Controlled Activation Safety Disposition Review Packet"
BRANCH = "phase24-step6-controlled-activation-approval-boundary"
MODE_KEY = "implementation_controlled_activation_approval_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_approval_boundary_write"
RECORD_KEY = "implementation_controlled_activation_approval_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step6_controlled_activation_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/262_Phase24_Step6_Implementation_Controlled_Activation_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP6_CONTROLLED_ACTIVATION_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step6_controlled_activation_approval_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 6 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 6 files copied or already present." in text
