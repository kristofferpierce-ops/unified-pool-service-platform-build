...
PHASE = 25
STEP = 81
STEP_TITLE = "Phase 25 Step 81 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Boundary Packet"
PRIOR_STEP = "Phase 25 Step 80 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Final Boundary Confirmation Packet"
BRANCH = "phase25-step81-post-closeout-release-gate-verification-planning-boundary"
MODE_KEY = "implementation_post_closeout_release_gate_verification_planning_boundary_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_verification_planning_boundary_write"
RECORD_KEY = "implementation_post_closeout_release_gate_verification_planning_boundary_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_verification_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step81_post_closeout_release_gate_verification_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/457_Phase25_Step81_Implementation_PostCloseout_Release_Gate_Verification_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP81_POST_CLOSEOUT_RELEASE_GATE_VERIFICATION_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step81_post_closeout_release_gate_verification_planning_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 81 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 81 files copied or already present." in text
