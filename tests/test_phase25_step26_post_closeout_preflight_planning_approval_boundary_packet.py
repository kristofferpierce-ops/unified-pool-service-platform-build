...
PHASE = 25
STEP = 26
STEP_TITLE = "Phase 25 Step 26 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Approval Boundary Packet"
PRIOR_STEP = "Phase 25 Step 25 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Safety Disposition Review Packet"
BRANCH = "phase25-step26-post-closeout-preflight-planning-approval-boundary"
MODE_KEY = "implementation_post_closeout_preflight_planning_approval_boundary_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_approval_boundary_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_approval_boundary_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step26_post_closeout_preflight_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/402_Phase25_Step26_Implementation_PostCloseout_Preflight_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP26_POST_CLOSEOUT_PREFLIGHT_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step26_post_closeout_preflight_planning_approval_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 26 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 26 files copied or already present." in text
