...
PHASE = 25
STEP = 14
STEP_TITLE = "Phase 25 Step 14 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Safety Disposition Planning Packet"
PRIOR_STEP = "Phase 25 Step 13 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Evidence Gap Review Packet"
BRANCH = "phase25-step14-post-closeout-guardrail-verification-safety-disposition-planning"
MODE_KEY = "implementation_post_closeout_guardrail_verification_safety_disposition_planning_mode"
WRITE_KEY = "implementation_post_closeout_guardrail_verification_safety_disposition_planning_write"
RECORD_KEY = "implementation_post_closeout_guardrail_verification_safety_disposition_planning_record_creation"
CONTEXT = "implementation_post_closeout_guardrail_verification_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step14_post_closeout_guardrail_verification_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/390_Phase25_Step14_Implementation_PostCloseout_Guardrail_Verification_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP14_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step14_post_closeout_guardrail_verification_safety_disposition_planning_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 14 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 14 files copied or already present." in text
