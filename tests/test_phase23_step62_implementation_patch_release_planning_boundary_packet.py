...
BRANCH = "phase23-step62-implementation-patch-release-planning-boundary"
MODE_KEY = "implementation_patch_release_planning_boundary_mode"
WRITE_KEY = "implementation_patch_release_planning_boundary_write"
RECORD_KEY = "implementation_patch_release_planning_boundary_record_creation"
CONTEXT = "implementation_patch_release_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step62_implementation_patch_release_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/238_Phase23_Step62_Implementation_Patch_Release_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP62_IMPLEMENTATION_PATCH_RELEASE_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step62_implementation_patch_release_planning_boundary_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 62 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 62 files copied or already present." in text
