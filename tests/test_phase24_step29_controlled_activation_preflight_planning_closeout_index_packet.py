...
PHASE = 24
STEP = 29
STEP_TITLE = "Phase 24 Step 29 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Closeout Index Packet"
PRIOR_STEP = "Phase 24 Step 28 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Operator Hold Point Packet"
BRANCH = "phase24-step29-ctrl-activation-preflight-closeout-index"
MODE_KEY = "implementation_controlled_activation_preflight_planning_closeout_index_mode"
WRITE_KEY = "implementation_controlled_activation_preflight_planning_closeout_index_write"
RECORD_KEY = "implementation_controlled_activation_preflight_planning_closeout_index_record_creation"
CONTEXT = "implementation_controlled_activation_preflight_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step29_controlled_activation_preflight_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/285_Phase24_Step29_Implementation_Controlled_Activation_Preflight_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP29_CONTROLLED_ACTIVATION_PREFLIGHT_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step29_controlled_activation_preflight_planning_closeout_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 29 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 29 files copied or already present." in text
