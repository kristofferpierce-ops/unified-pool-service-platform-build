...
PHASE = 25
STEP = 32
STEP_TITLE = "Phase 25 Step 32 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Evidence Index Packet"
PRIOR_STEP = "Phase 25 Step 31 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Boundary Packet"
BRANCH = "phase25-step32-post-closeout-no-write-dry-run-readiness-evidence-index"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_evidence_index_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_evidence_index_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_readiness_evidence_index_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_readiness_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step32_post_closeout_no_write_dry_run_readiness_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/408_Phase25_Step32_Implementation_PostCloseout_NoWrite_Dry_Run_Readiness_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP32_POST_CLOSEOUT_NO_WRITE_DRY_RUN_READINESS_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step32_post_closeout_no_write_dry_run_readiness_evidence_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 32 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 32 files copied or already present." in text
