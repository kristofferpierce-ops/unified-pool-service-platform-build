...
PHASE = 25
STEP = 61
STEP_TITLE = "Phase 25 Step 61 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Result Disposition Planning Boundary Packet"
PRIOR_STEP = "Phase 25 Step 60 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Result Review Planning Final Boundary Confirmation Packet"
BRANCH = "phase25-step61-post-closeout-no-write-dry-run-result-disposition-planning-boundary"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_boundary_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_boundary_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_boundary_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step61_post_closeout_no_write_dry_run_result_disposition_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/437_Phase25_Step61_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Disposition_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP61_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_DISPOSITION_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step61_post_closeout_no_write_dry_run_result_disposition_planning_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 61 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 61 files copied or already present." in text
