...
MODE_KEY = "implementation_controlled_activation_final_release_hold_planning_safety_disposition_planning_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_planning_safety_disposition_planning_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_planning_safety_disposition_planning_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_planning_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step94_controlled_activation_final_release_hold_planning_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/350_Phase24_Step94_Implementation_Controlled_Activation_Final_Release_Hold_Planning_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP94_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_PLANNING_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step94_controlled_activation_final_release_hold_planning_safety_disposition_planning_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 94 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 94 files copied or already present." in text
