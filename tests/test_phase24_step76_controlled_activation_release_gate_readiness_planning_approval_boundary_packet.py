...
PHASE = 24
STEP = 76
STEP_TITLE = "Phase 24 Step 76 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Readiness Planning Approval Boundary Packet"
PRIOR_STEP = "Phase 24 Step 75 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Readiness Planning Safety Disposition Review Packet"
BRANCH = "phase24-step76-release-gate-readiness-approval-boundary"
MODE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_approval_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_approval_boundary_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_readiness_planning_approval_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_readiness_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step76_controlled_activation_release_gate_readiness_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/332_Phase24_Step76_Implementation_Controlled_Activation_Release_Gate_Readiness_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP76_CONTROLLED_ACTIVATION_RELEASE_GATE_READINESS_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step76_controlled_activation_release_gate_readiness_planning_approval_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 76 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 76 files copied or already present." in text
