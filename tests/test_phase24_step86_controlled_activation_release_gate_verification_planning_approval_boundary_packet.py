...
MODE_KEY = "implementation_controlled_activation_release_gate_verification_planning_approval_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_verification_planning_approval_boundary_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_verification_planning_approval_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_verification_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step86_controlled_activation_release_gate_verification_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/342_Phase24_Step86_Implementation_Controlled_Activation_Release_Gate_Verification_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP86_CONTROLLED_ACTIVATION_RELEASE_GATE_VERIFICATION_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step86_controlled_activation_release_gate_verification_planning_approval_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 86 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 86 files copied or already present." in text
