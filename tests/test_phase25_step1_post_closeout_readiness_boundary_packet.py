...
PHASE = 25
STEP = 1
STEP_TITLE = "Phase 25 Step 1 - Phase 20 Network Transport Implementation Post-Closeout Readiness Boundary Packet"
PRIOR_STEP = "Phase 24 Step 120 - Phase 20 Network Transport Implementation Phase 24 Final No-Write Closeout Hold Packet"
BRANCH = "phase25-step1-post-closeout-readiness-boundary"
MODE_KEY = "implementation_post_closeout_readiness_boundary_mode"
WRITE_KEY = "implementation_post_closeout_readiness_boundary_write"
RECORD_KEY = "implementation_post_closeout_readiness_boundary_record_creation"
CONTEXT = "implementation_post_closeout_readiness_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step1_post_closeout_readiness_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/377_Phase25_Step1_Implementation_PostCloseout_Readiness_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP1_POST_CLOSEOUT_READINESS_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step1_post_closeout_readiness_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 1 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 1 files copied or already present." in text
