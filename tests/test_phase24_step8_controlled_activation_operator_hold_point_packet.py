...
PHASE = 24
STEP = 8
STEP_TITLE = "Phase 24 Step 8 - Phase 20 Network Transport Implementation Controlled Activation Operator Hold Point Packet"
PRIOR_STEP = "Phase 24 Step 7 - Phase 20 Network Transport Implementation Controlled Activation Approval Readiness Packet"
BRANCH = "phase24-step8-controlled-activation-operator-hold-point"
MODE_KEY = "implementation_controlled_activation_operator_hold_point_mode"
WRITE_KEY = "implementation_controlled_activation_operator_hold_point_write"
RECORD_KEY = "implementation_controlled_activation_operator_hold_point_record_creation"
CONTEXT = "implementation_controlled_activation_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step8_controlled_activation_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/264_Phase24_Step8_Implementation_Controlled_Activation_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP8_CONTROLLED_ACTIVATION_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step8_controlled_activation_operator_hold_point_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 8 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 8 files copied or already present." in text
