...
PHASE = 24
STEP = 97
STEP_TITLE = "Phase 24 Step 97 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Approval Readiness Packet"
PRIOR_STEP = "Phase 24 Step 96 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Approval Boundary Packet"
BRANCH = "phase24-step97-final-release-hold-approval-readiness"
MODE_KEY = "implementation_controlled_activation_final_release_hold_planning_approval_readiness_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_planning_approval_readiness_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_planning_approval_readiness_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step97_controlled_activation_final_release_hold_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/353_Phase24_Step97_Implementation_Controlled_Activation_Final_Release_Hold_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP97_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step97_controlled_activation_final_release_hold_planning_approval_readiness_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 97 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 97 files copied or already present." in text
