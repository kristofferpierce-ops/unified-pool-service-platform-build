...
PHASE = 25
STEP = 77
STEP_TITLE = "Phase 25 Step 77 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Approval Readiness Packet"
PRIOR_STEP = "Phase 25 Step 76 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Approval Boundary Packet"
BRANCH = "phase25-step77-post-closeout-release-gate-readiness-planning-approval-readiness"
MODE_KEY = "implementation_post_closeout_release_gate_readiness_planning_approval_readiness_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_readiness_planning_approval_readiness_write"
RECORD_KEY = "implementation_post_closeout_release_gate_readiness_planning_approval_readiness_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_readiness_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step77_post_closeout_release_gate_readiness_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/453_Phase25_Step77_Implementation_PostCloseout_Release_Gate_Readiness_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP77_POST_CLOSEOUT_RELEASE_GATE_READINESS_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step77_post_closeout_release_gate_readiness_planning_approval_readiness_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 77 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 77 files copied or already present." in text
