...
SCRIPT = REPO / "scripts/phase37_step18_monitored_live_write_ops_guardrail_operator_hold_packet.ps1"
UI = REPO / "ui/pages/1834_Phase37_Step18_Monitored_Live_Write_Ops_Guardrail_Operator_Hold.py"
DOC = REPO / "docs/PHASE37_STEP18_MONITORED_LIVE_WRITE_OPS_GUARDRAIL_OPERATOR_HOLD_PACKET.md"
TEST = REPO / "tests/test_phase37_step18_monitored_live_write_ops_guardrail_operator_hold_packet.py"
...
def test_phase37_step18_files_exist():
...
def test_phase37_step18_launcher_has_valid_param_block():
    text = _read(SCRIPT)
...
def test_phase37_step18_required_safety_markers_present():
...
def test_phase37_step18_forbidden_true_markers_absent():
...
def test_phase37_step18_literal_pass_markers_present():
    text = _read(SCRIPT)
    assert "APPLY PASS" in text
    assert "SMOKE TEST PASS" in text


def test_phase37_step18_launcher_smoke_passes():
