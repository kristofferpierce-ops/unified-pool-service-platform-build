...
PHASE = 24
STEP = 31
STEP_TITLE = "Phase 24 Step 31 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Boundary Packet"
PRIOR_STEP = "Phase 24 Step 30 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Final Boundary Confirmation Packet"
BRANCH = "phase24-step31-ctrl-activation-dry-run-boundary"
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_boundary_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_readiness_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step31_controlled_activation_no_write_dry_run_readiness_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/287_Phase24_Step31_Implementation_Controlled_Activation_No_Write_Dry_Run_Readiness_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP31_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_READINESS_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step31_controlled_activation_no_write_dry_run_readiness_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 31 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 31 files copied or already present." in text
