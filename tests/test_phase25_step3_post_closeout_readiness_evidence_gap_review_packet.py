...
PHASE = 25
STEP = 3
STEP_TITLE = "Phase 25 Step 3 - Phase 20 Network Transport Implementation Post-Closeout Readiness Evidence Gap Review Packet"
PRIOR_STEP = "Phase 25 Step 2 - Phase 20 Network Transport Implementation Post-Closeout Readiness Evidence Index Packet"
BRANCH = "phase25-step3-post-closeout-readiness-evidence-gap-review"
MODE_KEY = "implementation_post_closeout_readiness_evidence_gap_review_mode"
WRITE_KEY = "implementation_post_closeout_readiness_evidence_gap_review_write"
RECORD_KEY = "implementation_post_closeout_readiness_evidence_gap_review_record_creation"
CONTEXT = "implementation_post_closeout_readiness_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step3_post_closeout_readiness_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/379_Phase25_Step3_Implementation_PostCloseout_Readiness_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP3_POST_CLOSEOUT_READINESS_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step3_post_closeout_readiness_evidence_gap_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 3 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 3 files copied or already present." in text
