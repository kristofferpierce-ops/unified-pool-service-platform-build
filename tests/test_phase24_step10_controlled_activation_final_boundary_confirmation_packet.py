...
MODE_KEY = "implementation_controlled_activation_final_boundary_confirmation_mode"
WRITE_KEY = "implementation_controlled_activation_final_boundary_confirmation_write"
RECORD_KEY = "implementation_controlled_activation_final_boundary_confirmation_record_creation"
CONTEXT = "implementation_controlled_activation_final_boundary_confirmation_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step10_controlled_activation_final_boundary_confirmation_packet.ps1"
UI_PAGE = ROOT / "ui/pages/266_Phase24_Step10_Implementation_Controlled_Activation_Final_Boundary_Confirmation_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP10_CONTROLLED_ACTIVATION_FINAL_BOUNDARY_CONFIRMATION_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step10_controlled_activation_final_boundary_confirmation_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 10 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 10 files copied or already present." in text
