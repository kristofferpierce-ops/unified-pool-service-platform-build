...
PHASE = 25
STEP = 75
STEP_TITLE = "Phase 25 Step 75 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Safety Disposition Review Packet"
PRIOR_STEP = "Phase 25 Step 74 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Safety Disposition Planning Packet"
BRANCH = "phase25-step75-post-closeout-release-gate-readiness-planning-safety-disposition-review"
MODE_KEY = "implementation_post_closeout_release_gate_readiness_planning_safety_disposition_review_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_readiness_planning_safety_disposition_review_write"
RECORD_KEY = "implementation_post_closeout_release_gate_readiness_planning_safety_disposition_review_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_readiness_planning_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step75_post_closeout_release_gate_readiness_planning_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/451_Phase25_Step75_Implementation_PostCloseout_Release_Gate_Readiness_Planning_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP75_POST_CLOSEOUT_RELEASE_GATE_READINESS_PLANNING_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step75_post_closeout_release_gate_readiness_planning_safety_disposition_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 75 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 75 files copied or already present." in text
