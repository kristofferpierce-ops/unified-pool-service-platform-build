...
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_boundary_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step61_controlled_activation_no_write_dry_run_result_disposition_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/317_Phase24_Step61_Implementation_Controlled_Activation_No_Write_Dry_Run_Result_Disposition_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP61_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_RESULT_DISPOSITION_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step61_controlled_activation_no_write_dry_run_result_disposition_planning_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 61 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 61 files copied or already present." in text
