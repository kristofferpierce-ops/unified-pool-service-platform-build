...
MODE_KEY = "phase23_final_no_write_closeout_mode"
WRITE_KEY = "phase23_final_no_write_closeout_write"
RECORD_KEY = "phase23_final_no_write_closeout_record_creation"
CONTEXT = "phase23_final_no_write_closeout_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step80_phase23_final_no_write_closeout_packet.ps1"
UI_PAGE = ROOT / "ui/pages/256_Phase23_Step80_Phase23_Final_No_Write_Closeout_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP80_PHASE23_FINAL_NO_WRITE_CLOSEOUT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step80_phase23_final_no_write_closeout_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 80 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 80 files copied or already present." in text
