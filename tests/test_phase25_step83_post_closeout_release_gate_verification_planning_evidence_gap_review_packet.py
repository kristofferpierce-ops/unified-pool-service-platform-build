...
PHASE = 25
STEP = 83
STEP_TITLE = "Phase 25 Step 83 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Evidence Gap Review Packet"
PRIOR_STEP = "Phase 25 Step 82 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Evidence Index Packet"
BRANCH = "phase25-step83-post-closeout-release-gate-verification-planning-evidence-gap-review"
MODE_KEY = "implementation_post_closeout_release_gate_verification_planning_evidence_gap_review_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_verification_planning_evidence_gap_review_write"
RECORD_KEY = "implementation_post_closeout_release_gate_verification_planning_evidence_gap_review_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_verification_planning_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step83_post_closeout_release_gate_verification_planning_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/459_Phase25_Step83_Implementation_PostCloseout_Release_Gate_Verification_Planning_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP83_POST_CLOSEOUT_RELEASE_GATE_VERIFICATION_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step83_post_closeout_release_gate_verification_planning_evidence_gap_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 83 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 83 files copied or already present." in text
