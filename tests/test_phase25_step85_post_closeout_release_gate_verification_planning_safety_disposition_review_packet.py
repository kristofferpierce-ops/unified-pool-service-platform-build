...
MODE_KEY = "implementation_post_closeout_release_gate_verification_planning_safety_disposition_review_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_verification_planning_safety_disposition_review_write"
RECORD_KEY = "implementation_post_closeout_release_gate_verification_planning_safety_disposition_review_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_verification_planning_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step85_post_closeout_release_gate_verification_planning_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/461_Phase25_Step85_Implementation_PostCloseout_Release_Gate_Verification_Planning_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP85_POST_CLOSEOUT_RELEASE_GATE_VERIFICATION_PLANNING_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step85_post_closeout_release_gate_verification_planning_safety_disposition_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 85 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 85 files copied or already present." in text
