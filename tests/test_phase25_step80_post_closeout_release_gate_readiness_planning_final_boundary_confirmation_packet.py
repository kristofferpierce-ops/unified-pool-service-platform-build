...
MODE_KEY = "implementation_post_closeout_release_gate_readiness_planning_final_boundary_confirmation_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_readiness_planning_final_boundary_confirmation_write"
RECORD_KEY = "implementation_post_closeout_release_gate_readiness_planning_final_boundary_confirmation_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_readiness_planning_final_boundary_confirmation_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step80_post_closeout_release_gate_readiness_planning_final_boundary_confirmation_packet.ps1"
UI_PAGE = ROOT / "ui/pages/456_Phase25_Step80_Implementation_PostCloseout_Release_Gate_Readiness_Planning_Final_Boundary_Confirmation_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP80_POST_CLOSEOUT_RELEASE_GATE_READINESS_PLANNING_FINAL_BOUNDARY_CONFIRMATION_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step80_post_closeout_release_gate_readiness_planning_final_boundary_confirmation_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 80 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 80 files copied or already present." in text
