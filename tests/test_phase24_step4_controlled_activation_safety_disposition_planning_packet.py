...
PHASE = 24
STEP = 4
STEP_TITLE = "Phase 24 Step 4 - Phase 20 Network Transport Implementation Controlled Activation Safety Disposition Planning Packet"
PRIOR_STEP = "Phase 24 Step 3 - Phase 20 Network Transport Implementation Controlled Activation Evidence Gap Review Packet"
BRANCH = "phase24-step4-controlled-activation-safety-disposition-planning"
MODE_KEY = "implementation_controlled_activation_safety_disposition_planning_mode"
WRITE_KEY = "implementation_controlled_activation_safety_disposition_planning_write"
RECORD_KEY = "implementation_controlled_activation_safety_disposition_planning_record_creation"
CONTEXT = "implementation_controlled_activation_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step4_controlled_activation_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/260_Phase24_Step4_Implementation_Controlled_Activation_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP4_CONTROLLED_ACTIVATION_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step4_controlled_activation_safety_disposition_planning_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 4 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 4 files copied or already present." in text
