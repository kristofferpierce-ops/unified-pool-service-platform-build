...
PHASE = 25
STEP = 21
STEP_TITLE = "Phase 25 Step 21 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Boundary Packet"
PRIOR_STEP = "Phase 25 Step 20 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Final Boundary Confirmation Packet"
BRANCH = "phase25-step21-post-closeout-preflight-planning-boundary"
MODE_KEY = "implementation_post_closeout_preflight_planning_boundary_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_boundary_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_boundary_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step21_post_closeout_preflight_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/397_Phase25_Step21_Implementation_PostCloseout_Preflight_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP21_POST_CLOSEOUT_PREFLIGHT_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step21_post_closeout_preflight_planning_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 21 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 21 files copied or already present." in text
