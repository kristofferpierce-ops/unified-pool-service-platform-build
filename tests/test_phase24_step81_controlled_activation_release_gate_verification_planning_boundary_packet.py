...
PHASE = 24
STEP = 81
STEP_TITLE = "Phase 24 Step 81 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Verification Planning Boundary Packet"
PRIOR_STEP = "Phase 24 Step 80 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Readiness Planning Final Boundary Confirmation Packet"
BRANCH = "phase24-step81-release-gate-verification-boundary"
MODE_KEY = "implementation_controlled_activation_release_gate_verification_planning_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_verification_planning_boundary_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_verification_planning_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_verification_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step81_controlled_activation_release_gate_verification_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/337_Phase24_Step81_Implementation_Controlled_Activation_Release_Gate_Verification_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP81_CONTROLLED_ACTIVATION_RELEASE_GATE_VERIFICATION_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step81_controlled_activation_release_gate_verification_planning_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 81 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 81 files copied or already present." in text
