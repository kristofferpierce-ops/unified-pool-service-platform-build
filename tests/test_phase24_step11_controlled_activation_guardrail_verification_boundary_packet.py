...
PHASE = 24
STEP = 11
STEP_TITLE = "Phase 24 Step 11 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Boundary Packet"
PRIOR_STEP = "Phase 24 Step 10 - Phase 20 Network Transport Implementation Controlled Activation Final Boundary Confirmation Packet"
BRANCH = "phase24-step11-controlled-activation-guardrail-boundary"
MODE_KEY = "implementation_controlled_activation_guardrail_verification_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_guardrail_verification_boundary_write"
RECORD_KEY = "implementation_controlled_activation_guardrail_verification_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_guardrail_verification_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step11_controlled_activation_guardrail_verification_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/267_Phase24_Step11_Implementation_Controlled_Activation_Guardrail_Verification_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP11_CONTROLLED_ACTIVATION_GUARDRAIL_VERIFICATION_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step11_controlled_activation_guardrail_verification_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 11 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 11 files copied or already present." in text
