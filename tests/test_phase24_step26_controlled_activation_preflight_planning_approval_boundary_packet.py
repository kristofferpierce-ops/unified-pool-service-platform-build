...
PHASE = 24
STEP = 26
STEP_TITLE = "Phase 24 Step 26 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Approval Boundary Packet"
PRIOR_STEP = "Phase 24 Step 25 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Safety Disposition Review Packet"
BRANCH = "phase24-step26-ctrl-activation-preflight-approval-boundary"
MODE_KEY = "implementation_controlled_activation_preflight_planning_approval_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_preflight_planning_approval_boundary_write"
RECORD_KEY = "implementation_controlled_activation_preflight_planning_approval_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_preflight_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step26_controlled_activation_preflight_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/282_Phase24_Step26_Implementation_Controlled_Activation_Preflight_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP26_CONTROLLED_ACTIVATION_PREFLIGHT_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step26_controlled_activation_preflight_planning_approval_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 26 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 26 files copied or already present." in text
