...
PHASE = 25
STEP = 23
STEP_TITLE = "Phase 25 Step 23 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Evidence Gap Review Packet"
PRIOR_STEP = "Phase 25 Step 22 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Evidence Index Packet"
BRANCH = "phase25-step23-post-closeout-preflight-planning-evidence-gap-review"
MODE_KEY = "implementation_post_closeout_preflight_planning_evidence_gap_review_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_evidence_gap_review_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_evidence_gap_review_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step23_post_closeout_preflight_planning_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/399_Phase25_Step23_Implementation_PostCloseout_Preflight_Planning_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP23_POST_CLOSEOUT_PREFLIGHT_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step23_post_closeout_preflight_planning_evidence_gap_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 23 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 23 files copied or already present." in text
