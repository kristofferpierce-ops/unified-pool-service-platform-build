...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_review_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_review_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_review_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step65_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/441_Phase25_Step65_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Disposition_Planning_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP65_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_DISPOSITION_PLANNING_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step65_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 65 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 65 files copied or already present." in text
