...
PHASE = 24
STEP = 30
STEP_TITLE = "Phase 24 Step 30 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Final Boundary Confirmation Packet"
PRIOR_STEP = "Phase 24 Step 29 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Closeout Index Packet"
BRANCH = "phase24-step30-ctrl-activation-preflight-final-boundary-confirmation"
MODE_KEY = "implementation_controlled_activation_preflight_planning_final_boundary_confirmation_mode"
WRITE_KEY = "implementation_controlled_activation_preflight_planning_final_boundary_confirmation_write"
RECORD_KEY = "implementation_controlled_activation_preflight_planning_final_boundary_confirmation_record_creation"
CONTEXT = "implementation_controlled_activation_preflight_planning_final_boundary_confirmation_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step30_controlled_activation_preflight_planning_final_boundary_confirmation_packet.ps1"
UI_PAGE = ROOT / "ui/pages/286_Phase24_Step30_Implementation_Controlled_Activation_Preflight_Planning_Final_Boundary_Confirmation_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP30_CONTROLLED_ACTIVATION_PREFLIGHT_PLANNING_FINAL_BOUNDARY_CONFIRMATION_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step30_controlled_activation_preflight_planning_final_boundary_confirmation_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 30 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 30 files copied or already present." in text
