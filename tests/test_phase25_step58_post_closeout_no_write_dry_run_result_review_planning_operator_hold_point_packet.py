...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_operator_hold_point_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_operator_hold_point_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_operator_hold_point_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_review_planning_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step58_post_closeout_no_write_dry_run_result_review_planning_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/434_Phase25_Step58_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Review_Planning_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP58_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_REVIEW_PLANNING_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step58_post_closeout_no_write_dry_run_result_review_planning_operator_hold_point_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 58 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 58 files copied or already present." in text
