...
PHASE = 25
STEP = 24
STEP_TITLE = "Phase 25 Step 24 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Safety Disposition Planning Packet"
PRIOR_STEP = "Phase 25 Step 23 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Evidence Gap Review Packet"
BRANCH = "phase25-step24-post-closeout-preflight-planning-safety-disposition-planning"
MODE_KEY = "implementation_post_closeout_preflight_planning_safety_disposition_planning_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_safety_disposition_planning_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_safety_disposition_planning_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step24_post_closeout_preflight_planning_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/400_Phase25_Step24_Implementation_PostCloseout_Preflight_Planning_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP24_POST_CLOSEOUT_PREFLIGHT_PLANNING_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step24_post_closeout_preflight_planning_safety_disposition_planning_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 24 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 24 files copied or already present." in text
