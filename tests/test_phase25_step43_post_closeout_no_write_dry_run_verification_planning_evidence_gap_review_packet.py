...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_evidence_gap_review_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_evidence_gap_review_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_evidence_gap_review_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_verification_planning_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step43_post_closeout_no_write_dry_run_verification_planning_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/419_Phase25_Step43_Implementation_PostCloseout_NoWrite_Dry_Run_Verification_Planning_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP43_POST_CLOSEOUT_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step43_post_closeout_no_write_dry_run_verification_planning_evidence_gap_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 43 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 43 files copied or already present." in text
