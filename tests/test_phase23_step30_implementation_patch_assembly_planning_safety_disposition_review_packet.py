...
BRANCH = "phase23-step30-implementation-patch-assembly-planning-safety-disposition-review"
MODE_KEY = "implementation_patch_assembly_planning_safety_disposition_review_mode"
WRITE_KEY = "implementation_patch_assembly_planning_safety_disposition_review_write"
RECORD_KEY = "implementation_patch_assembly_planning_safety_disposition_review_record_creation"
CONTEXT = "implementation_patch_assembly_planning_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step30_implementation_patch_assembly_planning_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/206_Phase23_Step30_Implementation_Patch_Assembly_Planning_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP30_IMPLEMENTATION_PATCH_ASSEMBLY_PLANNING_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step30_implementation_patch_assembly_planning_safety_disposition_review_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 30 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 30 files copied or already present." in text
