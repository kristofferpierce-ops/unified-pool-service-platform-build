...
st.set_page_config(
    page_title="Phase 36 Step 4",
    layout="wide",
)

st.title("Phase 36 Step 4")
st.subheader("Readiness Safety Planning")
st.caption("Phase 36 Step 4 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Readiness Safety Disposition Planning Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 4 planning-only packet for trusted-production controlled live-write expansion. "
