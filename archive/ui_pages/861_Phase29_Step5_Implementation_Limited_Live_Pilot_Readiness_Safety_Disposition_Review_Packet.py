...
st.set_page_config(
    page_title="Phase 29 Step 5",
    layout="wide",
)

st.title("Phase 29 Step 5")
st.subheader("Phase 20 Network Transport Implementation Limited Live Pilot Readiness Safety Disposition Review Packet")
...
st.code("Phase 29 Step 4 - Phase 20 Network Transport Implementation Limited Live Pilot Readiness Safety Disposition Planning Packet")
