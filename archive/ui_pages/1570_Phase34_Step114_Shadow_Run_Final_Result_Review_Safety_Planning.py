...
st.set_page_config(
    page_title="Phase 34 Step 114",
    layout="wide",
)

st.title("Phase 34 Step 114")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Shadow Run Validation Final Release Result Review Planning Safety Disposition Planning Packet")
...
st.code("Phase 34 Step 113 - Phase 20 Network Transport Implementation Trusted Production Shadow Run Validation Final Release Result Review Planning Evidence Gap Review Packet")
