...
st.set_page_config(
    page_title="Phase 29 Step 1",
    layout="wide",
)

st.title("Phase 29 Step 1")
st.subheader("Phase 20 Network Transport Implementation Limited Live Pilot Readiness Boundary Packet")
...
st.code("Phase 28 Step 120 - Phase 20 Network Transport Implementation Phase 28 Final No-Write Closeout Hold Packet")
