...
st.set_page_config(
    page_title="Phase 29 Step 17",
    layout="wide",
)

st.title("Phase 29 Step 17")
st.subheader("Phase 20 Network Transport Implementation Limited Live Pilot Guardrail Verification Approval Readiness Packet")
...
st.code("Phase 29 Step 16 - Phase 20 Network Transport Implementation Limited Live Pilot Guardrail Verification Approval Boundary Packet")
