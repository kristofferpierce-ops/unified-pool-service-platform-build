...
st.set_page_config(
    page_title="Phase 32 Step 120",
    layout="wide",
)

st.title("Phase 32 Step 120")
st.subheader("Phase 20 Network Transport Implementation Phase 32 Final No-Write Closeout Hold Packet")
...
st.code("Phase 32 Step 119 - Phase 20 Network Transport Implementation Production-Like Rollout Final Release Result Review Planning Closeout Index Packet")
