...
st.set_page_config(
    page_title="Phase 31 Step 10",
    layout="wide",
)

st.title("Phase 31 Step 10")
st.subheader("Phase 20 Network Transport Implementation Controlled Active Program Operation Readiness Final Boundary Confirmation Packet")
...
st.code("Phase 31 Step 9 - Phase 20 Network Transport Implementation Controlled Active Program Operation Readiness Closeout Index Packet")
