...
st.set_page_config(
    page_title="Phase 31 Step 109",
    layout="wide",
)

st.title("Phase 31 Step 109")
st.subheader("Phase 20 Network Transport Implementation Controlled Active Program Operation Final Release Hold Verification Planning Closeout Index Packet")
...
st.code("Phase 31 Step 108 - Phase 20 Network Transport Implementation Controlled Active Program Operation Final Release Hold Verification Planning Operator Hold Point Packet")
