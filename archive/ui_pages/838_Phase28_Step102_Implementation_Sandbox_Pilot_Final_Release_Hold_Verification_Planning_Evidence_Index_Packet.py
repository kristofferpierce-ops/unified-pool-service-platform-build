...
STEP_NUMBER = 102
STEP_TITLE = "Phase 28 Step 102 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Verification Planning Evidence Index Packet"
PRIOR_STEP = "Phase 28 Step 101 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Verification Planning Boundary Packet"
PHASE_CONTEXT = "implementation_sandbox_pilot_final_release_hold_verification_planning_only"

st.set_page_config(
    page_title="Phase 28 Step 102",
    layout="wide",
)
...
st.write("phase28_boundary=implementation_sandbox_pilot_final_release_hold_verification_planning_evidence_index_opened_by_packet")
