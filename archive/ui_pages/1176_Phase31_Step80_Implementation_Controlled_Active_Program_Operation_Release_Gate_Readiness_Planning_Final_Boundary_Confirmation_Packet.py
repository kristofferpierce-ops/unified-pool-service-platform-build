...
st.set_page_config(
    page_title="Phase 31 Step 80",
    layout="wide",
)

st.title("Phase 31 Step 80")
st.subheader("Phase 20 Network Transport Implementation Controlled Active Program Operation Release Gate Readiness Planning Final Boundary Confirmation Packet")
...
st.code("Phase 31 Step 79 - Phase 20 Network Transport Implementation Controlled Active Program Operation Release Gate Readiness Planning Closeout Index Packet")
