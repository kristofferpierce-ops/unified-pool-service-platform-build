...
PHASE = 38
STEP = 60
TITLE = "Phase 38 Step 70 - Phase 20 Network Transport Implementation Trusted Production Sustained Live Write Operations No-Write Dry Run Result Disposition Planning Final Boundary Confirmation Packet"
...
with left:
    ...
    st.write("Trusted-production sustained live-write operations no-write dry-run result-disposition planning.")
