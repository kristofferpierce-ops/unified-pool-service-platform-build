...
TITLE = "Phase 38 Step 35 - Phase 20 Network Transport Implementation Trusted Production Sustained Live Write Operations No-Write Dry Run Readiness Safety Disposition Review Packet"
MARKERS = {
    "planning_only": "true",
...
def render() -> None:
    ...
    st.set_page_config(page_title=f"Phase 38 Step 35", layout="wide")
    st.title(TITLE)
