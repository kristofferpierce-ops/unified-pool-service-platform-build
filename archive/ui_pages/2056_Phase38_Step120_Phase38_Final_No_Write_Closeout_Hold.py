...
st.set_page_config(page_title="Phase 38 Step 120", layout="wide")

TITLE = "Phase 38 Step 120 - Phase 20 Network Transport Implementation Phase 38 Final No-Write Closeout Hold Packet"
