...
st.set_page_config(
    page_title="Phase 35 Step 1",
    layout="wide",
)

st.title("Phase 35 Step 1")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Readiness Boundary Packet")
...
st.code("Phase 34 Step 120 - Phase 20 Network Transport Implementation Phase 34 Final No-Write Closeout Hold Packet")
