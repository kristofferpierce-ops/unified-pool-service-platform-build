...
st.set_page_config(
    page_title="Phase 29 Step 118",
    layout="wide",
)

st.title("Phase 29 Step 118")
st.subheader("Phase 20 Network Transport Implementation Limited Live Pilot Final Release Result Review Planning Operator Hold Point Packet")
...
st.code("Phase 29 Step 117 - Phase 20 Network Transport Implementation Limited Live Pilot Final Release Result Review Planning Approval Readiness Packet")
