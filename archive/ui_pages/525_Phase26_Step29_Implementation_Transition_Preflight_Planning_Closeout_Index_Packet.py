...
st.set_page_config(
    page_title="Phase 26 Step 29",
    layout="wide",
)

st.title("Phase 26 Step 29 - Phase 20 Network Transport Implementation Transition Preflight Planning Closeout Index Packet")
...
st.write("scripts/phase26_step29_implementation_transition_preflight_planning_closeout_index_packet.ps1")
st.write("ui/pages/525_Phase26_Step29_Implementation_Transition_Preflight_Planning_Closeout_Index_Packet.py")
st.write("docs/PHASE26_STEP29_IMPLEMENTATION_TRANSITION_PREFLIGHT_PLANNING_CLOSEOUT_INDEX_PACKET.md")
st.write("tests/test_phase26_step29_implementation_transition_preflight_planning_closeout_index_packet.py")
