...
st.set_page_config(
    page_title="Phase 31 Step 120",
    layout="wide",
)

st.title("Phase 31 Step 120")
st.subheader("Phase 20 Network Transport Implementation Phase 31 Final No-Write Closeout Hold Packet")
...
st.code("Phase 31 Step 119 - Phase 20 Network Transport Implementation Controlled Active Program Operation Final Release Result Review Planning Closeout Index Packet")
