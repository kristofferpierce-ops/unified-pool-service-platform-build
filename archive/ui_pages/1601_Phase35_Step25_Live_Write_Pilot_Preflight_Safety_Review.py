...
st.set_page_config(
    page_title="Phase 35 Step 25",
    layout="wide",
)

st.title("Phase 35 Step 25")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Preflight Planning Safety Disposition Review Packet")
...
st.code("Phase 35 Step 24 - Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Preflight Planning Safety Disposition Planning Packet")
