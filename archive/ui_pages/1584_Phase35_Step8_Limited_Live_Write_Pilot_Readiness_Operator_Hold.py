...
st.set_page_config(
    page_title="Phase 35 Step 8",
    layout="wide",
)

st.title("Phase 35 Step 8")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Readiness Operator Hold Point Packet")
...
st.code("Phase 35 Step 7 - Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Readiness Approval Readiness Packet")
