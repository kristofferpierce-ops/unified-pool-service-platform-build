...
TITLE = "Phase 39 Step 13 - Phase 20 Network Transport Implementation Trusted Production Live Write Activation Gate Guardrail Verification Evidence Gap Review Packet"
...
st.set_page_config(page_title="Phase 39 Step 13", layout="wide")
st.title(TITLE)
