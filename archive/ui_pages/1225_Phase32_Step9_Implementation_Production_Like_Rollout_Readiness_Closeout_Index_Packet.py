...
st.set_page_config(
    page_title="Phase 32 Step 9",
    layout="wide",
)

st.title("Phase 32 Step 9")
st.subheader("Phase 20 Network Transport Implementation Production-Like Rollout Readiness Closeout Index Packet")
...
st.code("Phase 32 Step 8 - Phase 20 Network Transport Implementation Production-Like Rollout Readiness Operator Hold Point Packet")
