...
TITLE = "Phase 39 Step 22 - Phase 20 Network Transport Implementation Trusted Production Live Write Activation Gate Preflight Planning Evidence Index Packet"
...
st.set_page_config(page_title="Phase 39 Step 22", layout="wide")
st.title(TITLE)
