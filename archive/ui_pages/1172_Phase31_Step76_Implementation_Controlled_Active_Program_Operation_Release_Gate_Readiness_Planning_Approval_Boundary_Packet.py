...
st.set_page_config(
    page_title="Phase 31 Step 76",
    layout="wide",
)

st.title("Phase 31 Step 76")
st.subheader("Phase 20 Network Transport Implementation Controlled Active Program Operation Release Gate Readiness Planning Approval Boundary Packet")
...
st.code("Phase 31 Step 75 - Phase 20 Network Transport Implementation Controlled Active Program Operation Release Gate Readiness Planning Safety Disposition Review Packet")
