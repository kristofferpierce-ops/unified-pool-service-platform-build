...
TITLE = "Phase 38 Step 30 - Phase 20 Network Transport Implementation Trusted Production Sustained Live Write Operations Preflight Planning Final Boundary Confirmation Packet"
MARKERS = {
    "planning_only": "true",
...
def render() -> None:
    ...
    st.set_page_config(page_title=f"Phase 38 Step 30", layout="wide")
    st.title(TITLE)
    st.caption("Planning-only sustained live-write operations preflight planning packet. No live writes, no live user access, no bridge POST, and no Phase 39 boundary creation.")
