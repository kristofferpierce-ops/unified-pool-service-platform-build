...
st.set_page_config(page_title="Phase 38 Step 2", layout="wide")

st.title("Phase 38 Step 2")
st.subheader("Evidence Index")
st.caption("Phase 38 Step 2 - Phase 20 Network Transport Implementation Trusted Production Sustained Live Write Operations Readiness Evidence Index Packet")
...
st.write(
    "This generated page documents the Phase 38 Step 2 planning-only packet for trusted-production sustained live-write operations readiness. "
