...
st.set_page_config(
    page_title="Phase 34 Step 9",
    layout="wide",
)

st.title("Phase 34 Step 9")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Shadow Run Validation Readiness Closeout Index Packet")
...
st.code("Phase 34 Step 8 - Phase 20 Network Transport Implementation Trusted Production Shadow Run Validation Readiness Operator Hold Point Packet")
