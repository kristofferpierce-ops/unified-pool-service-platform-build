...
TITLE = "Phase 39 Step 21 - Phase 20 Network Transport Implementation Trusted Production Live Write Activation Gate Preflight Planning Boundary Packet"
...
st.set_page_config(page_title="Phase 39 Step 21", layout="wide")
st.title(TITLE)
