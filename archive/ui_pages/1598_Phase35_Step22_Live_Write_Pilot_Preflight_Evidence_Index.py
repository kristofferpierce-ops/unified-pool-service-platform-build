...
st.set_page_config(
    page_title="Phase 35 Step 22",
    layout="wide",
)

st.title("Phase 35 Step 22")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Preflight Planning Evidence Index Packet")
...
st.code("Phase 35 Step 21 - Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Preflight Planning Boundary Packet")
