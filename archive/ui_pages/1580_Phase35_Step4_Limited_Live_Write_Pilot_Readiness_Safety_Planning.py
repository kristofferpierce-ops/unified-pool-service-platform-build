...
st.set_page_config(
    page_title="Phase 35 Step 4",
    layout="wide",
)

st.title("Phase 35 Step 4")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Readiness Safety Disposition Planning Packet")
...
st.code("Phase 35 Step 3 - Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Readiness Evidence Gap Review Packet")
