...
STEP_NUMBER = 104
STEP_NAME = "Phase 25 Step 104 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Verification Planning Safety Disposition Planning Packet"
PRIOR_STEP = "Phase 25 Step 103 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Verification Planning Evidence Gap Review Packet"
...
st.write(
    "This page indexes the Phase 25 Step 104 post-closeout final release hold verification planning packet. "
...
st.code("""scripts/phase25_step104_post_closeout_final_release_hold_verification_planning_safety_disposition_planning_packet.ps1
