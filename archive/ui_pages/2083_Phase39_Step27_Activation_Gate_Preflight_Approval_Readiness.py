...
TITLE = "Phase 39 Step 27 - Phase 20 Network Transport Implementation Trusted Production Live Write Activation Gate Preflight Planning Approval Readiness Packet"
...
st.set_page_config(page_title="Phase 39 Step 27", layout="wide")
st.title(TITLE)
