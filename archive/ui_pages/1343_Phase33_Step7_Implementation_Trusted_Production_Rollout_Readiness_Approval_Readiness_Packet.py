...
st.set_page_config(
    page_title="Phase 33 Step 7",
    layout="wide",
)

st.title("Phase 33 Step 7")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Rollout Readiness Approval Readiness Packet")
...
st.code("Phase 33 Step 6 - Phase 20 Network Transport Implementation Trusted Production Rollout Readiness Approval Boundary Packet")
