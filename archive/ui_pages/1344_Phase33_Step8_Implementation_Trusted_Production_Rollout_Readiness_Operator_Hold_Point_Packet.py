...
st.set_page_config(
    page_title="Phase 33 Step 8",
    layout="wide",
)

st.title("Phase 33 Step 8")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Rollout Readiness Operator Hold Point Packet")
...
st.code("Phase 33 Step 7 - Phase 20 Network Transport Implementation Trusted Production Rollout Readiness Approval Readiness Packet")
