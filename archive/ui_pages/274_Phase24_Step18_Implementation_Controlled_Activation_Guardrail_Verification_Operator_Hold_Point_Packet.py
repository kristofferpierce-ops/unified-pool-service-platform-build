...
EXPECTED_BRANCH = "phase24-step18-controlled-activation-guardrail-operator-hold-point"
...
st.code("""scripts/phase24_step18_controlled_activation_guardrail_verification_operator_hold_point_packet.ps1
