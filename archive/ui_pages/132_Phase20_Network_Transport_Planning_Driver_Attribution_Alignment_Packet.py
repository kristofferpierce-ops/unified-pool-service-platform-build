"""Phase 22 Step 26 driver attribution alignment page.
...
TITLE = "Phase 22 Step 26 - Phase 20 Network Transport Planning Driver Attribution Alignment Packet"
...
DRIVER_ATTRIBUTION_ALIGNMENT = {
    ...
    "expected_actual_alignment": "candidate_drivers_evidence_confidence_operator_review",
...
def render() -> None:
    ...
    st.set_page_config(page_title="Phase 22 Step 26", layout="wide")
    st.title(TITLE)
    ...
    with right:
        st.subheader("Driver attribution alignment")
        st.json(DRIVER_ATTRIBUTION_ALIGNMENT)
...
CANDIDATE_DRIVER_GROUPS = ["climate_driver", "chemical_driver", "labor_driver", "route_driver", "equipment_driver", "water_source_driver", "billing_driver", "customer_behavior_driver", "vendor_cost_driver", "branch_overlay_driver"]
