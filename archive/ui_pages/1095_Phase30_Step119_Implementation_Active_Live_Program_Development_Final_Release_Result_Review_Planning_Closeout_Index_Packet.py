...
st.set_page_config(
    page_title="Phase 30 Step 119",
    layout="wide",
)

st.title("Phase 30 Step 119")
st.subheader("Phase 20 Network Transport Implementation Active Live Program Development Final Release Result Review Planning Closeout Index Packet")
...
st.code("Phase 30 Step 118 - Phase 20 Network Transport Implementation Active Live Program Development Final Release Result Review Planning Operator Hold Point Packet")
