...
st.set_page_config(
    page_title="Phase 36 Step 6",
    layout="wide",
)

st.title("Phase 36 Step 6")
st.subheader("Readiness Approval Boundary")
st.caption("Phase 36 Step 6 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Readiness Approval Boundary Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 6 planning-only packet for trusted-production controlled live-write expansion. "
