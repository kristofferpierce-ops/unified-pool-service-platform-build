...
st.set_page_config(
    page_title="Phase 31 Step 38",
    layout="wide",
)

st.title("Phase 31 Step 38")
st.subheader("Phase 20 Network Transport Implementation Controlled Active Program Operation No-Write Dry Run Readiness Operator Hold Point Packet")
...
st.code("Phase 31 Step 37 - Phase 20 Network Transport Implementation Controlled Active Program Operation No-Write Dry Run Readiness Approval Readiness Packet")
