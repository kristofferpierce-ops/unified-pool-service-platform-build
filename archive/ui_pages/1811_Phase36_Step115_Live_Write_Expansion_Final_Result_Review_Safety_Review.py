...
st.set_page_config(
    page_title="Phase 36 Step 115",
    layout="wide",
)

st.title("Phase 36 Step 115")
st.subheader("Safety Disposition Review")
st.caption("Phase 36 Step 115 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Final Release Result Review Planning Safety Disposition Review Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 115 planning-only packet for trusted-production controlled live-write expansion final-release result-review and final no-write closeout planning. "
