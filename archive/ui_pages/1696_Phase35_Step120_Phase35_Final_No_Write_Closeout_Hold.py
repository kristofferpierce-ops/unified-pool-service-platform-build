...
st.set_page_config(
    page_title="Phase 35 Step 120",
    layout="wide",
)

st.title("Phase 35 Step 120")
st.subheader("Phase35 Final No Write Closeout Hold")
st.caption("Phase 35 Step 120 - Phase 20 Network Transport Implementation Phase 35 Final No-Write Closeout Hold Packet")
...
st.write(
    "This generated page documents the Phase 35 Step 120 planning-only packet for the trusted-production limited live-write pilot. "
