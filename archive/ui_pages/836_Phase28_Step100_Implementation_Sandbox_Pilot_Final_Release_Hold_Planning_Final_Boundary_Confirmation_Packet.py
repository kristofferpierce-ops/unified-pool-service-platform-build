...
STEP_NUMBER = 100
STEP_TITLE = "Phase 28 Step 100 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Final Boundary Confirmation Packet"
PRIOR_STEP = "Phase 28 Step 99 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Closeout Index Packet"
PHASE_CONTEXT = "implementation_sandbox_pilot_final_release_hold_planning_only"

st.set_page_config(
    page_title="Phase 28 Step 100",
    layout="wide",
)
...
st.write("phase28_boundary=implementation_sandbox_pilot_final_release_hold_planning_final_boundary_confirmation_opened_by_packet")
