...
st.set_page_config(
    page_title="Phase 36 Step 5",
    layout="wide",
)

st.title("Phase 36 Step 5")
st.subheader("Readiness Safety Review")
st.caption("Phase 36 Step 5 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Readiness Safety Disposition Review Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 5 planning-only packet for trusted-production controlled live-write expansion. "
