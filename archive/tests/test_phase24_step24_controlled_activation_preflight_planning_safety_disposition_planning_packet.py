...
PHASE = 24
STEP = 24
STEP_TITLE = "Phase 24 Step 24 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Safety Disposition Planning Packet"
PRIOR_STEP = "Phase 24 Step 23 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Evidence Gap Review Packet"
BRANCH = "phase24-step24-ctrl-activation-preflight-safety-disposition-planning"
MODE_KEY = "implementation_controlled_activation_preflight_planning_safety_disposition_planning_mode"
WRITE_KEY = "implementation_controlled_activation_preflight_planning_safety_disposition_planning_write"
RECORD_KEY = "implementation_controlled_activation_preflight_planning_safety_disposition_planning_record_creation"
CONTEXT = "implementation_controlled_activation_preflight_planning_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step24_controlled_activation_preflight_planning_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/280_Phase24_Step24_Implementation_Controlled_Activation_Preflight_Planning_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP24_CONTROLLED_ACTIVATION_PREFLIGHT_PLANNING_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step24_controlled_activation_preflight_planning_safety_disposition_planning_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 24 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 24 files copied or already present." in text
