...
PHASE = 24
STEP = 27
STEP_TITLE = "Phase 24 Step 27 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Approval Readiness Packet"
PRIOR_STEP = "Phase 24 Step 26 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Approval Boundary Packet"
BRANCH = "phase24-step27-ctrl-activation-preflight-approval-readiness"
MODE_KEY = "implementation_controlled_activation_preflight_planning_approval_readiness_mode"
WRITE_KEY = "implementation_controlled_activation_preflight_planning_approval_readiness_write"
RECORD_KEY = "implementation_controlled_activation_preflight_planning_approval_readiness_record_creation"
CONTEXT = "implementation_controlled_activation_preflight_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step27_controlled_activation_preflight_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/283_Phase24_Step27_Implementation_Controlled_Activation_Preflight_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP27_CONTROLLED_ACTIVATION_PREFLIGHT_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step27_controlled_activation_preflight_planning_approval_readiness_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 27 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 27 files copied or already present." in text
