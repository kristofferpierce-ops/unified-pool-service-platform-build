...
PHASE = 25
STEP = 41
STEP_TITLE = "Phase 25 Step 41 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Verification Planning Boundary Packet"
PRIOR_STEP = "Phase 25 Step 40 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Final Boundary Confirmation Packet"
BRANCH = "phase25-step41-post-closeout-no-write-dry-run-verification-planning-boundary"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_boundary_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_boundary_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_boundary_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_verification_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step41_post_closeout_no_write_dry_run_verification_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/417_Phase25_Step41_Implementation_PostCloseout_NoWrite_Dry_Run_Verification_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP41_POST_CLOSEOUT_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step41_post_closeout_no_write_dry_run_verification_planning_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 41 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 41 files copied or already present." in text
