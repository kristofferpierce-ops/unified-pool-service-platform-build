...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_final_boundary_confirmation_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_final_boundary_confirmation_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_final_boundary_confirmation_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_review_planning_final_boundary_confirmation_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step60_post_closeout_no_write_dry_run_result_review_planning_final_boundary_confirmation_packet.ps1"
UI_PAGE = ROOT / "ui/pages/436_Phase25_Step60_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Review_Planning_Final_Boundary_Confirmation_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP60_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_REVIEW_PLANNING_FINAL_BOUNDARY_CONFIRMATION_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step60_post_closeout_no_write_dry_run_result_review_planning_final_boundary_confirmation_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 60 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 60 files copied or already present." in text
