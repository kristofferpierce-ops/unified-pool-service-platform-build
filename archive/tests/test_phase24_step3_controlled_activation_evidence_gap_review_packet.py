...
PHASE = 24
STEP = 3
STEP_TITLE = "Phase 24 Step 3 - Phase 20 Network Transport Implementation Controlled Activation Evidence Gap Review Packet"
PRIOR_STEP = "Phase 24 Step 2 - Phase 20 Network Transport Implementation Controlled Activation Evidence Index Packet"
BRANCH = "phase24-step3-controlled-activation-evidence-gap-review"
MODE_KEY = "implementation_controlled_activation_evidence_gap_review_mode"
WRITE_KEY = "implementation_controlled_activation_evidence_gap_review_write"
RECORD_KEY = "implementation_controlled_activation_evidence_gap_review_record_creation"
CONTEXT = "implementation_controlled_activation_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step3_controlled_activation_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/259_Phase24_Step3_Implementation_Controlled_Activation_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP3_CONTROLLED_ACTIVATION_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step3_controlled_activation_evidence_gap_review_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 3 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 3 files copied or already present." in text
