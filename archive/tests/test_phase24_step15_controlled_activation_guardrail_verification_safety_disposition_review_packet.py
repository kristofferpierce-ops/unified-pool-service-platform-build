...
PHASE = 24
STEP = 15
STEP_TITLE = "Phase 24 Step 15 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Safety Disposition Review Packet"
PRIOR_STEP = "Phase 24 Step 14 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Safety Disposition Planning Packet"
BRANCH = "phase24-step15-controlled-activation-guardrail-safety-review"
MODE_KEY = "implementation_controlled_activation_guardrail_verification_safety_disposition_review_mode"
WRITE_KEY = "implementation_controlled_activation_guardrail_verification_safety_disposition_review_write"
RECORD_KEY = "implementation_controlled_activation_guardrail_verification_safety_disposition_review_record_creation"
CONTEXT = "implementation_controlled_activation_guardrail_verification_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step15_controlled_activation_guardrail_verification_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/271_Phase24_Step15_Implementation_Controlled_Activation_Guardrail_Verification_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP15_CONTROLLED_ACTIVATION_GUARDRAIL_VERIFICATION_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step15_controlled_activation_guardrail_verification_safety_disposition_review_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 15 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 15 files copied or already present." in text
