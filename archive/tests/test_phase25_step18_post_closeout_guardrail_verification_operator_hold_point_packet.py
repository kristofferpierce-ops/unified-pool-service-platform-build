...
PHASE = 25
STEP = 18
STEP_TITLE = "Phase 25 Step 18 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Operator Hold Point Packet"
PRIOR_STEP = "Phase 25 Step 17 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Approval Readiness Packet"
BRANCH = "phase25-step18-post-closeout-guardrail-verification-operator-hold-point"
MODE_KEY = "implementation_post_closeout_guardrail_verification_operator_hold_point_mode"
WRITE_KEY = "implementation_post_closeout_guardrail_verification_operator_hold_point_write"
RECORD_KEY = "implementation_post_closeout_guardrail_verification_operator_hold_point_record_creation"
CONTEXT = "implementation_post_closeout_guardrail_verification_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step18_post_closeout_guardrail_verification_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/394_Phase25_Step18_Implementation_PostCloseout_Guardrail_Verification_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP18_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step18_post_closeout_guardrail_verification_operator_hold_point_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 18 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 18 files copied or already present." in text
