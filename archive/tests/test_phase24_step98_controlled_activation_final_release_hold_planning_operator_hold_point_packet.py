...
PHASE = 24
STEP = 98
STEP_TITLE = "Phase 24 Step 98 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Operator Hold Point Packet"
PRIOR_STEP = "Phase 24 Step 97 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Approval Readiness Packet"
BRANCH = "phase24-step98-final-release-hold-operator-hold"
MODE_KEY = "implementation_controlled_activation_final_release_hold_planning_operator_hold_point_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_planning_operator_hold_point_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_planning_operator_hold_point_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_planning_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step98_controlled_activation_final_release_hold_planning_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/354_Phase24_Step98_Implementation_Controlled_Activation_Final_Release_Hold_Planning_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP98_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_PLANNING_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step98_controlled_activation_final_release_hold_planning_operator_hold_point_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 98 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 98 files copied or already present." in text
