...
PHASE = 25
STEP = 49
STEP_TITLE = "Phase 25 Step 49 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Verification Planning Closeout Index Packet"
PRIOR_STEP = "Phase 25 Step 48 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Verification Planning Operator Hold Point Packet"
BRANCH = "phase25-step49-post-closeout-no-write-dry-run-verification-planning-closeout-index"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_closeout_index_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_closeout_index_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_closeout_index_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_verification_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step49_post_closeout_no_write_dry_run_verification_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/425_Phase25_Step49_Implementation_PostCloseout_NoWrite_Dry_Run_Verification_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP49_POST_CLOSEOUT_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step49_post_closeout_no_write_dry_run_verification_planning_closeout_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 49 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 49 files copied or already present." in text
