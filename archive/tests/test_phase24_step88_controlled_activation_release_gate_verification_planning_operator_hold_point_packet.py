...
MODE_KEY = "implementation_controlled_activation_release_gate_verification_planning_operator_hold_point_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_verification_planning_operator_hold_point_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_verification_planning_operator_hold_point_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_verification_planning_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step88_controlled_activation_release_gate_verification_planning_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/344_Phase24_Step88_Implementation_Controlled_Activation_Release_Gate_Verification_Planning_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP88_CONTROLLED_ACTIVATION_RELEASE_GATE_VERIFICATION_PLANNING_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step88_controlled_activation_release_gate_verification_planning_operator_hold_point_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 88 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 88 files copied or already present." in text
