...
PHASE = 25
STEP = 36
STEP_TITLE = "Phase 25 Step 36 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Approval Boundary Packet"
PRIOR_STEP = "Phase 25 Step 35 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Safety Disposition Review Packet"
BRANCH = "phase25-step36-post-closeout-no-write-dry-run-readiness-approval-boundary"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_approval_boundary_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_approval_boundary_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_readiness_approval_boundary_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_readiness_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step36_post_closeout_no_write_dry_run_readiness_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/412_Phase25_Step36_Implementation_PostCloseout_NoWrite_Dry_Run_Readiness_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP36_POST_CLOSEOUT_NO_WRITE_DRY_RUN_READINESS_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step36_post_closeout_no_write_dry_run_readiness_approval_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 36 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 36 files copied or already present." in text
