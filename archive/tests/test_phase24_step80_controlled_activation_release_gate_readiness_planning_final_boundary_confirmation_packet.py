...
MODE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_final_boundary_confirmation_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_final_boundary_confirmation_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_readiness_planning_final_boundary_confirmation_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_readiness_planning_final_boundary_confirmation_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step80_controlled_activation_release_gate_readiness_planning_final_boundary_confirmation_packet.ps1"
UI_PAGE = ROOT / "ui/pages/336_Phase24_Step80_Implementation_Controlled_Activation_Release_Gate_Readiness_Planning_Final_Boundary_Confirmation_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP80_CONTROLLED_ACTIVATION_RELEASE_GATE_READINESS_PLANNING_FINAL_BOUNDARY_CONFIRMATION_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step80_controlled_activation_release_gate_readiness_planning_final_boundary_confirmation_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 80 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 80 files copied or already present." in text
