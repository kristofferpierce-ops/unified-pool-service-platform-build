...
MODE_KEY = "implementation_controlled_activation_release_gate_verification_planning_safety_disposition_planning_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_verification_planning_safety_disposition_planning_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_verification_planning_safety_disposition_planning_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_verification_planning_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step84_controlled_activation_release_gate_verification_planning_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/340_Phase24_Step84_Implementation_Controlled_Activation_Release_Gate_Verification_Planning_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP84_CONTROLLED_ACTIVATION_RELEASE_GATE_VERIFICATION_PLANNING_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step84_controlled_activation_release_gate_verification_planning_safety_disposition_planning_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 84 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 84 files copied or already present." in text
