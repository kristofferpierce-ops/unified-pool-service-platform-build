...
PHASE = 25
STEP = 30
STEP_TITLE = "Phase 25 Step 30 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Final Boundary Confirmation Packet"
PRIOR_STEP = "Phase 25 Step 29 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Closeout Index Packet"
BRANCH = "phase25-step30-post-closeout-preflight-planning-final-boundary-confirmation"
MODE_KEY = "implementation_post_closeout_preflight_planning_final_boundary_confirmation_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_final_boundary_confirmation_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_final_boundary_confirmation_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_final_boundary_confirmation_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step30_post_closeout_preflight_planning_final_boundary_confirmation_packet.ps1"
UI_PAGE = ROOT / "ui/pages/406_Phase25_Step30_Implementation_PostCloseout_Preflight_Planning_Final_Boundary_Confirmation_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP30_POST_CLOSEOUT_PREFLIGHT_PLANNING_FINAL_BOUNDARY_CONFIRMATION_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step30_post_closeout_preflight_planning_final_boundary_confirmation_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 30 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 30 files copied or already present." in text
