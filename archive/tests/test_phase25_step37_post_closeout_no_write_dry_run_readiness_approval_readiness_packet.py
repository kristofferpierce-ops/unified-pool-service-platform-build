...
PHASE = 25
STEP = 37
STEP_TITLE = "Phase 25 Step 37 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Approval Readiness Packet"
PRIOR_STEP = "Phase 25 Step 36 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Approval Boundary Packet"
BRANCH = "phase25-step37-post-closeout-no-write-dry-run-readiness-approval-readiness"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_approval_readiness_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_approval_readiness_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_readiness_approval_readiness_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_readiness_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step37_post_closeout_no_write_dry_run_readiness_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/413_Phase25_Step37_Implementation_PostCloseout_NoWrite_Dry_Run_Readiness_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP37_POST_CLOSEOUT_NO_WRITE_DRY_RUN_READINESS_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step37_post_closeout_no_write_dry_run_readiness_approval_readiness_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 37 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 37 files copied or already present." in text
