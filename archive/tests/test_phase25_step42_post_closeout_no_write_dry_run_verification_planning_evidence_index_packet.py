...
PHASE = 25
STEP = 42
STEP_TITLE = "Phase 25 Step 42 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Verification Planning Evidence Index Packet"
PRIOR_STEP = "Phase 25 Step 41 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Verification Planning Boundary Packet"
BRANCH = "phase25-step42-post-closeout-no-write-dry-run-verification-planning-evidence-index"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_evidence_index_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_evidence_index_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_evidence_index_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_verification_planning_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step42_post_closeout_no_write_dry_run_verification_planning_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/418_Phase25_Step42_Implementation_PostCloseout_NoWrite_Dry_Run_Verification_Planning_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP42_POST_CLOSEOUT_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step42_post_closeout_no_write_dry_run_verification_planning_evidence_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 42 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 42 files copied or already present." in text
