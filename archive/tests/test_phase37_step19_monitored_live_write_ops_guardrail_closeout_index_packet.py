...
SCRIPT = REPO / "scripts/phase37_step19_monitored_live_write_ops_guardrail_closeout_index_packet.ps1"
UI = REPO / "ui/pages/1835_Phase37_Step19_Monitored_Live_Write_Ops_Guardrail_Closeout_Index.py"
DOC = REPO / "docs/PHASE37_STEP19_MONITORED_LIVE_WRITE_OPS_GUARDRAIL_CLOSEOUT_INDEX_PACKET.md"
TEST = REPO / "tests/test_phase37_step19_monitored_live_write_ops_guardrail_closeout_index_packet.py"
...
def test_phase37_step19_files_exist():
...
def test_phase37_step19_launcher_has_valid_param_block():
    text = _read(SCRIPT)
...
def test_phase37_step19_required_safety_markers_present():
...
def test_phase37_step19_forbidden_true_markers_absent():
...
def test_phase37_step19_literal_pass_markers_present():
    text = _read(SCRIPT)
    assert "APPLY PASS" in text
    assert "SMOKE TEST PASS" in text


def test_phase37_step19_launcher_smoke_passes():
