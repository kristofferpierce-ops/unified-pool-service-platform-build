...
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_verification_planning_approval_readiness_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_verification_planning_approval_readiness_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_verification_planning_approval_readiness_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_verification_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step47_controlled_activation_no_write_dry_run_verification_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/303_Phase24_Step47_Implementation_Controlled_Activation_No_Write_Dry_Run_Verification_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP47_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step47_controlled_activation_no_write_dry_run_verification_planning_approval_readiness_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 47 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 47 files copied or already present." in text
