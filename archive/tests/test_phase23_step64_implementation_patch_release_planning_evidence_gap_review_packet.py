...
BRANCH = "phase23-step64-implementation-patch-release-planning-evidence-gap-review"
MODE_KEY = "implementation_patch_release_planning_evidence_gap_review_mode"
WRITE_KEY = "implementation_patch_release_planning_evidence_gap_review_write"
RECORD_KEY = "implementation_patch_release_planning_evidence_gap_review_record_creation"
CONTEXT = "implementation_patch_release_planning_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step64_implementation_patch_release_planning_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/240_Phase23_Step64_Implementation_Patch_Release_Planning_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP64_IMPLEMENTATION_PATCH_RELEASE_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step64_implementation_patch_release_planning_evidence_gap_review_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 64 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 64 files copied or already present." in text
