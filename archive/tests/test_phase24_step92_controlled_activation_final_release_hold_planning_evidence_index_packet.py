...
PHASE = 24
STEP = 92
STEP_TITLE = "Phase 24 Step 92 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Evidence Index Packet"
PRIOR_STEP = "Phase 24 Step 91 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Boundary Packet"
BRANCH = "phase24-step92-final-release-hold-evidence-index"
MODE_KEY = "implementation_controlled_activation_final_release_hold_planning_evidence_index_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_planning_evidence_index_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_planning_evidence_index_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_planning_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step92_controlled_activation_final_release_hold_planning_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/348_Phase24_Step92_Implementation_Controlled_Activation_Final_Release_Hold_Planning_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP92_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_PLANNING_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step92_controlled_activation_final_release_hold_planning_evidence_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 92 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 92 files copied or already present." in text
