...
MODE_KEY = "implementation_controlled_activation_final_release_hold_verification_planning_closeout_index_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_verification_planning_closeout_index_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_verification_planning_closeout_index_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_verification_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step109_controlled_activation_final_release_hold_verification_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/365_Phase24_Step109_Implementation_Controlled_Activation_Final_Release_Hold_Verification_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP109_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_VERIFICATION_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step109_controlled_activation_final_release_hold_verification_planning_closeout_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 109 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 109 files copied or already present." in text
