...
MODE_KEY = "implementation_controlled_activation_final_release_result_review_planning_operator_hold_point_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_result_review_planning_operator_hold_point_write"
RECORD_KEY = "implementation_controlled_activation_final_release_result_review_planning_operator_hold_point_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_result_review_planning_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step118_controlled_activation_final_release_result_review_planning_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/374_Phase24_Step118_Implementation_Controlled_Activation_Final_Release_Result_Review_Planning_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP118_CONTROLLED_ACTIVATION_FINAL_RELEASE_RESULT_REVIEW_PLANNING_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step118_controlled_activation_final_release_result_review_planning_operator_hold_point_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 118 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 118 files copied or already present." in text
