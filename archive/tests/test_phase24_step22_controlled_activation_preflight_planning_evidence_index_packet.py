...
PHASE = 24
STEP = 22
STEP_TITLE = "Phase 24 Step 22 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Evidence Index Packet"
PRIOR_STEP = "Phase 24 Step 21 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Boundary Packet"
BRANCH = "phase24-step22-ctrl-activation-preflight-evidence-index"
MODE_KEY = "implementation_controlled_activation_preflight_planning_evidence_index_mode"
WRITE_KEY = "implementation_controlled_activation_preflight_planning_evidence_index_write"
RECORD_KEY = "implementation_controlled_activation_preflight_planning_evidence_index_record_creation"
CONTEXT = "implementation_controlled_activation_preflight_planning_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step22_controlled_activation_preflight_planning_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/278_Phase24_Step22_Implementation_Controlled_Activation_Preflight_Planning_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP22_CONTROLLED_ACTIVATION_PREFLIGHT_PLANNING_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step22_controlled_activation_preflight_planning_evidence_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 22 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 22 files copied or already present." in text
