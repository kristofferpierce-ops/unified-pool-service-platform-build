...
PHASE = 25
STEP = 12
STEP_TITLE = "Phase 25 Step 12 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Evidence Index Packet"
PRIOR_STEP = "Phase 25 Step 11 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Boundary Packet"
BRANCH = "phase25-step12-post-closeout-guardrail-verification-evidence-index"
MODE_KEY = "implementation_post_closeout_guardrail_verification_evidence_index_mode"
WRITE_KEY = "implementation_post_closeout_guardrail_verification_evidence_index_write"
RECORD_KEY = "implementation_post_closeout_guardrail_verification_evidence_index_record_creation"
CONTEXT = "implementation_post_closeout_guardrail_verification_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step12_post_closeout_guardrail_verification_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/388_Phase25_Step12_Implementation_PostCloseout_Guardrail_Verification_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP12_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step12_post_closeout_guardrail_verification_evidence_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 12 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 12 files copied or already present." in text
