...
PHASE = 25
STEP = 17
STEP_TITLE = "Phase 25 Step 17 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Approval Readiness Packet"
PRIOR_STEP = "Phase 25 Step 16 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Approval Boundary Packet"
BRANCH = "phase25-step17-post-closeout-guardrail-verification-approval-readiness"
MODE_KEY = "implementation_post_closeout_guardrail_verification_approval_readiness_mode"
WRITE_KEY = "implementation_post_closeout_guardrail_verification_approval_readiness_write"
RECORD_KEY = "implementation_post_closeout_guardrail_verification_approval_readiness_record_creation"
CONTEXT = "implementation_post_closeout_guardrail_verification_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step17_post_closeout_guardrail_verification_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/393_Phase25_Step17_Implementation_PostCloseout_Guardrail_Verification_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP17_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step17_post_closeout_guardrail_verification_approval_readiness_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 17 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 17 files copied or already present." in text
