...
PHASE = 24
STEP = 18
STEP_TITLE = "Phase 24 Step 18 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Operator Hold Point Packet"
PRIOR_STEP = "Phase 24 Step 17 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Approval Readiness Packet"
BRANCH = "phase24-step18-controlled-activation-guardrail-operator-hold-point"
MODE_KEY = "implementation_controlled_activation_guardrail_verification_operator_hold_point_mode"
WRITE_KEY = "implementation_controlled_activation_guardrail_verification_operator_hold_point_write"
RECORD_KEY = "implementation_controlled_activation_guardrail_verification_operator_hold_point_record_creation"
CONTEXT = "implementation_controlled_activation_guardrail_verification_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step18_controlled_activation_guardrail_verification_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/274_Phase24_Step18_Implementation_Controlled_Activation_Guardrail_Verification_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP18_CONTROLLED_ACTIVATION_GUARDRAIL_VERIFICATION_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step18_controlled_activation_guardrail_verification_operator_hold_point_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 18 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 18 files copied or already present." in text
