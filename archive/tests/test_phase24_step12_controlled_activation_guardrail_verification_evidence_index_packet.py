...
MODE_KEY = "implementation_controlled_activation_guardrail_verification_evidence_index_mode"
WRITE_KEY = "implementation_controlled_activation_guardrail_verification_evidence_index_write"
RECORD_KEY = "implementation_controlled_activation_guardrail_verification_evidence_index_record_creation"
CONTEXT = "implementation_controlled_activation_guardrail_verification_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step12_controlled_activation_guardrail_verification_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/268_Phase24_Step12_Implementation_Controlled_Activation_Guardrail_Verification_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP12_CONTROLLED_ACTIVATION_GUARDRAIL_VERIFICATION_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step12_controlled_activation_guardrail_verification_evidence_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 12 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 12 files copied or already present." in text
