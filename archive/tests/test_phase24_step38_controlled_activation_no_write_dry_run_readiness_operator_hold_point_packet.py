...
PHASE = 24
STEP = 38
STEP_TITLE = "Phase 24 Step 38 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Operator Hold Point Packet"
PRIOR_STEP = "Phase 24 Step 37 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Approval Readiness Packet"
BRANCH = "phase24-step38-ctrl-activation-dry-run-operator-hold-point"
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_operator_hold_point_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_operator_hold_point_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_operator_hold_point_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_readiness_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step38_controlled_activation_no_write_dry_run_readiness_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/294_Phase24_Step38_Implementation_Controlled_Activation_No_Write_Dry_Run_Readiness_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP38_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_READINESS_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step38_controlled_activation_no_write_dry_run_readiness_operator_hold_point_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 38 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 38 files copied or already present." in text
