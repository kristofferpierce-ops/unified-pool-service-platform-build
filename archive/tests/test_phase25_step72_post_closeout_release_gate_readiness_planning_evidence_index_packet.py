...
PHASE = 25
STEP = 72
STEP_TITLE = "Phase 25 Step 72 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Evidence Index Packet"
PRIOR_STEP = "Phase 25 Step 71 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Boundary Packet"
BRANCH = "phase25-step72-post-closeout-release-gate-readiness-planning-evidence-index"
MODE_KEY = "implementation_post_closeout_release_gate_readiness_planning_evidence_index_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_readiness_planning_evidence_index_write"
RECORD_KEY = "implementation_post_closeout_release_gate_readiness_planning_evidence_index_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_readiness_planning_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step72_post_closeout_release_gate_readiness_planning_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/448_Phase25_Step72_Implementation_PostCloseout_Release_Gate_Readiness_Planning_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP72_POST_CLOSEOUT_RELEASE_GATE_READINESS_PLANNING_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step72_post_closeout_release_gate_readiness_planning_evidence_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 72 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 72 files copied or already present." in text
