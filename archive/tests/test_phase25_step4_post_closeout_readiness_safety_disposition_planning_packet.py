...
PHASE = 25
STEP = 4
STEP_TITLE = "Phase 25 Step 4 - Phase 20 Network Transport Implementation Post-Closeout Readiness Safety Disposition Planning Packet"
PRIOR_STEP = "Phase 25 Step 3 - Phase 20 Network Transport Implementation Post-Closeout Readiness Evidence Gap Review Packet"
BRANCH = "phase25-step4-post-closeout-readiness-safety-disposition-planning"
MODE_KEY = "implementation_post_closeout_readiness_safety_disposition_planning_mode"
WRITE_KEY = "implementation_post_closeout_readiness_safety_disposition_planning_write"
RECORD_KEY = "implementation_post_closeout_readiness_safety_disposition_planning_record_creation"
CONTEXT = "implementation_post_closeout_readiness_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step4_post_closeout_readiness_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/380_Phase25_Step4_Implementation_PostCloseout_Readiness_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP4_POST_CLOSEOUT_READINESS_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step4_post_closeout_readiness_safety_disposition_planning_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 4 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 4 files copied or already present." in text
