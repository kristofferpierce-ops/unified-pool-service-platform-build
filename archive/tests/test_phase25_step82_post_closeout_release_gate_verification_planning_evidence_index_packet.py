...
PHASE = 25
STEP = 82
STEP_TITLE = "Phase 25 Step 82 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Evidence Index Packet"
PRIOR_STEP = "Phase 25 Step 81 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Boundary Packet"
BRANCH = "phase25-step82-post-closeout-release-gate-verification-planning-evidence-index"
MODE_KEY = "implementation_post_closeout_release_gate_verification_planning_evidence_index_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_verification_planning_evidence_index_write"
RECORD_KEY = "implementation_post_closeout_release_gate_verification_planning_evidence_index_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_verification_planning_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step82_post_closeout_release_gate_verification_planning_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/458_Phase25_Step82_Implementation_PostCloseout_Release_Gate_Verification_Planning_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP82_POST_CLOSEOUT_RELEASE_GATE_VERIFICATION_PLANNING_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step82_post_closeout_release_gate_verification_planning_evidence_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 82 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 82 files copied or already present." in text
