...
MODE_KEY = "implementation_release_gate_closeout_evidence_index_mode"
WRITE_KEY = "implementation_release_gate_closeout_evidence_index_write"
RECORD_KEY = "implementation_release_gate_closeout_evidence_index_record_creation"
CONTEXT = "implementation_release_gate_closeout_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step72_implementation_release_gate_closeout_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/248_Phase23_Step72_Implementation_Release_Gate_Closeout_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP72_IMPLEMENTATION_RELEASE_GATE_CLOSEOUT_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step72_implementation_release_gate_closeout_evidence_index_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 72 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 72 files copied or already present." in text
