...
PHASE = 25
STEP = 2
STEP_TITLE = "Phase 25 Step 2 - Phase 20 Network Transport Implementation Post-Closeout Readiness Evidence Index Packet"
PRIOR_STEP = "Phase 25 Step 1 - Phase 20 Network Transport Implementation Post-Closeout Readiness Boundary Packet"
BRANCH = "phase25-step2-post-closeout-readiness-evidence-index"
MODE_KEY = "implementation_post_closeout_readiness_evidence_index_mode"
WRITE_KEY = "implementation_post_closeout_readiness_evidence_index_write"
RECORD_KEY = "implementation_post_closeout_readiness_evidence_index_record_creation"
CONTEXT = "implementation_post_closeout_readiness_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step2_post_closeout_readiness_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/378_Phase25_Step2_Implementation_PostCloseout_Readiness_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP2_POST_CLOSEOUT_READINESS_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step2_post_closeout_readiness_evidence_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 2 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 2 files copied or already present." in text
