...
PHASE = 25
STEP = 20
STEP_TITLE = "Phase 25 Step 20 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Final Boundary Confirmation Packet"
PRIOR_STEP = "Phase 25 Step 19 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Closeout Index Packet"
BRANCH = "phase25-step20-post-closeout-guardrail-verification-final-boundary-confirmation"
MODE_KEY = "implementation_post_closeout_guardrail_verification_final_boundary_confirmation_mode"
WRITE_KEY = "implementation_post_closeout_guardrail_verification_final_boundary_confirmation_write"
RECORD_KEY = "implementation_post_closeout_guardrail_verification_final_boundary_confirmation_record_creation"
CONTEXT = "implementation_post_closeout_guardrail_verification_final_boundary_confirmation_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step20_post_closeout_guardrail_verification_final_boundary_confirmation_packet.ps1"
UI_PAGE = ROOT / "ui/pages/396_Phase25_Step20_Implementation_PostCloseout_Guardrail_Verification_Final_Boundary_Confirmation_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP20_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_FINAL_BOUNDARY_CONFIRMATION_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step20_post_closeout_guardrail_verification_final_boundary_confirmation_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 20 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 20 files copied or already present." in text
