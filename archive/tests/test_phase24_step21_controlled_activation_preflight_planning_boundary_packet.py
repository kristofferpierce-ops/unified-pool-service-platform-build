...
PHASE = 24
STEP = 21
STEP_TITLE = "Phase 24 Step 21 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Boundary Packet"
PRIOR_STEP = "Phase 24 Step 20 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Final Boundary Confirmation Packet"
BRANCH = "phase24-step21-ctrl-activation-preflight-boundary"
MODE_KEY = "implementation_controlled_activation_preflight_planning_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_preflight_planning_boundary_write"
RECORD_KEY = "implementation_controlled_activation_preflight_planning_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_preflight_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step21_controlled_activation_preflight_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/277_Phase24_Step21_Implementation_Controlled_Activation_Preflight_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP21_CONTROLLED_ACTIVATION_PREFLIGHT_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step21_controlled_activation_preflight_planning_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 21 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 21 files copied or already present." in text
