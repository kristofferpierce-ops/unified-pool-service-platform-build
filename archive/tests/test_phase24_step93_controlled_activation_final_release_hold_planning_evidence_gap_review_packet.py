...
PHASE = 24
STEP = 93
STEP_TITLE = "Phase 24 Step 93 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Evidence Gap Review Packet"
PRIOR_STEP = "Phase 24 Step 92 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Evidence Index Packet"
BRANCH = "phase24-step93-final-release-hold-gap-review"
MODE_KEY = "implementation_controlled_activation_final_release_hold_planning_evidence_gap_review_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_planning_evidence_gap_review_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_planning_evidence_gap_review_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_planning_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step93_controlled_activation_final_release_hold_planning_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/349_Phase24_Step93_Implementation_Controlled_Activation_Final_Release_Hold_Planning_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP93_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step93_controlled_activation_final_release_hold_planning_evidence_gap_review_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 93 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 93 files copied or already present." in text
