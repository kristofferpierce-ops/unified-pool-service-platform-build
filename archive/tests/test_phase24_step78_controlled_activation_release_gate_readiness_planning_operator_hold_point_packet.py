...
MODE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_operator_hold_point_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_operator_hold_point_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_readiness_planning_operator_hold_point_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_readiness_planning_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step78_controlled_activation_release_gate_readiness_planning_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/334_Phase24_Step78_Implementation_Controlled_Activation_Release_Gate_Readiness_Planning_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP78_CONTROLLED_ACTIVATION_RELEASE_GATE_READINESS_PLANNING_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step78_controlled_activation_release_gate_readiness_planning_operator_hold_point_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 78 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 78 files copied or already present." in text
