...
BRANCH = "phase23-step28-implementation-patch-assembly-planning-evidence-gap-review"
MODE_KEY = "implementation_patch_assembly_planning_evidence_gap_review_mode"
WRITE_KEY = "implementation_patch_assembly_planning_evidence_gap_review_write"
RECORD_KEY = "implementation_patch_assembly_planning_evidence_gap_review_record_creation"
CONTEXT = "implementation_patch_assembly_planning_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step28_implementation_patch_assembly_planning_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/204_Phase23_Step28_Implementation_Patch_Assembly_Planning_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP28_IMPLEMENTATION_PATCH_ASSEMBLY_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step28_implementation_patch_assembly_planning_evidence_gap_review_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 28 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 28 files copied or already present." in text
