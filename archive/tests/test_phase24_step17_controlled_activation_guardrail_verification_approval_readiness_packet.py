...
PHASE = 24
STEP = 17
STEP_TITLE = "Phase 24 Step 17 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Approval Readiness Packet"
PRIOR_STEP = "Phase 24 Step 16 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Approval Boundary Packet"
BRANCH = "phase24-step17-controlled-activation-guardrail-approval-readiness"
MODE_KEY = "implementation_controlled_activation_guardrail_verification_approval_readiness_mode"
WRITE_KEY = "implementation_controlled_activation_guardrail_verification_approval_readiness_write"
RECORD_KEY = "implementation_controlled_activation_guardrail_verification_approval_readiness_record_creation"
CONTEXT = "implementation_controlled_activation_guardrail_verification_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step17_controlled_activation_guardrail_verification_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/273_Phase24_Step17_Implementation_Controlled_Activation_Guardrail_Verification_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP17_CONTROLLED_ACTIVATION_GUARDRAIL_VERIFICATION_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step17_controlled_activation_guardrail_verification_approval_readiness_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 17 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 17 files copied or already present." in text
