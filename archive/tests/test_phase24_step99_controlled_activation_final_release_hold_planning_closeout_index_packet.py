...
PHASE = 24
STEP = 99
STEP_TITLE = "Phase 24 Step 99 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Closeout Index Packet"
PRIOR_STEP = "Phase 24 Step 98 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Operator Hold Point Packet"
BRANCH = "phase24-step99-final-release-hold-closeout-index"
MODE_KEY = "implementation_controlled_activation_final_release_hold_planning_closeout_index_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_planning_closeout_index_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_planning_closeout_index_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step99_controlled_activation_final_release_hold_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/355_Phase24_Step99_Implementation_Controlled_Activation_Final_Release_Hold_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP99_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step99_controlled_activation_final_release_hold_planning_closeout_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 99 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 99 files copied or already present." in text
