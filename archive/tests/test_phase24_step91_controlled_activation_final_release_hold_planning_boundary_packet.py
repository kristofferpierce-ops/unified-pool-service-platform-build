...
PHASE = 24
STEP = 91
STEP_TITLE = "Phase 24 Step 91 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Boundary Packet"
PRIOR_STEP = "Phase 24 Step 90 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Verification Planning Final Boundary Confirmation Packet"
BRANCH = "phase24-step91-final-release-hold-boundary"
MODE_KEY = "implementation_controlled_activation_final_release_hold_planning_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_planning_boundary_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_planning_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step91_controlled_activation_final_release_hold_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/347_Phase24_Step91_Implementation_Controlled_Activation_Final_Release_Hold_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP91_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step91_controlled_activation_final_release_hold_planning_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 91 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 91 files copied or already present." in text
