...
PHASE = 25
STEP = 86
STEP_TITLE = "Phase 25 Step 86 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Approval Boundary Packet"
PRIOR_STEP = "Phase 25 Step 85 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Safety Disposition Review Packet"
BRANCH = "phase25-step86-post-closeout-release-gate-verification-planning-approval-boundary"
MODE_KEY = "implementation_post_closeout_release_gate_verification_planning_approval_boundary_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_verification_planning_approval_boundary_write"
RECORD_KEY = "implementation_post_closeout_release_gate_verification_planning_approval_boundary_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_verification_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step86_post_closeout_release_gate_verification_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/462_Phase25_Step86_Implementation_PostCloseout_Release_Gate_Verification_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP86_POST_CLOSEOUT_RELEASE_GATE_VERIFICATION_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step86_post_closeout_release_gate_verification_planning_approval_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 86 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 86 files copied or already present." in text
