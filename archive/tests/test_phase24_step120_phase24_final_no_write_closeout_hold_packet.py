...
PHASE = 24
STEP = 120
STEP_TITLE = "Phase 24 Step 120 - Phase 20 Network Transport Implementation Phase 24 Final No-Write Closeout Hold Packet"
PRIOR_STEP = "Phase 24 Step 119 - Phase 20 Network Transport Implementation Controlled Activation Final Release Result Review Planning Closeout Index Packet"
BRANCH = "phase24-step120-final-no-write-closeout-hold"
MODE_KEY = "implementation_phase24_final_no_write_closeout_hold_mode"
WRITE_KEY = "implementation_phase24_final_no_write_closeout_hold_write"
RECORD_KEY = "implementation_phase24_final_no_write_closeout_hold_record_creation"
CONTEXT = "implementation_phase24_final_no_write_closeout_hold_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step120_phase24_final_no_write_closeout_hold_packet.ps1"
UI_PAGE = ROOT / "ui/pages/376_Phase24_Step120_Implementation_Phase24_Final_No_Write_Closeout_Hold_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP120_PHASE24_FINAL_NO_WRITE_CLOSEOUT_HOLD_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step120_phase24_final_no_write_closeout_hold_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 120 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 120 files copied or already present." in text
