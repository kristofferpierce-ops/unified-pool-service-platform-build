...
PHASE = 25
STEP = 8
STEP_TITLE = "Phase 25 Step 8 - Phase 20 Network Transport Implementation Post-Closeout Readiness Operator Hold Point Packet"
PRIOR_STEP = "Phase 25 Step 7 - Phase 20 Network Transport Implementation Post-Closeout Readiness Approval Readiness Packet"
BRANCH = "phase25-step8-post-closeout-readiness-operator-hold-point"
MODE_KEY = "implementation_post_closeout_readiness_operator_hold_point_mode"
WRITE_KEY = "implementation_post_closeout_readiness_operator_hold_point_write"
RECORD_KEY = "implementation_post_closeout_readiness_operator_hold_point_record_creation"
CONTEXT = "implementation_post_closeout_readiness_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step8_post_closeout_readiness_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/384_Phase25_Step8_Implementation_PostCloseout_Readiness_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP8_POST_CLOSEOUT_READINESS_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step8_post_closeout_readiness_operator_hold_point_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 8 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 8 files copied or already present." in text
