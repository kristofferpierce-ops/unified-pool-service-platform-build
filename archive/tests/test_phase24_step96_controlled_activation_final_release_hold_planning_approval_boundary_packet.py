...
PHASE = 24
STEP = 96
STEP_TITLE = "Phase 24 Step 96 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Approval Boundary Packet"
PRIOR_STEP = "Phase 24 Step 95 - Phase 20 Network Transport Implementation Controlled Activation Final Release Hold Planning Safety Disposition Review Packet"
BRANCH = "phase24-step96-final-release-hold-approval-boundary"
MODE_KEY = "implementation_controlled_activation_final_release_hold_planning_approval_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_planning_approval_boundary_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_planning_approval_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step96_controlled_activation_final_release_hold_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/352_Phase24_Step96_Implementation_Controlled_Activation_Final_Release_Hold_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP96_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step96_controlled_activation_final_release_hold_planning_approval_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 96 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 96 files copied or already present." in text
