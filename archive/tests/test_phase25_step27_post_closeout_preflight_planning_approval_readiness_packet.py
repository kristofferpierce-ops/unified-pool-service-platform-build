...
PHASE = 25
STEP = 27
STEP_TITLE = "Phase 25 Step 27 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Approval Readiness Packet"
PRIOR_STEP = "Phase 25 Step 26 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Approval Boundary Packet"
BRANCH = "phase25-step27-post-closeout-preflight-planning-approval-readiness"
MODE_KEY = "implementation_post_closeout_preflight_planning_approval_readiness_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_approval_readiness_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_approval_readiness_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step27_post_closeout_preflight_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/403_Phase25_Step27_Implementation_PostCloseout_Preflight_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP27_POST_CLOSEOUT_PREFLIGHT_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step27_post_closeout_preflight_planning_approval_readiness_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 27 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 27 files copied or already present." in text
