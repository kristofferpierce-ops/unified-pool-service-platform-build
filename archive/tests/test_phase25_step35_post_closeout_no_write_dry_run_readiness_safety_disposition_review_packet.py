...
PHASE = 25
STEP = 35
STEP_TITLE = "Phase 25 Step 35 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Safety Disposition Review Packet"
PRIOR_STEP = "Phase 25 Step 34 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Safety Disposition Planning Packet"
BRANCH = "phase25-step35-post-closeout-no-write-dry-run-readiness-safety-disposition-review"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_safety_disposition_review_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_safety_disposition_review_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_readiness_safety_disposition_review_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_readiness_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step35_post_closeout_no_write_dry_run_readiness_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/411_Phase25_Step35_Implementation_PostCloseout_NoWrite_Dry_Run_Readiness_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP35_POST_CLOSEOUT_NO_WRITE_DRY_RUN_READINESS_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step35_post_closeout_no_write_dry_run_readiness_safety_disposition_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 35 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 35 files copied or already present." in text
