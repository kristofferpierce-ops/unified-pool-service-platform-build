...
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_closeout_index_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_closeout_index_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_closeout_index_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step69_controlled_activation_no_write_dry_run_result_disposition_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/325_Phase24_Step69_Implementation_Controlled_Activation_No_Write_Dry_Run_Result_Disposition_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP69_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_RESULT_DISPOSITION_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step69_controlled_activation_no_write_dry_run_result_disposition_planning_closeout_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 69 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 69 files copied or already present." in text
