...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_boundary_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_boundary_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_boundary_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_review_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step51_post_closeout_no_write_dry_run_result_review_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/427_Phase25_Step51_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Review_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP51_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_REVIEW_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step51_post_closeout_no_write_dry_run_result_review_planning_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 51 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 51 files copied or already present." in text
