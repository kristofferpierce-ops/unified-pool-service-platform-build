...
PHASE = 25
STEP = 52
STEP_TITLE = "Phase 25 Step 52 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Result Review Planning Evidence Index Packet"
PRIOR_STEP = "Phase 25 Step 51 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Result Review Planning Boundary Packet"
BRANCH = "phase25-step52-post-closeout-no-write-dry-run-result-review-planning-evidence-index"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_evidence_index_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_evidence_index_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_review_planning_evidence_index_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_review_planning_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step52_post_closeout_no_write_dry_run_result_review_planning_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/428_Phase25_Step52_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Review_Planning_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP52_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_REVIEW_PLANNING_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step52_post_closeout_no_write_dry_run_result_review_planning_evidence_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 52 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 52 files copied or already present." in text
