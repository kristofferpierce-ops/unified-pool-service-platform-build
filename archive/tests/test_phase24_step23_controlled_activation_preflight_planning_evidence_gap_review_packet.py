...
PHASE = 24
STEP = 23
STEP_TITLE = "Phase 24 Step 23 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Evidence Gap Review Packet"
PRIOR_STEP = "Phase 24 Step 22 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Evidence Index Packet"
BRANCH = "phase24-step23-ctrl-activation-preflight-evidence-gap-review"
MODE_KEY = "implementation_controlled_activation_preflight_planning_evidence_gap_review_mode"
WRITE_KEY = "implementation_controlled_activation_preflight_planning_evidence_gap_review_write"
RECORD_KEY = "implementation_controlled_activation_preflight_planning_evidence_gap_review_record_creation"
CONTEXT = "implementation_controlled_activation_preflight_planning_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step23_controlled_activation_preflight_planning_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/279_Phase24_Step23_Implementation_Controlled_Activation_Preflight_Planning_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP23_CONTROLLED_ACTIVATION_PREFLIGHT_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step23_controlled_activation_preflight_planning_evidence_gap_review_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 23 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 23 files copied or already present." in text
