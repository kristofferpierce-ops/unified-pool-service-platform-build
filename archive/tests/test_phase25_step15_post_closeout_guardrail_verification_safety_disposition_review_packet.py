...
PHASE = 25
STEP = 15
STEP_TITLE = "Phase 25 Step 15 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Safety Disposition Review Packet"
PRIOR_STEP = "Phase 25 Step 14 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Safety Disposition Planning Packet"
BRANCH = "phase25-step15-post-closeout-guardrail-verification-safety-disposition-review"
MODE_KEY = "implementation_post_closeout_guardrail_verification_safety_disposition_review_mode"
WRITE_KEY = "implementation_post_closeout_guardrail_verification_safety_disposition_review_write"
RECORD_KEY = "implementation_post_closeout_guardrail_verification_safety_disposition_review_record_creation"
CONTEXT = "implementation_post_closeout_guardrail_verification_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step15_post_closeout_guardrail_verification_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/391_Phase25_Step15_Implementation_PostCloseout_Guardrail_Verification_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP15_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step15_post_closeout_guardrail_verification_safety_disposition_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 15 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 15 files copied or already present." in text
