...
PHASE = 25
STEP = 71
STEP_TITLE = "Phase 25 Step 71 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Readiness Planning Boundary Packet"
PRIOR_STEP = "Phase 25 Step 70 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Result Disposition Planning Final Boundary Confirmation Packet"
BRANCH = "phase25-step71-post-closeout-release-gate-readiness-planning-boundary"
MODE_KEY = "implementation_post_closeout_release_gate_readiness_planning_boundary_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_readiness_planning_boundary_write"
RECORD_KEY = "implementation_post_closeout_release_gate_readiness_planning_boundary_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_readiness_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step71_post_closeout_release_gate_readiness_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/447_Phase25_Step71_Implementation_PostCloseout_Release_Gate_Readiness_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP71_POST_CLOSEOUT_RELEASE_GATE_READINESS_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step71_post_closeout_release_gate_readiness_planning_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 71 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 71 files copied or already present." in text
