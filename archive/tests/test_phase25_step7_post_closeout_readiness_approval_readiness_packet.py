...
PHASE = 25
STEP = 7
STEP_TITLE = "Phase 25 Step 7 - Phase 20 Network Transport Implementation Post-Closeout Readiness Approval Readiness Packet"
PRIOR_STEP = "Phase 25 Step 6 - Phase 20 Network Transport Implementation Post-Closeout Readiness Approval Boundary Packet"
BRANCH = "phase25-step7-post-closeout-readiness-approval-readiness"
MODE_KEY = "implementation_post_closeout_readiness_approval_readiness_mode"
WRITE_KEY = "implementation_post_closeout_readiness_approval_readiness_write"
RECORD_KEY = "implementation_post_closeout_readiness_approval_readiness_record_creation"
CONTEXT = "implementation_post_closeout_readiness_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step7_post_closeout_readiness_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/383_Phase25_Step7_Implementation_PostCloseout_Readiness_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP7_POST_CLOSEOUT_READINESS_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step7_post_closeout_readiness_approval_readiness_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 7 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 7 files copied or already present." in text
