...
PHASE = 25
STEP = 38
STEP_TITLE = "Phase 25 Step 38 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Operator Hold Point Packet"
PRIOR_STEP = "Phase 25 Step 37 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Approval Readiness Packet"
BRANCH = "phase25-step38-post-closeout-no-write-dry-run-readiness-operator-hold-point"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_operator_hold_point_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_operator_hold_point_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_readiness_operator_hold_point_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_readiness_operator_hold_point_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step38_post_closeout_no_write_dry_run_readiness_operator_hold_point_packet.ps1"
UI_PAGE = ROOT / "ui/pages/414_Phase25_Step38_Implementation_PostCloseout_NoWrite_Dry_Run_Readiness_Operator_Hold_Point_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP38_POST_CLOSEOUT_NO_WRITE_DRY_RUN_READINESS_OPERATOR_HOLD_POINT_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step38_post_closeout_no_write_dry_run_readiness_operator_hold_point_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 38 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 38 files copied or already present." in text
