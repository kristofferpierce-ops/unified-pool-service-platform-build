...
PHASE = 25
STEP = 39
STEP_TITLE = "Phase 25 Step 39 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Closeout Index Packet"
PRIOR_STEP = "Phase 25 Step 38 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Operator Hold Point Packet"
BRANCH = "phase25-step39-post-closeout-no-write-dry-run-readiness-closeout-index"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_closeout_index_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_closeout_index_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_readiness_closeout_index_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_readiness_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step39_post_closeout_no_write_dry_run_readiness_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/415_Phase25_Step39_Implementation_PostCloseout_NoWrite_Dry_Run_Readiness_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP39_POST_CLOSEOUT_NO_WRITE_DRY_RUN_READINESS_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step39_post_closeout_no_write_dry_run_readiness_closeout_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 39 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 39 files copied or already present." in text
