...
PHASE = 25
STEP = 89
STEP_TITLE = "Phase 25 Step 89 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Closeout Index Packet"
PRIOR_STEP = "Phase 25 Step 88 - Phase 20 Network Transport Implementation Post-Closeout Release Gate Verification Planning Operator Hold Point Packet"
BRANCH = "phase25-step89-post-closeout-release-gate-verification-planning-closeout-index"
MODE_KEY = "implementation_post_closeout_release_gate_verification_planning_closeout_index_mode"
WRITE_KEY = "implementation_post_closeout_release_gate_verification_planning_closeout_index_write"
RECORD_KEY = "implementation_post_closeout_release_gate_verification_planning_closeout_index_record_creation"
CONTEXT = "implementation_post_closeout_release_gate_verification_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step89_post_closeout_release_gate_verification_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/465_Phase25_Step89_Implementation_PostCloseout_Release_Gate_Verification_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP89_POST_CLOSEOUT_RELEASE_GATE_VERIFICATION_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step89_post_closeout_release_gate_verification_planning_closeout_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 89 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 89 files copied or already present." in text
