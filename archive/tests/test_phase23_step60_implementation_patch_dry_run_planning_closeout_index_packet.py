...
BRANCH = "phase23-step60-implementation-patch-dry-run-planning-closeout-index"
MODE_KEY = "implementation_patch_dry_run_planning_closeout_index_mode"
WRITE_KEY = "implementation_patch_dry_run_planning_closeout_index_write"
RECORD_KEY = "implementation_patch_dry_run_planning_closeout_index_record_creation"
CONTEXT = "implementation_patch_dry_run_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step60_implementation_patch_dry_run_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/236_Phase23_Step60_Implementation_Patch_Dry_Run_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP60_IMPLEMENTATION_PATCH_DRY_RUN_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step60_implementation_patch_dry_run_planning_closeout_index_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 60 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 60 files copied or already present." in text
