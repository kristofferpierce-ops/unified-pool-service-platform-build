...
PHASE = 24
STEP = 32
STEP_TITLE = "Phase 24 Step 32 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Evidence Index Packet"
PRIOR_STEP = "Phase 24 Step 31 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Boundary Packet"
BRANCH = "phase24-step32-ctrl-activation-dry-run-evidence-index"
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_evidence_index_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_evidence_index_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_evidence_index_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_readiness_evidence_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step32_controlled_activation_no_write_dry_run_readiness_evidence_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/288_Phase24_Step32_Implementation_Controlled_Activation_No_Write_Dry_Run_Readiness_Evidence_Index_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP32_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_READINESS_EVIDENCE_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step32_controlled_activation_no_write_dry_run_readiness_evidence_index_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 32 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 32 files copied or already present." in text
