...
PHASE = 24
STEP = 7
STEP_TITLE = "Phase 24 Step 7 - Phase 20 Network Transport Implementation Controlled Activation Approval Readiness Packet"
PRIOR_STEP = "Phase 24 Step 6 - Phase 20 Network Transport Implementation Controlled Activation Approval Boundary Packet"
BRANCH = "phase24-step7-controlled-activation-approval-readiness"
MODE_KEY = "implementation_controlled_activation_approval_readiness_mode"
WRITE_KEY = "implementation_controlled_activation_approval_readiness_write"
RECORD_KEY = "implementation_controlled_activation_approval_readiness_record_creation"
CONTEXT = "implementation_controlled_activation_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step7_controlled_activation_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/263_Phase24_Step7_Implementation_Controlled_Activation_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP7_CONTROLLED_ACTIVATION_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step7_controlled_activation_approval_readiness_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 7 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 7 files copied or already present." in text
