...
PHASE = 25
STEP = 5
STEP_TITLE = "Phase 25 Step 5 - Phase 20 Network Transport Implementation Post-Closeout Readiness Safety Disposition Review Packet"
PRIOR_STEP = "Phase 25 Step 4 - Phase 20 Network Transport Implementation Post-Closeout Readiness Safety Disposition Planning Packet"
BRANCH = "phase25-step5-post-closeout-readiness-safety-disposition-review"
MODE_KEY = "implementation_post_closeout_readiness_safety_disposition_review_mode"
WRITE_KEY = "implementation_post_closeout_readiness_safety_disposition_review_write"
RECORD_KEY = "implementation_post_closeout_readiness_safety_disposition_review_record_creation"
CONTEXT = "implementation_post_closeout_readiness_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step5_post_closeout_readiness_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/381_Phase25_Step5_Implementation_PostCloseout_Readiness_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP5_POST_CLOSEOUT_READINESS_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step5_post_closeout_readiness_safety_disposition_review_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 5 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 5 files copied or already present." in text
