...
PHASE = 25
STEP = 29
STEP_TITLE = "Phase 25 Step 29 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Closeout Index Packet"
PRIOR_STEP = "Phase 25 Step 28 - Phase 20 Network Transport Implementation Post-Closeout Preflight Planning Operator Hold Point Packet"
BRANCH = "phase25-step29-post-closeout-preflight-planning-closeout-index"
MODE_KEY = "implementation_post_closeout_preflight_planning_closeout_index_mode"
WRITE_KEY = "implementation_post_closeout_preflight_planning_closeout_index_write"
RECORD_KEY = "implementation_post_closeout_preflight_planning_closeout_index_record_creation"
CONTEXT = "implementation_post_closeout_preflight_planning_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step29_post_closeout_preflight_planning_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/405_Phase25_Step29_Implementation_PostCloseout_Preflight_Planning_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP29_POST_CLOSEOUT_PREFLIGHT_PLANNING_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step29_post_closeout_preflight_planning_closeout_index_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 29 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 29 files copied or already present." in text
