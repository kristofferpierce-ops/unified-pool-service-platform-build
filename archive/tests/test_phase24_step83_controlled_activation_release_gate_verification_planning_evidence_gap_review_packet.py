...
MODE_KEY = "implementation_controlled_activation_release_gate_verification_planning_evidence_gap_review_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_verification_planning_evidence_gap_review_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_verification_planning_evidence_gap_review_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_verification_planning_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step83_controlled_activation_release_gate_verification_planning_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/339_Phase24_Step83_Implementation_Controlled_Activation_Release_Gate_Verification_Planning_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP83_CONTROLLED_ACTIVATION_RELEASE_GATE_VERIFICATION_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step83_controlled_activation_release_gate_verification_planning_evidence_gap_review_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 83 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 83 files copied or already present." in text
