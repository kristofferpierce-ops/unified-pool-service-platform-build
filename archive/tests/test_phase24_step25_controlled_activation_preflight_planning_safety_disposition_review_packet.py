...
PHASE = 24
STEP = 25
STEP_TITLE = "Phase 24 Step 25 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Safety Disposition Review Packet"
PRIOR_STEP = "Phase 24 Step 24 - Phase 20 Network Transport Implementation Controlled Activation Preflight Planning Safety Disposition Planning Packet"
BRANCH = "phase24-step25-ctrl-activation-preflight-safety-disposition-review"
MODE_KEY = "implementation_controlled_activation_preflight_planning_safety_disposition_review_mode"
WRITE_KEY = "implementation_controlled_activation_preflight_planning_safety_disposition_review_write"
RECORD_KEY = "implementation_controlled_activation_preflight_planning_safety_disposition_review_record_creation"
CONTEXT = "implementation_controlled_activation_preflight_planning_safety_disposition_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step25_controlled_activation_preflight_planning_safety_disposition_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/281_Phase24_Step25_Implementation_Controlled_Activation_Preflight_Planning_Safety_Disposition_Review_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP25_CONTROLLED_ACTIVATION_PREFLIGHT_PLANNING_SAFETY_DISPOSITION_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step25_controlled_activation_preflight_planning_safety_disposition_review_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 25 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 25 files copied or already present." in text
