...
PHASE = 24
STEP = 41
STEP_TITLE = "Phase 24 Step 41 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Verification Planning Boundary Packet"
PRIOR_STEP = "Phase 24 Step 40 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Final Boundary Confirmation Packet"
BRANCH = "phase24-step41-ctrl-activation-dry-run-verify-boundary"
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_verification_planning_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_verification_planning_boundary_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_verification_planning_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_verification_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step41_controlled_activation_no_write_dry_run_verification_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/297_Phase24_Step41_Implementation_Controlled_Activation_No_Write_Dry_Run_Verification_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP41_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step41_controlled_activation_no_write_dry_run_verification_planning_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 41 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 41 files copied or already present." in text
