...
MODE_KEY = "implementation_controlled_activation_final_release_result_review_planning_approval_readiness_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_result_review_planning_approval_readiness_write"
RECORD_KEY = "implementation_controlled_activation_final_release_result_review_planning_approval_readiness_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_result_review_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step117_controlled_activation_final_release_result_review_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/373_Phase24_Step117_Implementation_Controlled_Activation_Final_Release_Result_Review_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP117_CONTROLLED_ACTIVATION_FINAL_RELEASE_RESULT_REVIEW_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step117_controlled_activation_final_release_result_review_planning_approval_readiness_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 117 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 117 files copied or already present." in text
