...
MODE_KEY = "implementation_controlled_activation_final_release_hold_verification_planning_approval_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_final_release_hold_verification_planning_approval_boundary_write"
RECORD_KEY = "implementation_controlled_activation_final_release_hold_verification_planning_approval_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_final_release_hold_verification_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step106_controlled_activation_final_release_hold_verification_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/362_Phase24_Step106_Implementation_Controlled_Activation_Final_Release_Hold_Verification_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP106_CONTROLLED_ACTIVATION_FINAL_RELEASE_HOLD_VERIFICATION_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step106_controlled_activation_final_release_hold_verification_planning_approval_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 106 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 106 files copied or already present." in text
