...
MODE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_planning_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_planning_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_planning_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step64_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/440_Phase25_Step64_Implementation_PostCloseout_NoWrite_Dry_Run_Result_Disposition_Planning_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP64_POST_CLOSEOUT_NO_WRITE_DRY_RUN_RESULT_DISPOSITION_PLANNING_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step64_post_closeout_no_write_dry_run_result_disposition_planning_safety_disposition_planning_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 64 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 64 files copied or already present." in text
