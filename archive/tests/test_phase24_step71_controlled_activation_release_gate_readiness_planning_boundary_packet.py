...
PHASE = 24
STEP = 71
STEP_TITLE = "Phase 24 Step 71 - Phase 20 Network Transport Implementation Controlled Activation Release Gate Readiness Planning Boundary Packet"
PRIOR_STEP = "Phase 24 Step 70 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Result Disposition Planning Final Boundary Confirmation Packet"
BRANCH = "phase24-step71-release-gate-readiness-boundary"
MODE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_boundary_mode"
WRITE_KEY = "implementation_controlled_activation_release_gate_readiness_planning_boundary_write"
RECORD_KEY = "implementation_controlled_activation_release_gate_readiness_planning_boundary_record_creation"
CONTEXT = "implementation_controlled_activation_release_gate_readiness_planning_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step71_controlled_activation_release_gate_readiness_planning_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/327_Phase24_Step71_Implementation_Controlled_Activation_Release_Gate_Readiness_Planning_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP71_CONTROLLED_ACTIVATION_RELEASE_GATE_READINESS_PLANNING_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step71_controlled_activation_release_gate_readiness_planning_boundary_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 71 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 71 files copied or already present." in text
