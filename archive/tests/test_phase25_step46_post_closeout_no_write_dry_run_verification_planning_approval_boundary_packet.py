...
PHASE = 25
STEP = 46
STEP_TITLE = "Phase 25 Step 46 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Verification Planning Approval Boundary Packet"
PRIOR_STEP = "Phase 25 Step 45 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Verification Planning Safety Disposition Review Packet"
BRANCH = "phase25-step46-post-closeout-no-write-dry-run-verification-planning-approval-boundary"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_approval_boundary_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_approval_boundary_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_approval_boundary_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_verification_planning_approval_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step46_post_closeout_no_write_dry_run_verification_planning_approval_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/422_Phase25_Step46_Implementation_PostCloseout_NoWrite_Dry_Run_Verification_Planning_Approval_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP46_POST_CLOSEOUT_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_APPROVAL_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step46_post_closeout_no_write_dry_run_verification_planning_approval_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 46 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 46 files copied or already present." in text
