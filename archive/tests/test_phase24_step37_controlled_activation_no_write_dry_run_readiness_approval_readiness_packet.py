...
PHASE = 24
STEP = 37
STEP_TITLE = "Phase 24 Step 37 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Approval Readiness Packet"
PRIOR_STEP = "Phase 24 Step 36 - Phase 20 Network Transport Implementation Controlled Activation No-Write Dry Run Readiness Approval Boundary Packet"
BRANCH = "phase24-step37-ctrl-activation-dry-run-approval-readiness"
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_approval_readiness_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_approval_readiness_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_readiness_approval_readiness_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_readiness_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step37_controlled_activation_no_write_dry_run_readiness_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/293_Phase24_Step37_Implementation_Controlled_Activation_No_Write_Dry_Run_Readiness_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP37_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_READINESS_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step37_controlled_activation_no_write_dry_run_readiness_approval_readiness_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 37 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 37 files copied or already present." in text
