...
PHASE = 25
STEP = 11
STEP_TITLE = "Phase 25 Step 11 - Phase 20 Network Transport Implementation Post-Closeout Guardrail Verification Boundary Packet"
PRIOR_STEP = "Phase 25 Step 10 - Phase 20 Network Transport Implementation Post-Closeout Readiness Final Boundary Confirmation Packet"
BRANCH = "phase25-step11-post-closeout-guardrail-verification-boundary"
MODE_KEY = "implementation_post_closeout_guardrail_verification_boundary_mode"
WRITE_KEY = "implementation_post_closeout_guardrail_verification_boundary_write"
RECORD_KEY = "implementation_post_closeout_guardrail_verification_boundary_record_creation"
CONTEXT = "implementation_post_closeout_guardrail_verification_boundary_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step11_post_closeout_guardrail_verification_boundary_packet.ps1"
UI_PAGE = ROOT / "ui/pages/387_Phase25_Step11_Implementation_PostCloseout_Guardrail_Verification_Boundary_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP11_POST_CLOSEOUT_GUARDRAIL_VERIFICATION_BOUNDARY_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step11_post_closeout_guardrail_verification_boundary_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 11 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 11 files copied or already present." in text
