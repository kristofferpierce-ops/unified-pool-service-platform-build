...
MODE_KEY = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_evidence_gap_review_mode"
WRITE_KEY = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_evidence_gap_review_write"
RECORD_KEY = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_evidence_gap_review_record_creation"
CONTEXT = "implementation_controlled_activation_no_write_dry_run_result_disposition_planning_evidence_gap_review_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step63_controlled_activation_no_write_dry_run_result_disposition_planning_evidence_gap_review_packet.ps1"
UI_PAGE = ROOT / "ui/pages/319_Phase24_Step63_Implementation_Controlled_Activation_No_Write_Dry_Run_Result_Disposition_Planning_Evidence_Gap_Review_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP63_CONTROLLED_ACTIVATION_NO_WRITE_DRY_RUN_RESULT_DISPOSITION_PLANNING_EVIDENCE_GAP_REVIEW_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step63_controlled_activation_no_write_dry_run_result_disposition_planning_evidence_gap_review_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 63 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 63 files copied or already present." in text
