...
PHASE = 25
STEP = 47
STEP_TITLE = "Phase 25 Step 47 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Verification Planning Approval Readiness Packet"
PRIOR_STEP = "Phase 25 Step 46 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Verification Planning Approval Boundary Packet"
BRANCH = "phase25-step47-post-closeout-no-write-dry-run-verification-planning-approval-readiness"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_approval_readiness_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_approval_readiness_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_verification_planning_approval_readiness_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_verification_planning_approval_readiness_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step47_post_closeout_no_write_dry_run_verification_planning_approval_readiness_packet.ps1"
UI_PAGE = ROOT / "ui/pages/423_Phase25_Step47_Implementation_PostCloseout_NoWrite_Dry_Run_Verification_Planning_Approval_Readiness_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP47_POST_CLOSEOUT_NO_WRITE_DRY_RUN_VERIFICATION_PLANNING_APPROVAL_READINESS_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step47_post_closeout_no_write_dry_run_verification_planning_approval_readiness_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 47 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 47 files copied or already present." in text
