...
PHASE = 25
STEP = 34
STEP_TITLE = "Phase 25 Step 34 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Safety Disposition Planning Packet"
PRIOR_STEP = "Phase 25 Step 33 - Phase 20 Network Transport Implementation Post-Closeout No-Write Dry Run Readiness Evidence Gap Review Packet"
BRANCH = "phase25-step34-post-closeout-no-write-dry-run-readiness-safety-disposition-planning"
MODE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_safety_disposition_planning_mode"
WRITE_KEY = "implementation_post_closeout_no_write_dry_run_readiness_safety_disposition_planning_write"
RECORD_KEY = "implementation_post_closeout_no_write_dry_run_readiness_safety_disposition_planning_record_creation"
CONTEXT = "implementation_post_closeout_no_write_dry_run_readiness_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase25_step34_post_closeout_no_write_dry_run_readiness_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/410_Phase25_Step34_Implementation_PostCloseout_NoWrite_Dry_Run_Readiness_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE25_STEP34_POST_CLOSEOUT_NO_WRITE_DRY_RUN_READINESS_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase25_step34_post_closeout_no_write_dry_run_readiness_safety_disposition_planning_packet.py"
...
def test_phase25_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 25 Step 34 menu" in text
    ...
    assert "APPLY PASS: Phase 25 Step 34 files copied or already present." in text
