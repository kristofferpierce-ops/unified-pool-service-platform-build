...
BRANCH = "phase23-step24-implementation-patch-readiness-closeout-index"
MODE_KEY = "implementation_patch_readiness_closeout_index_mode"
WRITE_KEY = "implementation_patch_readiness_closeout_index_write"
RECORD_KEY = "implementation_patch_readiness_closeout_index_record_creation"
CONTEXT = "implementation_patch_readiness_closeout_index_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase23_step24_implementation_patch_readiness_closeout_index_packet.ps1"
UI_PAGE = ROOT / "ui/pages/200_Phase23_Step24_Implementation_Patch_Readiness_Closeout_Index_Packet.py"
DOC = ROOT / "docs/PHASE23_STEP24_IMPLEMENTATION_PATCH_READINESS_CLOSEOUT_INDEX_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase23_step24_implementation_patch_readiness_closeout_index_packet.py"
...
def test_phase23_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 23 Step 24 menu" in text
    ...
    assert "APPLY PASS: Phase 23 Step 24 files copied or already present." in text
