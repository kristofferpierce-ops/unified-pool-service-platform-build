...
PHASE = 24
STEP = 14
STEP_TITLE = "Phase 24 Step 14 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Safety Disposition Planning Packet"
PRIOR_STEP = "Phase 24 Step 13 - Phase 20 Network Transport Implementation Controlled Activation Guardrail Verification Evidence Gap Review Packet"
BRANCH = "phase24-step14-controlled-activation-guardrail-safety-plan"
MODE_KEY = "implementation_controlled_activation_guardrail_verification_safety_disposition_planning_mode"
WRITE_KEY = "implementation_controlled_activation_guardrail_verification_safety_disposition_planning_write"
RECORD_KEY = "implementation_controlled_activation_guardrail_verification_safety_disposition_planning_record_creation"
CONTEXT = "implementation_controlled_activation_guardrail_verification_safety_disposition_planning_planning_only"

STEP_SCRIPT = ROOT / "scripts/phase24_step14_controlled_activation_guardrail_verification_safety_disposition_planning_packet.ps1"
UI_PAGE = ROOT / "ui/pages/270_Phase24_Step14_Implementation_Controlled_Activation_Guardrail_Verification_Safety_Disposition_Planning_Packet.py"
DOC = ROOT / "docs/PHASE24_STEP14_CONTROLLED_ACTIVATION_GUARDRAIL_VERIFICATION_SAFETY_DISPOSITION_PLANNING_PACKET.md"
TEST_FILE = ROOT / "tests/test_phase24_step14_controlled_activation_guardrail_verification_safety_disposition_planning_packet.py"
...
def test_phase24_step_launcher_has_menu_and_optimized_actions():
    ...
    assert "Phase 24 Step 14 menu" in text
    ...
    assert "APPLY PASS: Phase 24 Step 14 files copied or already present." in text
