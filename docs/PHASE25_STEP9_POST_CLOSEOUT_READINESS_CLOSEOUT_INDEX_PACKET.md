...
- Phase: 25
- Step: 9
- Prior step: Phase 25 Step 8 - Phase 20 Network Transport Implementation Post-Closeout Readiness Operator Hold Point Packet
- Branch: `phase25-step9-post-closeout-readiness-closeout-index`
...
Set-Location $Parent
powershell.exe -NoProfile -ExecutionPolicy Bypass -File (Join-Path $Parent "unified_pool_service_platform_build\scripts/phase25_step9_post_closeout_readiness_closeout_index_packet.ps1") -Action all
```

## Expected smoke-test text

```text
SMOKE TEST PASS: Phase 25 Step 9 Implementation Post-Closeout Readiness Closeout Index Packet is present and planning-only.
```
...
PASS: phase25_boundary=implementation_post_closeout_readiness_closeout_index_opened_by_packet
...
PASS: implementation_post_closeout_readiness_closeout_index_mode=reference_only
PASS: implementation_post_closeout_readiness_closeout_index_write=false
PASS: implementation_post_closeout_readiness_closeout_index_record_creation=false
...
CHECK: prior_step=Phase 25 Step 8 - Phase 20 Network Transport Implementation Post-Closeout Readiness Operator Hold Point Packet
CHECK: phase25_context=implementation_post_closeout_readiness_closeout_index_planning_only
