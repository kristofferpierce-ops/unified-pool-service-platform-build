...
Phase 22 Step 8 continues the planning phase after the Phase 22 planning readiness packet.

It creates a no-write planning review packet for the Phase 20 bridge routing network transport chain. It reads the latest Phase 22 planning readiness packet, carries forward keep-latest and manual-archive-review decisions, preserves the do-not-stage boundary, and turns the planning readiness areas into explicit planning review areas for execution envelope, transport injection, bridge gate, response storage, cutover review, and audit/rollback review.
...
## Generate planning review packet

From the platform repo, with FastAPI and bridge running:

```powershell
powershell -ExecutionPolicy Bypass -File scripts\phase22_generate_phase20_network_transport_planning_review_packet.ps1
```

Output:

```text
C:\Users\krist\Desktop\unified_pool_service_platform_build\backups\phase22_phase20_network_transport_planning_review_packet_<timestamp>
```
...
phase22_phase20_network_transport_planning_review_packet_sections.csv
phase22_phase20_network_transport_planning_review_packet_entries.csv
phase22_phase20_network_transport_planning_review_packet_review_areas.csv
phase22_phase20_network_transport_planning_review_packet_decisions.csv
phase22_phase20_network_transport_planning_review_packet_artifact_families.csv
phase22_phase20_network_transport_planning_review_packet_git_status.csv
phase22_phase20_network_transport_planning_review_packet_staged.csv
phase22_phase20_network_transport_planning_review_packet_source_artifacts.csv
phase22_phase20_network_transport_planning_review_packet_checklist.csv
phase22_phase20_network_transport_planning_review_packet_issues.csv
phase22_phase20_network_transport_planning_review_packet.md
```
...
```text
Phase20 Network Transport Planning Review Packet
```

## Commit guard

Stage only the four Phase 22 Step 8 files. Do not stage generated planning-review files, local databases, `.env`, `.venv`, bridge folders, backups, evidence packs, import artifacts, or unrelated Replaster Quote files.
