...
- Phase: 23
- Step: 64
- Prior step: Phase 23 Step 63 - Phase 20 Network Transport Implementation Patch Release Planning Evidence Index Packet
...
Set-Location $Parent
powershell.exe -NoProfile -ExecutionPolicy Bypass -File (Join-Path $Parent "unified_pool_service_platform_build\scripts/phase23_step64_implementation_patch_release_planning_evidence_gap_review_packet.ps1") -Action all
```

## Expected smoke-test text

```text
SMOKE TEST PASS: Phase 23 Step 64 Implementation Patch Release Planning Evidence Gap Review Packet is present and planning-only.
```
...
PASS: phase23_planning_boundary=implementation_patch_release_planning_evidence_gap_review_opened_by_packet
...
PASS: implementation_patch_release_planning_evidence_gap_review_mode=reference_only
PASS: implementation_patch_release_planning_evidence_gap_review_write=false
PASS: implementation_patch_release_planning_evidence_gap_review_record_creation=false
...
CHECK: prior_step=Phase 23 Step 63 - Phase 20 Network Transport Implementation Patch Release Planning Evidence Index Packet
CHECK: phase23_context=implementation_patch_release_planning_evidence_gap_review_planning_only
