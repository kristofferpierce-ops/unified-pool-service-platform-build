...
Phase 22 Step 13 continues the planning phase after the Phase 22 planning closure packet.

It creates a no-write planning exit packet for the Phase 20 bridge routing network transport chain. It reads the latest Phase 22 planning closure packet, carries forward keep-latest and manual-archive-review decisions, preserves the do-not-stage boundary, and turns the planning closure areas into explicit exit-review areas for execution envelope, transport injection, bridge gate, response storage, cutover, and audit/rollback review.
...
## Generate planning exit packet

From the platform repo, with FastAPI and bridge running:

```powershell
powershell -ExecutionPolicy Bypass -File scripts\phase22_generate_phase20_network_transport_planning_exit_packet.ps1
```

Output:

```text
C:\Users\krist\Desktop\unified_pool_service_platform_build\backups\phase22_phase20_network_transport_planning_exit_packet_<timestamp>
```
...
phase22_phase20_network_transport_planning_exit_packet_sections.csv
phase22_phase20_network_transport_planning_exit_packet_entries.csv
phase22_phase20_network_transport_planning_exit_packet_exit_areas.csv
phase22_phase20_network_transport_planning_exit_packet_decisions.csv
phase22_phase20_network_transport_planning_exit_packet_artifact_families.csv
phase22_phase20_network_transport_planning_exit_packet_git_status.csv
phase22_phase20_network_transport_planning_exit_packet_staged.csv
phase22_phase20_network_transport_planning_exit_packet_source_artifacts.csv
phase22_phase20_network_transport_planning_exit_packet_checklist.csv
phase22_phase20_network_transport_planning_exit_packet_issues.csv
phase22_phase20_network_transport_planning_exit_packet.md
```
...
```text
Phase20 Network Transport Planning Exit Packet
```

## Commit guard

Stage only the four Phase 22 Step 13 files. Do not stage generated planning-exit files, local databases, `.env`, `.venv`, bridge folders, backups, evidence packs, import artifacts, or unrelated Replaster Quote files.
