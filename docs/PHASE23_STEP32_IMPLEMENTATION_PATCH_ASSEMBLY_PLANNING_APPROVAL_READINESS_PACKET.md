...
- Phase: 23
- Step: 32
- Prior step: Phase 23 Step 31 - Phase 20 Network Transport Implementation Patch Assembly Planning Approval Boundary Packet
...
Set-Location $Parent
powershell.exe -NoProfile -ExecutionPolicy Bypass -File (Join-Path $Parent "unified_pool_service_platform_build\scripts/phase23_step32_implementation_patch_assembly_planning_approval_readiness_packet.ps1") -Action all
```

## Expected smoke-test text

```text
SMOKE TEST PASS: Phase 23 Step 32 Implementation Patch Assembly Planning Approval Readiness Packet is present and planning-only.
```
...
PASS: phase23_planning_boundary=implementation_patch_assembly_planning_approval_readiness_opened_by_packet
...
PASS: implementation_patch_assembly_planning_approval_readiness_mode=reference_only
PASS: implementation_patch_assembly_planning_approval_readiness_write=false
PASS: implementation_patch_assembly_planning_approval_readiness_record_creation=false
...
CHECK: prior_step=Phase 23 Step 31 - Phase 20 Network Transport Implementation Patch Assembly Planning Approval Boundary Packet
CHECK: phase23_context=implementation_patch_assembly_planning_approval_readiness_planning_only
