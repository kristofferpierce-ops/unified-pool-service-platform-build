...
st.set_page_config(
    page_title="Phase 33 Step 2",
    layout="wide",
)

st.title("Phase 33 Step 2")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Rollout Readiness Evidence Index Packet")
...
st.code("Phase 33 Step 1 - Phase 20 Network Transport Implementation Trusted Production Rollout Readiness Boundary Packet")
