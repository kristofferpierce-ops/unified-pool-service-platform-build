...
STEP_NUMBER = 92
STEP_TITLE = "Phase 28 Step 92 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Evidence Index Packet"
PRIOR_STEP = "Phase 28 Step 91 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Boundary Packet"
PHASE_CONTEXT = "implementation_sandbox_pilot_final_release_hold_planning_only"

st.set_page_config(
    page_title="Phase 28 Step 92",
    layout="wide",
)
...
st.write("phase28_boundary=implementation_sandbox_pilot_final_release_hold_planning_evidence_index_opened_by_packet")
