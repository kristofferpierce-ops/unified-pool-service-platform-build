...
st.set_page_config(page_title="Phase 38 Step 118", layout="wide")

TITLE = "Phase 38 Step 118 - Phase 20 Network Transport Implementation Trusted Production Sustained Live Write Operations Final Release Result Review Planning Operator Hold Point Packet"
