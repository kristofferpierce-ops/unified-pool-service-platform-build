...
st.set_page_config(
    page_title="Phase 31 Step 99",
    layout="wide",
)

st.title("Phase 31 Step 99")
st.subheader("Phase 20 Network Transport Implementation Controlled Active Program Operation Final Release Hold Planning Closeout Index Packet")
...
st.code("Phase 31 Step 98 - Phase 20 Network Transport Implementation Controlled Active Program Operation Final Release Hold Planning Operator Hold Point Packet")
