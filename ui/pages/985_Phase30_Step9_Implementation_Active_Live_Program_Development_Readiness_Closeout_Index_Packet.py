...
st.set_page_config(
    page_title="Phase 30 Step 9",
    layout="wide",
)

st.title("Phase 30 Step 9")
st.subheader("Phase 20 Network Transport Implementation Active Live Program Development Readiness Closeout Index Packet")
...
st.code("Phase 30 Step 8 - Phase 20 Network Transport Implementation Active Live Program Development Readiness Operator Hold Point Packet")
