...
st.set_page_config(
    page_title="Phase 32 Step 4",
    layout="wide",
)

st.title("Phase 32 Step 4")
st.subheader("Phase 20 Network Transport Implementation Production-Like Rollout Readiness Safety Disposition Planning Packet")
...
st.code("Phase 32 Step 3 - Phase 20 Network Transport Implementation Production-Like Rollout Readiness Evidence Gap Review Packet")
