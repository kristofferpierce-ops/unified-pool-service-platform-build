...
st.set_page_config(
    page_title="Phase 32 Step 6",
    layout="wide",
)

st.title("Phase 32 Step 6")
st.subheader("Phase 20 Network Transport Implementation Production-Like Rollout Readiness Approval Boundary Packet")
...
st.code("Phase 32 Step 5 - Phase 20 Network Transport Implementation Production-Like Rollout Readiness Safety Disposition Review Packet")
