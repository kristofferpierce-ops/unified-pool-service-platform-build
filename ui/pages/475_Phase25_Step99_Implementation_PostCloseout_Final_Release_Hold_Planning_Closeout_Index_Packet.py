...
st.set_page_config(
    page_title="Phase 25 Step 99 Final Release Hold Planning",
    layout="wide",
)

st.title("Phase 25 Step 99 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Closeout Index Packet")
...
st.write("scripts/phase25_step99_post_closeout_final_release_hold_planning_closeout_index_packet.ps1")
st.write("ui/pages/475_Phase25_Step99_Implementation_PostCloseout_Final_Release_Hold_Planning_Closeout_Index_Packet.py")
st.write("docs/PHASE25_STEP99_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_CLOSEOUT_INDEX_PACKET.md")
st.write("tests/test_phase25_step99_post_closeout_final_release_hold_planning_closeout_index_packet.py")
