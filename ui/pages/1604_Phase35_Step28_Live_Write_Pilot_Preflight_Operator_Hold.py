...
st.set_page_config(
    page_title="Phase 35 Step 28",
    layout="wide",
)

st.title("Phase 35 Step 28")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Preflight Planning Operator Hold Point Packet")
...
st.code("Phase 35 Step 27 - Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Preflight Planning Approval Readiness Packet")
