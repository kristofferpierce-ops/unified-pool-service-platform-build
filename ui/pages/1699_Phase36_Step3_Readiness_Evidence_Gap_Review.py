...
st.set_page_config(
    page_title="Phase 36 Step 3",
    layout="wide",
)

st.title("Phase 36 Step 3")
st.subheader("Readiness Evidence Gap Review")
st.caption("Phase 36 Step 3 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Readiness Evidence Gap Review Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 3 planning-only packet for trusted-production controlled live-write expansion. "
