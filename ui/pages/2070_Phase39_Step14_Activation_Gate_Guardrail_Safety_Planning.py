...
TITLE = "Phase 39 Step 14 - Phase 20 Network Transport Implementation Trusted Production Live Write Activation Gate Guardrail Verification Safety Disposition Planning Packet"
...
st.set_page_config(page_title="Phase 39 Step 14", layout="wide")
st.title(TITLE)
