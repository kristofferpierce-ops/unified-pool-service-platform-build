...
TITLE = "Phase 38 Step 21 - Phase 20 Network Transport Implementation Trusted Production Sustained Live Write Operations Preflight Planning Boundary Packet"
MARKERS = {
    "planning_only": "true",
...
def render() -> None:
    ...
    st.set_page_config(page_title=f"Phase 38 Step 21", layout="wide")
    st.title(TITLE)
