...
st.set_page_config(
    page_title="Phase 33 Step 120",
    layout="wide",
)

st.title("Phase 33 Step 120")
st.subheader("Phase 20 Network Transport Implementation Phase 33 Final No-Write Closeout Hold Packet")
...
st.code("Phase 33 Step 119 - Phase 20 Network Transport Implementation Trusted Production Rollout Final Release Result Review Planning Closeout Index Packet")
