...
st.set_page_config(
    page_title="Phase 25 Step 120",
    layout="wide",
)

st.title("Phase 25 Step 120 - Phase 20 Network Transport Implementation Phase 25 Final No-Write Closeout Hold Packet")
...
st.write(
    "This Phase 25 packet records Phase 25 Final No-Write Closeout Hold evidence for the network transport post-closeout lane. "
...
st.write("scripts/phase25_step120_final_no_write_closeout_hold_packet.ps1")
st.write("ui/pages/496_Phase25_Step120_Final_No_Write_Closeout_Hold_Packet.py")
st.write("docs/PHASE25_STEP120_FINAL_NO_WRITE_CLOSEOUT_HOLD_PACKET.md")
st.write("tests/test_phase25_step120_final_no_write_closeout_hold_packet.py")
