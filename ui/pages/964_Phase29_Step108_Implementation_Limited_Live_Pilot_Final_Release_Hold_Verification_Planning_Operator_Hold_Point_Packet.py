...
st.set_page_config(
    page_title="Phase 29 Step 108",
    layout="wide",
)

st.title("Phase 29 Step 108")
st.subheader("Phase 20 Network Transport Implementation Limited Live Pilot Final Release Hold Verification Planning Operator Hold Point Packet")
...
st.code("Phase 29 Step 107 - Phase 20 Network Transport Implementation Limited Live Pilot Final Release Hold Verification Planning Approval Readiness Packet")
