...
st.set_page_config(
    page_title="Phase 29 Step 33",
    layout="wide",
)

st.title("Phase 29 Step 33")
st.subheader("Phase 20 Network Transport Implementation Limited Live Pilot No-Write Dry Run Readiness Evidence Gap Review Packet")
...
st.code("Phase 29 Step 32 - Phase 20 Network Transport Implementation Limited Live Pilot No-Write Dry Run Readiness Evidence Index Packet")
