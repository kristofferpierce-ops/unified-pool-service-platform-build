...
st.set_page_config(page_title="Phase 38 Step 84", layout="wide")

TITLE = "Phase 38 Step 84 - Phase 20 Network Transport Implementation Trusted Production Sustained Live Write Operations Release Gate Verification Planning Safety Disposition Planning Packet"
