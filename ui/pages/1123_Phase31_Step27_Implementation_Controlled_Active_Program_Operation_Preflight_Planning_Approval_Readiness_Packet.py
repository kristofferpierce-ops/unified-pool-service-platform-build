...
st.set_page_config(
    page_title="Phase 31 Step 27",
    layout="wide",
)

st.title("Phase 31 Step 27")
st.subheader("Phase 20 Network Transport Implementation Controlled Active Program Operation Preflight Planning Approval Readiness Packet")
...
st.code("Phase 31 Step 26 - Phase 20 Network Transport Implementation Controlled Active Program Operation Preflight Planning Approval Boundary Packet")
