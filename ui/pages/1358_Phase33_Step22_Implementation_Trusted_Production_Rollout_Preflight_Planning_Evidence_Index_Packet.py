...
st.set_page_config(
    page_title="Phase 33 Step 22",
    layout="wide",
)

st.title("Phase 33 Step 22")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Rollout Preflight Planning Evidence Index Packet")
...
st.code("Phase 33 Step 21 - Phase 20 Network Transport Implementation Trusted Production Rollout Preflight Planning Boundary Packet")
