...
PHASE = 38
STEP = 50
TITLE = "Phase 38 Step 50 - Phase 20 Network Transport Implementation Trusted Production Sustained Live Write Operations No-Write Dry Run Verification Planning Final Boundary Confirmation Packet"
...
with left:
    ...
    st.write("Trusted-production sustained live-write operations no-write dry-run verification planning.")
