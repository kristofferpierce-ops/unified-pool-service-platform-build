...
st.set_page_config(
    page_title="Phase 25 Step 95 Final Release Hold Planning",
    layout="wide",
)

st.title("Phase 25 Step 95 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Safety Disposition Review Packet")
...
st.write("scripts/phase25_step95_post_closeout_final_release_hold_planning_safety_disposition_review_packet.ps1")
st.write("ui/pages/471_Phase25_Step95_Implementation_PostCloseout_Final_Release_Hold_Planning_Safety_Disposition_Review_Packet.py")
st.write("docs/PHASE25_STEP95_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_SAFETY_DISPOSITION_REVIEW_PACKET.md")
st.write("tests/test_phase25_step95_post_closeout_final_release_hold_planning_safety_disposition_review_packet.py")
