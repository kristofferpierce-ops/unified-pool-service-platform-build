...
st.set_page_config(
    page_title="Phase 36 Step 23",
    layout="wide",
)

st.title("Phase 36 Step 23")
st.subheader("Evidence Gap Review")
st.caption("Phase 36 Step 23 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Evidence Gap Review Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 23 planning-only packet for trusted-production "
