...
st.set_page_config(
    page_title="Phase 25 Step 98 Final Release Hold Planning",
    layout="wide",
)

st.title("Phase 25 Step 98 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Operator Hold Point Packet")
...
st.write("scripts/phase25_step98_post_closeout_final_release_hold_planning_operator_hold_point_packet.ps1")
st.write("ui/pages/474_Phase25_Step98_Implementation_PostCloseout_Final_Release_Hold_Planning_Operator_Hold_Point_Packet.py")
st.write("docs/PHASE25_STEP98_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_OPERATOR_HOLD_POINT_PACKET.md")
st.write("tests/test_phase25_step98_post_closeout_final_release_hold_planning_operator_hold_point_packet.py")
