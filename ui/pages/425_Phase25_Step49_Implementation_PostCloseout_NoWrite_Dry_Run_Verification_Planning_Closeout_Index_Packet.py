...
EXPECTED_BRANCH = "phase25-step49-post-closeout-no-write-dry-run-verification-planning-closeout-index"
...
st.code("""scripts/phase25_step49_post_closeout_no_write_dry_run_verification_planning_closeout_index_packet.ps1
