...
st.set_page_config(
    page_title="Phase 36 Step 32",
    layout="wide",
)

st.title("Phase 36 Step 32")
st.subheader("Evidence Index")
st.caption("Phase 36 Step 32 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion No-Write Dry Run Readiness Evidence Index Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 32 planning-only packet for trusted-production "
