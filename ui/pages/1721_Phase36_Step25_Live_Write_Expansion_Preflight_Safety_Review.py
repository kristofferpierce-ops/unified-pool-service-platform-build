...
st.set_page_config(
    page_title="Phase 36 Step 25",
    layout="wide",
)

st.title("Phase 36 Step 25")
st.subheader("Safety Disposition Review")
st.caption("Phase 36 Step 25 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Safety Disposition Review Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 25 planning-only packet for trusted-production "
