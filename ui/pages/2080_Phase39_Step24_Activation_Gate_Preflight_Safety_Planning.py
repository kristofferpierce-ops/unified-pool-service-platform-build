...
TITLE = "Phase 39 Step 24 - Phase 20 Network Transport Implementation Trusted Production Live Write Activation Gate Preflight Planning Safety Disposition Planning Packet"
...
st.set_page_config(page_title="Phase 39 Step 24", layout="wide")
st.title(TITLE)
