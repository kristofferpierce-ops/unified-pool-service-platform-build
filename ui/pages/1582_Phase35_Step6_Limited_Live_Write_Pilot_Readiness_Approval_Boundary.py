...
st.set_page_config(
    page_title="Phase 35 Step 6",
    layout="wide",
)

st.title("Phase 35 Step 6")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Readiness Approval Boundary Packet")
...
st.code("Phase 35 Step 5 - Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Readiness Safety Disposition Review Packet")
