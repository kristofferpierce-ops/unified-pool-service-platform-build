...
st.set_page_config(
    page_title="Phase 35 Step 30",
    layout="wide",
)

st.title("Phase 35 Step 30")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Preflight Planning Final Boundary Confirmation Packet")
...
st.code("Phase 35 Step 29 - Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Preflight Planning Closeout Index Packet")
