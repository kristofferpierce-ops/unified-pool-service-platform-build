...
st.set_page_config(
    page_title="Phase 36 Step 2",
    layout="wide",
)

st.title("Phase 36 Step 2")
st.subheader("Readiness Evidence Index")
st.caption("Phase 36 Step 2 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Readiness Evidence Index Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 2 planning-only packet for trusted-production controlled live-write expansion. "
