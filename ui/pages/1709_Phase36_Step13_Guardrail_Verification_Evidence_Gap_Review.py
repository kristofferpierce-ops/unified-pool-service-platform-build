...
st.set_page_config(
    page_title="Phase 36 Step 13",
    layout="wide",
)

st.title("Phase 36 Step 13")
st.subheader("Guardrail Verification Evidence Gap Review")
st.caption("Phase 36 Step 13 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Guardrail Verification Evidence Gap Review Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 13 planning-only packet for trusted-production controlled live-write expansion guardrail verification. "
