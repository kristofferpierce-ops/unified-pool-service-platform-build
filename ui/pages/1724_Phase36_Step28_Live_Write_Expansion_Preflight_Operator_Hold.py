...
st.set_page_config(
    page_title="Phase 36 Step 28",
    layout="wide",
)

st.title("Phase 36 Step 28")
st.subheader("Operator Hold Point")
st.caption("Phase 36 Step 28 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Operator Hold Point Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 28 planning-only packet for trusted-production "
