...
st.set_page_config(
    page_title="Phase 36 Step 24",
    layout="wide",
)

st.title("Phase 36 Step 24")
st.subheader("Safety Disposition Planning")
st.caption("Phase 36 Step 24 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Safety Disposition Planning Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 24 planning-only packet for trusted-production "
    "controlled live-write expansion preflight planning. It is intended for audit, readiness review, and operator hold-point evidence only."
)
