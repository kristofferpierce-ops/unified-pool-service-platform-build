...
TITLE = "Phase 39 Step 29 - Phase 20 Network Transport Implementation Trusted Production Live Write Activation Gate Preflight Planning Closeout Index Packet"
...
st.set_page_config(page_title="Phase 39 Step 29", layout="wide")
st.title(TITLE)
