...
st.set_page_config(
    page_title="Phase 31 Step 95",
    layout="wide",
)

st.title("Phase 31 Step 95")
st.subheader("Phase 20 Network Transport Implementation Controlled Active Program Operation Final Release Hold Planning Safety Disposition Review Packet")
...
st.code("Phase 31 Step 94 - Phase 20 Network Transport Implementation Controlled Active Program Operation Final Release Hold Planning Safety Disposition Planning Packet")
