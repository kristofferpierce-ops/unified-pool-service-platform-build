...
st.set_page_config(
    page_title="Phase 32 Step 3",
    layout="wide",
)

st.title("Phase 32 Step 3")
st.subheader("Phase 20 Network Transport Implementation Production-Like Rollout Readiness Evidence Gap Review Packet")
...
st.code("Phase 32 Step 2 - Phase 20 Network Transport Implementation Production-Like Rollout Readiness Evidence Index Packet")
