...
st.set_page_config(
    page_title="Phase 25 Step 97 Final Release Hold Planning",
    layout="wide",
)

st.title("Phase 25 Step 97 - Phase 20 Network Transport Implementation Post-Closeout Final Release Hold Planning Approval Readiness Packet")
...
st.write("scripts/phase25_step97_post_closeout_final_release_hold_planning_approval_readiness_packet.ps1")
st.write("ui/pages/473_Phase25_Step97_Implementation_PostCloseout_Final_Release_Hold_Planning_Approval_Readiness_Packet.py")
st.write("docs/PHASE25_STEP97_POST_CLOSEOUT_FINAL_RELEASE_HOLD_PLANNING_APPROVAL_READINESS_PACKET.md")
st.write("tests/test_phase25_step97_post_closeout_final_release_hold_planning_approval_readiness_packet.py")
