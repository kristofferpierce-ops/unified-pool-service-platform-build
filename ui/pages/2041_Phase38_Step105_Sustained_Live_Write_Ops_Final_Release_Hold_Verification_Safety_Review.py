...
st.set_page_config(page_title="Phase 38 Step 105", layout="wide")

TITLE = "Phase 38 Step 105 - Phase 20 Network Transport Implementation Trusted Production Sustained Live Write Operations Final Release Hold Verification Planning Safety Disposition Review Packet"
