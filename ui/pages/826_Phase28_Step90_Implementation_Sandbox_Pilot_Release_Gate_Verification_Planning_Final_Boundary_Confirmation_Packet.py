...
STEP_NUMBER = 90
STEP_TITLE = "Phase 28 Step 90 - Phase 20 Network Transport Implementation Sandbox Pilot Release Gate Verification Planning Final Boundary Confirmation Packet"
PRIOR_STEP = "Phase 28 Step 89 - Phase 20 Network Transport Implementation Sandbox Pilot Release Gate Verification Planning Closeout Index Packet"
PHASE_CONTEXT = "implementation_sandbox_pilot_release_gate_verification_planning_only"

st.set_page_config(
    page_title="Phase 28 Step 90",
    layout="wide",
)
...
st.write("phase28_boundary=implementation_sandbox_pilot_release_gate_verification_planning_final_boundary_confirmation_opened_by_packet")
