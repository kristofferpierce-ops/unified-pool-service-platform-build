...
st.set_page_config(
    page_title="Phase 22 Step 36 Exit Readiness Alignment",
    layout="wide",
)

st.title("Phase 22 Step 36 - Exit Readiness Alignment Packet")
...
st.subheader("Exit readiness alignment")
st.markdown(
    """
- Exit readiness scope: planning packet only.
...
st.info("Phase 22 Step 36 is an exit-readiness planning packet only. It does not approve or start implementation.")
