...
TITLE = "Phase 39 Step 23 - Phase 20 Network Transport Implementation Trusted Production Live Write Activation Gate Preflight Planning Evidence Gap Review Packet"
...
st.set_page_config(page_title="Phase 39 Step 23", layout="wide")
st.title(TITLE)
