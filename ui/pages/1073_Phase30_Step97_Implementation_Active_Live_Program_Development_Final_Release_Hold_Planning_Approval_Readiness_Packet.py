...
st.set_page_config(
    page_title="Phase 30 Step 97",
    layout="wide",
)

st.title("Phase 30 Step 97")
st.subheader("Phase 20 Network Transport Implementation Active Live Program Development Final Release Hold Planning Approval Readiness Packet")
...
st.code("Phase 30 Step 96 - Phase 20 Network Transport Implementation Active Live Program Development Final Release Hold Planning Approval Boundary Packet")
