...
st.set_page_config(
    page_title="Phase 36 Step 29",
    layout="wide",
)

st.title("Phase 36 Step 29")
st.subheader("Closeout Index")
st.caption("Phase 36 Step 29 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Closeout Index Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 29 planning-only packet for trusted-production "
