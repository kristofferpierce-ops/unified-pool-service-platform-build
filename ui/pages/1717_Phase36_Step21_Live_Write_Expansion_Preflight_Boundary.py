...
st.set_page_config(
    page_title="Phase 36 Step 21",
    layout="wide",
)

st.title("Phase 36 Step 21")
st.subheader("Boundary")
st.caption("Phase 36 Step 21 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Boundary Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 21 planning-only packet for trusted-production "
