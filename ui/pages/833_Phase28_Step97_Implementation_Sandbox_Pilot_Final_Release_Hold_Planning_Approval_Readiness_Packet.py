...
STEP_NUMBER = 97
STEP_TITLE = "Phase 28 Step 97 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Approval Readiness Packet"
PRIOR_STEP = "Phase 28 Step 96 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Approval Boundary Packet"
PHASE_CONTEXT = "implementation_sandbox_pilot_final_release_hold_planning_only"

st.set_page_config(
    page_title="Phase 28 Step 97",
    layout="wide",
)
...
st.write("phase28_boundary=implementation_sandbox_pilot_final_release_hold_planning_approval_readiness_opened_by_packet")
