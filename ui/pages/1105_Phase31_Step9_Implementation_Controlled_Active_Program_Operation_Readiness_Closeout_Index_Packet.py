...
st.set_page_config(
    page_title="Phase 31 Step 9",
    layout="wide",
)

st.title("Phase 31 Step 9")
st.subheader("Phase 20 Network Transport Implementation Controlled Active Program Operation Readiness Closeout Index Packet")
...
st.code("Phase 31 Step 8 - Phase 20 Network Transport Implementation Controlled Active Program Operation Readiness Operator Hold Point Packet")
