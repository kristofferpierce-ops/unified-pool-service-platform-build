...
st.set_page_config(
    page_title="Phase 29 Step 19",
    layout="wide",
)

st.title("Phase 29 Step 19")
st.subheader("Phase 20 Network Transport Implementation Limited Live Pilot Guardrail Verification Closeout Index Packet")
...
st.code("Phase 29 Step 18 - Phase 20 Network Transport Implementation Limited Live Pilot Guardrail Verification Operator Hold Point Packet")
