...
st.set_page_config(
    page_title="Phase 32 Step 1",
    layout="wide",
)

st.title("Phase 32 Step 1")
st.subheader("Phase 20 Network Transport Implementation Production-Like Rollout Readiness Boundary Packet")
...
st.code("Phase 31 Step 120 - Phase 20 Network Transport Implementation Phase 31 Final No-Write Closeout Hold Packet")
