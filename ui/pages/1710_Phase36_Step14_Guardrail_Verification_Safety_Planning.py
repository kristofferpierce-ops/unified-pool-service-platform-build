...
st.set_page_config(
    page_title="Phase 36 Step 14",
    layout="wide",
)

st.title("Phase 36 Step 14")
st.subheader("Guardrail Verification Safety Planning")
st.caption("Phase 36 Step 14 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Guardrail Verification Safety Disposition Planning Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 14 planning-only packet for trusted-production controlled live-write expansion guardrail verification. "
