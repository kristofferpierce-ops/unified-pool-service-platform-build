...
TITLE = "Phase 39 Step 18 - Phase 20 Network Transport Implementation Trusted Production Live Write Activation Gate Guardrail Verification Operator Hold Point Packet"
...
st.set_page_config(page_title="Phase 39 Step 18", layout="wide")
st.title(TITLE)
