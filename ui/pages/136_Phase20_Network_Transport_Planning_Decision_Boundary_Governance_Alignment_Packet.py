...
st.set_page_config(
    page_title="Phase 22 Step 30 Decision Boundary Governance Alignment",
    layout="wide",
)

st.title("Phase 22 Step 30 - Phase 20 Network Transport Planning Decision Boundary Governance Alignment Packet")
...
st.write(
    "This packet aligns the Phase 20 network transport planning chain with future decision-boundary governance. "
...
st.info(
    "External systems remain source buckets. Future decision-boundary governance should only consider approved and "
    "applied internal facts, preserved provenance, model-versioned estimates, variance records, and operator review. "
    "This Phase 22 Step 30 packet does not write raw, normalized, matched, approved, or applied records."
)
