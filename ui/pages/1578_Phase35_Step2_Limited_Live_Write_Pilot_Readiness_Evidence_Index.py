...
st.set_page_config(
    page_title="Phase 35 Step 2",
    layout="wide",
)

st.title("Phase 35 Step 2")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Readiness Evidence Index Packet")
...
st.code("Phase 35 Step 1 - Phase 20 Network Transport Implementation Trusted Production Limited Live Write Pilot Readiness Boundary Packet")
