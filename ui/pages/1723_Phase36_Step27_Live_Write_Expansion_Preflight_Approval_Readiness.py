...
st.set_page_config(
    page_title="Phase 36 Step 27",
    layout="wide",
)

st.title("Phase 36 Step 27")
st.subheader("Approval Readiness")
st.caption("Phase 36 Step 27 - Phase 20 Network Transport Implementation Trusted Production Controlled Live Write Expansion Preflight Planning Approval Readiness Packet")
...
st.write(
    "This generated page documents the Phase 36 Step 27 planning-only packet for trusted-production "
