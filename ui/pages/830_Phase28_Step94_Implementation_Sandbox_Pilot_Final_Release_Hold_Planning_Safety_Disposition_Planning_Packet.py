...
STEP_NUMBER = 94
STEP_TITLE = "Phase 28 Step 94 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Safety Disposition Planning Packet"
PRIOR_STEP = "Phase 28 Step 93 - Phase 20 Network Transport Implementation Sandbox Pilot Final Release Hold Planning Evidence Gap Review Packet"
PHASE_CONTEXT = "implementation_sandbox_pilot_final_release_hold_planning_only"

st.set_page_config(
    page_title="Phase 28 Step 94",
    layout="wide",
)
...
st.write("phase28_boundary=implementation_sandbox_pilot_final_release_hold_planning_safety_disposition_planning_opened_by_packet")
