...
st.set_page_config(
    page_title="Phase 33 Step 1",
    layout="wide",
)

st.title("Phase 33 Step 1")
st.subheader("Phase 20 Network Transport Implementation Trusted Production Rollout Readiness Boundary Packet")
...
st.code("Phase 32 Step 120 - Phase 20 Network Transport Implementation Phase 32 Final No-Write Closeout Hold Packet")
