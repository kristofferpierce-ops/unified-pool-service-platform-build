...
with launch_d:
    ...
    st.page_link('pages/28_Ledger_Search.py', label='Ledger Search', icon='🔎', help='Search an item, part number, or invoice number across every vendor - price, vendor, date, and invoice in one place.')
